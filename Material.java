...
public class Material {
   ...
   * @param alpha     float value in the range 0.0 (fully transparent) to 1.0 (fully opaque).
   */  
  ...
  */    
  ...
  /**
   * Gets the alpha (transparency) value.
   *
   * @return the alpha value (0.0 = fully transparent, 1.0 = fully opaque).
   */
  ...
  public String toString() {
    return "a:"+ambient+", d:"+diffuse+", s:"+specular+", e:"+emission+", shininess:"+shininess+ ", alpha:"+alpha;
  }  
