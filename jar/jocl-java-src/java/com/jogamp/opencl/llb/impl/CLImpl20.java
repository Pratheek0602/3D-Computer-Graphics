...
/* !---- Java-Unit: [pkg com.jogamp.opencl.llb.impl, cls CLImpl20], ../build/gensrc/java/com/jogamp/opencl/llb/impl/CLImpl20.java ----! */
...
public class CLImpl20 implements CL20{
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clCreateSubDevices}(cl_device_id in_device, const cl_device_partition_property *  properties, cl_uint num_devices, cl_device_id *  out_devices, cl_uint *  num_devices_ret)</code><br>
      @param properties a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param out_devices a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param num_devices_ret a direct or array-backed {@link java.nio.IntBuffer}   */
  public int clCreateSubDevices(long in_device, PointerBuffer properties, int num_devices, PointerBuffer out_devices, IntBuffer num_devices_ret)  {

    final boolean properties_is_direct = Buffers.isDirect(properties);
    final boolean out_devices_is_direct = Buffers.isDirect(out_devices);
    final boolean num_devices_ret_is_direct = Buffers.isDirect(num_devices_ret);
    final long __addr_ = addressTable._addressof_clCreateSubDevices;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clCreateSubDevices"));
    }
        return dispatch_clCreateSubDevices1(in_device, properties_is_direct ? ( properties != null ? properties.getBuffer() : null ) : Buffers.getArray(properties), properties_is_direct ? Buffers.getDirectBufferByteOffset(properties) : Buffers.getIndirectBufferByteOffset(properties), properties_is_direct, num_devices, out_devices_is_direct ? ( out_devices != null ? out_devices.getBuffer() : null ) : Buffers.getArray(out_devices), out_devices_is_direct ? Buffers.getDirectBufferByteOffset(out_devices) : Buffers.getIndirectBufferByteOffset(out_devices), out_devices_is_direct, num_devices_ret_is_direct ? num_devices_ret : Buffers.getArray(num_devices_ret), num_devices_ret_is_direct ? Buffers.getDirectBufferByteOffset(num_devices_ret) : Buffers.getIndirectBufferByteOffset(num_devices_ret), num_devices_ret_is_direct, __addr_);
  }
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clCreateSubDevices}(cl_device_id in_device, const cl_device_partition_property *  properties, cl_uint num_devices, cl_device_id *  out_devices, cl_uint *  num_devices_ret)</code><br>
      ...
      @param out_devices a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param num_devices_ret a direct or array-backed {@link java.nio.IntBuffer}   */
  private native int dispatch_clCreateSubDevices1(long in_device, Object properties, int properties_byte_offset, boolean properties_is_direct, int num_devices, Object out_devices, int out_devices_byte_offset, boolean out_devices_is_direct, Object num_devices_ret, int num_devices_ret_byte_offset, boolean num_devices_ret_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clCreateSubDevices}(cl_device_id in_device, const cl_device_partition_property *  properties, cl_uint num_devices, cl_device_id *  out_devices, cl_uint *  num_devices_ret)</code><br>
      @param properties a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param out_devices a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  public int clCreateSubDevices(long in_device, PointerBuffer properties, int num_devices, PointerBuffer out_devices, int[] num_devices_ret, int num_devices_ret_offset)  {

    final boolean properties_is_direct = Buffers.isDirect(properties);
    final boolean out_devices_is_direct = Buffers.isDirect(out_devices);
    if(num_devices_ret != null && num_devices_ret.length <= num_devices_ret_offset)
      throw new IllegalArgumentException("array offset argument \"num_devices_ret_offset\" (" + num_devices_ret_offset + ") equals or exceeds array length (" + num_devices_ret.length + ")");
    final long __addr_ = addressTable._addressof_clCreateSubDevices;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clCreateSubDevices"));
    }
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clRetainDevice}(cl_device_id device)</code><br>   */
  public int clRetainDevice(long device)  {

    final long __addr_ = addressTable._addressof_clRetainDevice;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clRetainDevice"));
    }
        return dispatch_clRetainDevice1(device, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clRetainDevice}(cl_device_id device)</code><br>   */
  private native int dispatch_clRetainDevice1(long device, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clReleaseDevice}(cl_device_id device)</code><br>   */
  public int clReleaseDevice(long device)  {

    final long __addr_ = addressTable._addressof_clReleaseDevice;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clReleaseDevice"));
    }
        return dispatch_clReleaseDevice1(device, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clReleaseDevice}(cl_device_id device)</code><br>   */
  private native int dispatch_clReleaseDevice1(long device, long procAddress);
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_command_queue {@native clCreateCommandQueueWithProperties}(cl_context context, cl_device_id device, const cl_queue_properties *  properties, cl_int *  errcode_ret)</code><br>
      @param properties a direct or array-backed {@link java.nio.LongBuffer}
      @param errcode_ret a direct or array-backed {@link java.nio.IntBuffer}   */
  public long clCreateCommandQueueWithProperties(long context, long device, LongBuffer properties, IntBuffer errcode_ret)  {

    final boolean properties_is_direct = Buffers.isDirect(properties);
    final boolean errcode_ret_is_direct = Buffers.isDirect(errcode_ret);
    final long __addr_ = addressTable._addressof_clCreateCommandQueueWithProperties;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clCreateCommandQueueWithProperties"));
    }
        return dispatch_clCreateCommandQueueWithProperties1(context, device, properties_is_direct ? properties : Buffers.getArray(properties), properties_is_direct ? Buffers.getDirectBufferByteOffset(properties) : Buffers.getIndirectBufferByteOffset(properties), properties_is_direct, errcode_ret_is_direct ? errcode_ret : Buffers.getArray(errcode_ret), errcode_ret_is_direct ? Buffers.getDirectBufferByteOffset(errcode_ret) : Buffers.getIndirectBufferByteOffset(errcode_ret), errcode_ret_is_direct, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_command_queue {@native clCreateCommandQueueWithProperties}(cl_context context, cl_device_id device, const cl_queue_properties *  properties, cl_int *  errcode_ret)</code><br>
      @param properties a direct or array-backed {@link java.nio.LongBuffer}
      @param errcode_ret a direct or array-backed {@link java.nio.IntBuffer}   */
  private native long dispatch_clCreateCommandQueueWithProperties1(long context, long device, Object properties, int properties_byte_offset, boolean properties_is_direct, Object errcode_ret, int errcode_ret_byte_offset, boolean errcode_ret_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_command_queue {@native clCreateCommandQueueWithProperties}(cl_context context, cl_device_id device, const cl_queue_properties *  properties, cl_int *  errcode_ret)</code><br>   */
  public long clCreateCommandQueueWithProperties(long context, long device, long[] properties, int properties_offset, int[] errcode_ret, int errcode_ret_offset)  {

    if(properties != null && properties.length <= properties_offset)
      throw new IllegalArgumentException("array offset argument \"properties_offset\" (" + properties_offset + ") equals or exceeds array length (" + properties.length + ")");
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clCreateCommandQueueWithProperties"));
        ...
        return dispatch_clCreateCommandQueueWithProperties1(context, device, properties, Buffers.SIZEOF_LONG * properties_offset, false, errcode_ret, Buffers.SIZEOF_INT * errcode_ret_offset, false, __addr_);
  }
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_mem {@native clCreateImage}(cl_context context, cl_mem_flags flags, const cl_image_format *  image_format, const cl_image_desc *  image_desc, void *  host_ptr, cl_int *  errcode_ret)</code><br>
      @param host_ptr a direct or array-backed {@link java.nio.Buffer}
      @param errcode_ret a direct or array-backed {@link java.nio.IntBuffer}   */
  public long clCreateImage(long context, long flags, CLImageFormatImpl image_format, CLImageDescImpl image_desc, Buffer host_ptr, IntBuffer errcode_ret)  {
    ...
    final boolean host_ptr_is_direct = Buffers.isDirect(host_ptr);
    final boolean errcode_ret_is_direct = Buffers.isDirect(errcode_ret);
    final long __addr_ = addressTable._addressof_clCreateImage;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clCreateImage"));
    }
        return dispatch_clCreateImage1(context, flags, ((image_format == null) ? null : image_format.getBuffer()), ((image_desc == null) ? null : image_desc.getBuffer()), host_ptr_is_direct ? host_ptr : Buffers.getArray(host_ptr), host_ptr_is_direct ? Buffers.getDirectBufferByteOffset(host_ptr) : Buffers.getIndirectBufferByteOffset(host_ptr), host_ptr_is_direct, errcode_ret_is_direct ? errcode_ret : Buffers.getArray(errcode_ret), errcode_ret_is_direct ? Buffers.getDirectBufferByteOffset(errcode_ret) : Buffers.getIndirectBufferByteOffset(errcode_ret), errcode_ret_is_direct, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_mem {@native clCreateImage}(cl_context context, cl_mem_flags flags, const cl_image_format *  image_format, const cl_image_desc *  image_desc, void *  host_ptr, cl_int *  errcode_ret)</code><br>
      @param host_ptr a direct or array-backed {@link java.nio.Buffer}
      @param errcode_ret a direct or array-backed {@link java.nio.IntBuffer}   */
  private native long dispatch_clCreateImage1(long context, long flags, ByteBuffer image_format, ByteBuffer image_desc, Object host_ptr, int host_ptr_byte_offset, boolean host_ptr_is_direct, Object errcode_ret, int errcode_ret_byte_offset, boolean errcode_ret_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_mem {@native clCreateImage}(cl_context context, cl_mem_flags flags, const cl_image_format *  image_format, const cl_image_desc *  image_desc, void *  host_ptr, cl_int *  errcode_ret)</code><br>
      @param host_ptr a direct or array-backed {@link java.nio.Buffer}   */
  public long clCreateImage(long context, long flags, CLImageFormatImpl image_format, CLImageDescImpl image_desc, Buffer host_ptr, int[] errcode_ret, int errcode_ret_offset)  {
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_mem {@native clCreatePipe}(cl_context context, cl_mem_flags flags, cl_uint pipe_packet_size, cl_uint pipe_max_packets, const cl_pipe_properties *  properties, cl_int *  errcode_ret)</code><br>
      @param properties a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param errcode_ret a direct or array-backed {@link java.nio.IntBuffer}   */
  public long clCreatePipe(long context, long flags, int pipe_packet_size, int pipe_max_packets, PointerBuffer properties, IntBuffer errcode_ret)  {

    final boolean properties_is_direct = Buffers.isDirect(properties);
    final boolean errcode_ret_is_direct = Buffers.isDirect(errcode_ret);
    final long __addr_ = addressTable._addressof_clCreatePipe;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clCreatePipe"));
    }
        return dispatch_clCreatePipe1(context, flags, pipe_packet_size, pipe_max_packets, properties_is_direct ? ( properties != null ? properties.getBuffer() : null ) : Buffers.getArray(properties), properties_is_direct ? Buffers.getDirectBufferByteOffset(properties) : Buffers.getIndirectBufferByteOffset(properties), properties_is_direct, errcode_ret_is_direct ? errcode_ret : Buffers.getArray(errcode_ret), errcode_ret_is_direct ? Buffers.getDirectBufferByteOffset(errcode_ret) : Buffers.getIndirectBufferByteOffset(errcode_ret), errcode_ret_is_direct, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_mem {@native clCreatePipe}(cl_context context, cl_mem_flags flags, cl_uint pipe_packet_size, cl_uint pipe_max_packets, const cl_pipe_properties *  properties, cl_int *  errcode_ret)</code><br>
      @param properties a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param errcode_ret a direct or array-backed {@link java.nio.IntBuffer}   */
  private native long dispatch_clCreatePipe1(long context, long flags, int pipe_packet_size, int pipe_max_packets, Object properties, int properties_byte_offset, boolean properties_is_direct, Object errcode_ret, int errcode_ret_byte_offset, boolean errcode_ret_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_mem {@native clCreatePipe}(cl_context context, cl_mem_flags flags, cl_uint pipe_packet_size, cl_uint pipe_max_packets, const cl_pipe_properties *  properties, cl_int *  errcode_ret)</code><br>
      @param properties a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  public long clCreatePipe(long context, long flags, int pipe_packet_size, int pipe_max_packets, PointerBuffer properties, int[] errcode_ret, int errcode_ret_offset)  {
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clGetPipeInfo}(cl_mem pipe, cl_pipe_info param_name, size_t param_value_size, void *  param_value, size_t *  param_value_size_ret)</code><br>
  ...
  public int clGetPipeInfo(long pipe, int param_name, long param_value_size, Buffer param_value, PointerBuffer param_value_size_ret)  {
    ...
    final long __addr_ = addressTable._addressof_clGetPipeInfo;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clGetPipeInfo"));
    }
        return dispatch_clGetPipeInfo1(pipe, param_name, param_value_size, param_value_is_direct ? param_value : Buffers.getArray(param_value), param_value_is_direct ? Buffers.getDirectBufferByteOffset(param_value) : Buffers.getIndirectBufferByteOffset(param_value), param_value_is_direct, param_value_size_ret_is_direct ? ( param_value_size_ret != null ? param_value_size_ret.getBuffer() : null ) : Buffers.getArray(param_value_size_ret), param_value_size_ret_is_direct ? Buffers.getDirectBufferByteOffset(param_value_size_ret) : Buffers.getIndirectBufferByteOffset(param_value_size_ret), param_value_size_ret_is_direct, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clGetPipeInfo}(cl_mem pipe, cl_pipe_info param_name, size_t param_value_size, void *  param_value, size_t *  param_value_size_ret)</code><br>
      @param param_value a direct or array-backed {@link java.nio.Buffer}
      @param param_value_size_ret a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  private native int dispatch_clGetPipeInfo1(long pipe, int param_name, long param_value_size, Object param_value, int param_value_byte_offset, boolean param_value_is_direct, Object param_value_size_ret, int param_value_size_ret_byte_offset, boolean param_value_size_ret_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>void *  {@native clSVMAlloc}(cl_context context, cl_svm_mem_flags flags, size_t size, cl_uint alignment)</code><br>   */
  public ByteBuffer clSVMAlloc(long context, long flags, long size, int alignment)  {

    final long __addr_ = addressTable._addressof_clSVMAlloc;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clSVMAlloc"));
    }
    final ByteBuffer _res;
    _res = dispatch_clSVMAlloc1(context, flags, size, alignment, __addr_);
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>void *  {@native clSVMAlloc}(cl_context context, cl_svm_mem_flags flags, size_t size, cl_uint alignment)</code><br>   */
  private native ByteBuffer dispatch_clSVMAlloc1(long context, long flags, long size, int alignment, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>void {@native clSVMFree}(cl_context context, void *  svm_pointer)</code><br>
      @param svm_pointer a direct or array-backed {@link java.nio.Buffer}   */
  public void clSVMFree(long context, Buffer svm_pointer)  {

    final boolean svm_pointer_is_direct = Buffers.isDirect(svm_pointer);
    final long __addr_ = addressTable._addressof_clSVMFree;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clSVMFree"));
    }
    dispatch_clSVMFree1(context, svm_pointer_is_direct ? svm_pointer : Buffers.getArray(svm_pointer), svm_pointer_is_direct ? Buffers.getDirectBufferByteOffset(svm_pointer) : Buffers.getIndirectBufferByteOffset(svm_pointer), svm_pointer_is_direct, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>void {@native clSVMFree}(cl_context context, void *  svm_pointer)</code><br>
      @param svm_pointer a direct or array-backed {@link java.nio.Buffer}   */
  private native void dispatch_clSVMFree1(long context, Object svm_pointer, int svm_pointer_byte_offset, boolean svm_pointer_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_sampler {@native clCreateSamplerWithProperties}(cl_context context, const cl_sampler_properties *  normalized_coords, cl_int *  errcode_ret)</code><br>
      @param normalized_coords a direct or array-backed {@link java.nio.LongBuffer}
      @param errcode_ret a direct or array-backed {@link java.nio.IntBuffer}   */
  public long clCreateSamplerWithProperties(long context, LongBuffer normalized_coords, IntBuffer errcode_ret)  {

    final boolean normalized_coords_is_direct = Buffers.isDirect(normalized_coords);
    final boolean errcode_ret_is_direct = Buffers.isDirect(errcode_ret);
    final long __addr_ = addressTable._addressof_clCreateSamplerWithProperties;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clCreateSamplerWithProperties"));
    }
        return dispatch_clCreateSamplerWithProperties1(context, normalized_coords_is_direct ? normalized_coords : Buffers.getArray(normalized_coords), normalized_coords_is_direct ? Buffers.getDirectBufferByteOffset(normalized_coords) : Buffers.getIndirectBufferByteOffset(normalized_coords), normalized_coords_is_direct, errcode_ret_is_direct ? errcode_ret : Buffers.getArray(errcode_ret), errcode_ret_is_direct ? Buffers.getDirectBufferByteOffset(errcode_ret) : Buffers.getIndirectBufferByteOffset(errcode_ret), errcode_ret_is_direct, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_sampler {@native clCreateSamplerWithProperties}(cl_context context, const cl_sampler_properties *  normalized_coords, cl_int *  errcode_ret)</code><br>
      @param normalized_coords a direct or array-backed {@link java.nio.LongBuffer}
      @param errcode_ret a direct or array-backed {@link java.nio.IntBuffer}   */
  private native long dispatch_clCreateSamplerWithProperties1(long context, Object normalized_coords, int normalized_coords_byte_offset, boolean normalized_coords_is_direct, Object errcode_ret, int errcode_ret_byte_offset, boolean errcode_ret_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_sampler {@native clCreateSamplerWithProperties}(cl_context context, const cl_sampler_properties *  normalized_coords, cl_int *  errcode_ret)</code><br>   */
  public long clCreateSamplerWithProperties(long context, long[] normalized_coords, int normalized_coords_offset, int[] errcode_ret, int errcode_ret_offset)  {

    if(normalized_coords != null && normalized_coords.length <= normalized_coords_offset)
      throw new IllegalArgumentException("array offset argument \"normalized_coords_offset\" (" + normalized_coords_offset + ") equals or exceeds array length (" + normalized_coords.length + ")");
    if(errcode_ret != null && errcode_ret.length <= errcode_ret_offset)
      throw new IllegalArgumentException("array offset argument \"errcode_ret_offset\" (" + errcode_ret_offset + ") equals or exceeds array length (" + errcode_ret.length + ")");
    final long __addr_ = addressTable._addressof_clCreateSamplerWithProperties;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clCreateSamplerWithProperties"));
        ...
        return dispatch_clCreateSamplerWithProperties1(context, normalized_coords, Buffers.SIZEOF_LONG * normalized_coords_offset, false, errcode_ret, Buffers.SIZEOF_INT * errcode_ret_offset, false, __addr_);
  }
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_program {@native clCreateProgramWithBuiltInKernels}(cl_context context, cl_uint num_devices, const cl_device_id *  device_list, const char *  kernel_names, cl_int *  errcode_ret)</code><br>
      @param device_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param kernel_names a direct or array-backed {@link java.nio.ByteBuffer}
      @param errcode_ret a direct or array-backed {@link java.nio.IntBuffer}   */
  public long clCreateProgramWithBuiltInKernels(long context, int num_devices, PointerBuffer device_list, ByteBuffer kernel_names, IntBuffer errcode_ret)  {

    final boolean device_list_is_direct = Buffers.isDirect(device_list);
    final boolean kernel_names_is_direct = Buffers.isDirect(kernel_names);
    final boolean errcode_ret_is_direct = Buffers.isDirect(errcode_ret);
    final long __addr_ = addressTable._addressof_clCreateProgramWithBuiltInKernels;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clCreateProgramWithBuiltInKernels"));
    }
        return dispatch_clCreateProgramWithBuiltInKernels1(context, num_devices, device_list_is_direct ? ( device_list != null ? device_list.getBuffer() : null ) : Buffers.getArray(device_list), device_list_is_direct ? Buffers.getDirectBufferByteOffset(device_list) : Buffers.getIndirectBufferByteOffset(device_list), device_list_is_direct, kernel_names_is_direct ? kernel_names : Buffers.getArray(kernel_names), kernel_names_is_direct ? Buffers.getDirectBufferByteOffset(kernel_names) : Buffers.getIndirectBufferByteOffset(kernel_names), kernel_names_is_direct, errcode_ret_is_direct ? errcode_ret : Buffers.getArray(errcode_ret), errcode_ret_is_direct ? Buffers.getDirectBufferByteOffset(errcode_ret) : Buffers.getIndirectBufferByteOffset(errcode_ret), errcode_ret_is_direct, __addr_);
  }
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_program {@native clCreateProgramWithBuiltInKernels}(cl_context context, cl_uint num_devices, const cl_device_id *  device_list, const char *  kernel_names, cl_int *  errcode_ret)</code><br>
      ...
      @param kernel_names a direct or array-backed {@link java.nio.ByteBuffer}
      @param errcode_ret a direct or array-backed {@link java.nio.IntBuffer}   */
  private native long dispatch_clCreateProgramWithBuiltInKernels1(long context, int num_devices, Object device_list, int device_list_byte_offset, boolean device_list_is_direct, Object kernel_names, int kernel_names_byte_offset, boolean kernel_names_is_direct, Object errcode_ret, int errcode_ret_byte_offset, boolean errcode_ret_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_program {@native clCreateProgramWithBuiltInKernels}(cl_context context, cl_uint num_devices, const cl_device_id *  device_list, const char *  kernel_names, cl_int *  errcode_ret)</code><br>
      @param device_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  public long clCreateProgramWithBuiltInKernels(long context, int num_devices, PointerBuffer device_list, byte[] kernel_names, int kernel_names_offset, int[] errcode_ret, int errcode_ret_offset)  {

    final boolean device_list_is_direct = Buffers.isDirect(device_list);
    if(kernel_names != null && kernel_names.length <= kernel_names_offset)
      throw new IllegalArgumentException("array offset argument \"kernel_names_offset\" (" + kernel_names_offset + ") equals or exceeds array length (" + kernel_names.length + ")");
    if(errcode_ret != null && errcode_ret.length <= errcode_ret_offset)
      throw new IllegalArgumentException("array offset argument \"errcode_ret_offset\" (" + errcode_ret_offset + ") equals or exceeds array length (" + errcode_ret.length + ")");
    final long __addr_ = addressTable._addressof_clCreateProgramWithBuiltInKernels;
    if (__addr_ == 0) {
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clUnloadPlatformCompiler}(cl_platform_id platform)</code><br>   */
  public int clUnloadPlatformCompiler(long platform)  {

    final long __addr_ = addressTable._addressof_clUnloadPlatformCompiler;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clUnloadPlatformCompiler"));
    }
        return dispatch_clUnloadPlatformCompiler1(platform, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clUnloadPlatformCompiler}(cl_platform_id platform)</code><br>   */
  private native int dispatch_clUnloadPlatformCompiler1(long platform, long procAddress);
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clSetKernelArgSVMPointer}(cl_kernel kernel, cl_uint arg_index, const void *  arg_value)</code><br>
      @param arg_value a direct or array-backed {@link java.nio.Buffer}   */
  public int clSetKernelArgSVMPointer(long kernel, int arg_index, Buffer arg_value)  {

    final boolean arg_value_is_direct = Buffers.isDirect(arg_value);
    final long __addr_ = addressTable._addressof_clSetKernelArgSVMPointer;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clSetKernelArgSVMPointer"));
    }
        return dispatch_clSetKernelArgSVMPointer1(kernel, arg_index, arg_value_is_direct ? arg_value : Buffers.getArray(arg_value), arg_value_is_direct ? Buffers.getDirectBufferByteOffset(arg_value) : Buffers.getIndirectBufferByteOffset(arg_value), arg_value_is_direct, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clSetKernelArgSVMPointer}(cl_kernel kernel, cl_uint arg_index, const void *  arg_value)</code><br>
      @param arg_value a direct or array-backed {@link java.nio.Buffer}   */
  private native int dispatch_clSetKernelArgSVMPointer1(long kernel, int arg_index, Object arg_value, int arg_value_byte_offset, boolean arg_value_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clSetKernelExecInfo}(cl_kernel kernel, cl_kernel_exec_info param_name, size_t param_value_size, const void *  param_value)</code><br>
      @param param_value a direct or array-backed {@link java.nio.Buffer}   */
  public int clSetKernelExecInfo(long kernel, int param_name, long param_value_size, Buffer param_value)  {

    final boolean param_value_is_direct = Buffers.isDirect(param_value);
    final long __addr_ = addressTable._addressof_clSetKernelExecInfo;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clSetKernelExecInfo"));
    }
        return dispatch_clSetKernelExecInfo1(kernel, param_name, param_value_size, param_value_is_direct ? param_value : Buffers.getArray(param_value), param_value_is_direct ? Buffers.getDirectBufferByteOffset(param_value) : Buffers.getIndirectBufferByteOffset(param_value), param_value_is_direct, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clSetKernelExecInfo}(cl_kernel kernel, cl_kernel_exec_info param_name, size_t param_value_size, const void *  param_value)</code><br>
      @param param_value a direct or array-backed {@link java.nio.Buffer}   */
  private native int dispatch_clSetKernelExecInfo1(long kernel, int param_name, long param_value_size, Object param_value, int param_value_byte_offset, boolean param_value_is_direct, long procAddress);
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clGetKernelArgInfo}(cl_kernel kernel, cl_uint arg_indx, cl_kernel_arg_info param_name, size_t param_value_size, void *  param_value, size_t *  param_value_size_ret)</code><br>
      @param param_value a direct or array-backed {@link java.nio.Buffer}
      @param param_value_size_ret a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  public int clGetKernelArgInfo(long kernel, int arg_indx, int param_name, long param_value_size, Buffer param_value, PointerBuffer param_value_size_ret)  {

    final boolean param_value_is_direct = Buffers.isDirect(param_value);
    final boolean param_value_size_ret_is_direct = Buffers.isDirect(param_value_size_ret);
    final long __addr_ = addressTable._addressof_clGetKernelArgInfo;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clGetKernelArgInfo"));
    }
        return dispatch_clGetKernelArgInfo1(kernel, arg_indx, param_name, param_value_size, param_value_is_direct ? param_value : Buffers.getArray(param_value), param_value_is_direct ? Buffers.getDirectBufferByteOffset(param_value) : Buffers.getIndirectBufferByteOffset(param_value), param_value_is_direct, param_value_size_ret_is_direct ? ( param_value_size_ret != null ? param_value_size_ret.getBuffer() : null ) : Buffers.getArray(param_value_size_ret), param_value_size_ret_is_direct ? Buffers.getDirectBufferByteOffset(param_value_size_ret) : Buffers.getIndirectBufferByteOffset(param_value_size_ret), param_value_size_ret_is_direct, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clGetKernelArgInfo}(cl_kernel kernel, cl_uint arg_indx, cl_kernel_arg_info param_name, size_t param_value_size, void *  param_value, size_t *  param_value_size_ret)</code><br>
      @param param_value a direct or array-backed {@link java.nio.Buffer}
      @param param_value_size_ret a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  private native int dispatch_clGetKernelArgInfo1(long kernel, int arg_indx, int param_name, long param_value_size, Object param_value, int param_value_byte_offset, boolean param_value_is_direct, Object param_value_size_ret, int param_value_size_ret_byte_offset, boolean param_value_size_ret_is_direct, long procAddress);
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueReadBuffer}(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_read, size_t offset, size_t size, void *  ptr, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
  ...
  public int clEnqueueReadBuffer(long command_queue, long buffer, int blocking_read, long offset, long size, Buffer ptr, int num_events_in_wait_list, PointerBuffer event_wait_list, PointerBuffer event)  {
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueReadBuffer}(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_read, size_t offset, size_t size, void *  ptr, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      ...
      @param event_wait_list a direct only {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  private native int dispatch_clEnqueueReadBuffer0(long command_queue, long buffer, int blocking_read, long offset, long size, Object ptr, int ptr_byte_offset, int num_events_in_wait_list, Object event_wait_list, int event_wait_list_byte_offset, Object event, int event_byte_offset, long procAddress);
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueReadBufferRect}(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_read, const size_t *  buffer_offset, const size_t *  host_offset, const size_t *  region, size_t buffer_row_pitch, size_t buffer_slice_pitch, size_t host_row_pitch, size_t host_slice_pitch, void *  ptr, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      @param buffer_offset a direct only {@link com.jogamp.common.nio.PointerBuffer}
      @param host_offset a direct only {@link com.jogamp.common.nio.PointerBuffer}
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueReadBufferRect}(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_read, const size_t *  buffer_offset, const size_t *  host_offset, const size_t *  region, size_t buffer_row_pitch, size_t buffer_slice_pitch, size_t host_row_pitch, size_t host_slice_pitch, void *  ptr, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      ...
      @param event_wait_list a direct only {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  private native int dispatch_clEnqueueReadBufferRect0(long command_queue, long buffer, int blocking_read, Object buffer_offset, int buffer_offset_byte_offset, Object host_offset, int host_offset_byte_offset, Object region, int region_byte_offset, long buffer_row_pitch, long buffer_slice_pitch, long host_row_pitch, long host_slice_pitch, Object ptr, int ptr_byte_offset, int num_events_in_wait_list, Object event_wait_list, int event_wait_list_byte_offset, Object event, int event_byte_offset, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueWriteBuffer}(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_write, size_t offset, size_t size, const void *  ptr, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      @param ptr a direct only {@link java.nio.Buffer}
      @param event_wait_list a direct only {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  public int clEnqueueWriteBuffer(long command_queue, long buffer, int blocking_write, long offset, long size, Buffer ptr, int num_events_in_wait_list, PointerBuffer event_wait_list, PointerBuffer event)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clEnqueueWriteBuffer"));
        ...
        return dispatch_clEnqueueWriteBuffer0(command_queue, buffer, blocking_write, offset, size, ptr, Buffers.getDirectBufferByteOffset(ptr), num_events_in_wait_list, event_wait_list != null ? event_wait_list.getBuffer() : null, Buffers.getDirectBufferByteOffset(event_wait_list), event != null ? event.getBuffer() : null, Buffers.getDirectBufferByteOffset(event), __addr_);
  }
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueWriteBuffer}(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_write, size_t offset, size_t size, const void *  ptr, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      ...
      @param event_wait_list a direct only {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  private native int dispatch_clEnqueueWriteBuffer0(long command_queue, long buffer, int blocking_write, long offset, long size, Object ptr, int ptr_byte_offset, int num_events_in_wait_list, Object event_wait_list, int event_wait_list_byte_offset, Object event, int event_byte_offset, long procAddress);
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueFillBuffer}(cl_command_queue command_queue, cl_mem buffer, const void *  pattern, size_t pattern_size, size_t offset, size_t size, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      @param pattern a direct or array-backed {@link java.nio.Buffer}
      @param event_wait_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  public int clEnqueueFillBuffer(long command_queue, long buffer, Buffer pattern, long pattern_size, long offset, long size, int num_events_in_wait_list, PointerBuffer event_wait_list, PointerBuffer event)  {

    final boolean pattern_is_direct = Buffers.isDirect(pattern);
    final boolean event_wait_list_is_direct = Buffers.isDirect(event_wait_list);
    final boolean event_is_direct = Buffers.isDirect(event);
    final long __addr_ = addressTable._addressof_clEnqueueFillBuffer;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clEnqueueFillBuffer"));
    }
        return dispatch_clEnqueueFillBuffer1(command_queue, buffer, pattern_is_direct ? pattern : Buffers.getArray(pattern), pattern_is_direct ? Buffers.getDirectBufferByteOffset(pattern) : Buffers.getIndirectBufferByteOffset(pattern), pattern_is_direct, pattern_size, offset, size, num_events_in_wait_list, event_wait_list_is_direct ? ( event_wait_list != null ? event_wait_list.getBuffer() : null ) : Buffers.getArray(event_wait_list), event_wait_list_is_direct ? Buffers.getDirectBufferByteOffset(event_wait_list) : Buffers.getIndirectBufferByteOffset(event_wait_list), event_wait_list_is_direct, event_is_direct ? ( event != null ? event.getBuffer() : null ) : Buffers.getArray(event), event_is_direct ? Buffers.getDirectBufferByteOffset(event) : Buffers.getIndirectBufferByteOffset(event), event_is_direct, __addr_);
  }
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueCopyBuffer}(cl_command_queue command_queue, cl_mem src_buffer, cl_mem dst_buffer, size_t src_offset, size_t dst_offset, size_t size, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      @param event_wait_list a direct only {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  private native int dispatch_clEnqueueCopyBuffer0(long command_queue, long src_buffer, long dst_buffer, long src_offset, long dst_offset, long size, int num_events_in_wait_list, Object event_wait_list, int event_wait_list_byte_offset, Object event, int event_byte_offset, long procAddress);
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueMigrateMemObjects}(cl_command_queue command_queue, cl_uint num_mem_objects, const cl_mem *  mem_objects, cl_mem_migration_flags flags, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      @param mem_objects a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event_wait_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  public int clEnqueueMigrateMemObjects(long command_queue, int num_mem_objects, PointerBuffer mem_objects, long flags, int num_events_in_wait_list, PointerBuffer event_wait_list, PointerBuffer event)  {

    final boolean mem_objects_is_direct = Buffers.isDirect(mem_objects);
    final boolean event_wait_list_is_direct = Buffers.isDirect(event_wait_list);
    final boolean event_is_direct = Buffers.isDirect(event);
    final long __addr_ = addressTable._addressof_clEnqueueMigrateMemObjects;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clEnqueueMigrateMemObjects"));
    }
        return dispatch_clEnqueueMigrateMemObjects1(command_queue, num_mem_objects, mem_objects_is_direct ? ( mem_objects != null ? mem_objects.getBuffer() : null ) : Buffers.getArray(mem_objects), mem_objects_is_direct ? Buffers.getDirectBufferByteOffset(mem_objects) : Buffers.getIndirectBufferByteOffset(mem_objects), mem_objects_is_direct, flags, num_events_in_wait_list, event_wait_list_is_direct ? ( event_wait_list != null ? event_wait_list.getBuffer() : null ) : Buffers.getArray(event_wait_list), event_wait_list_is_direct ? Buffers.getDirectBufferByteOffset(event_wait_list) : Buffers.getIndirectBufferByteOffset(event_wait_list), event_wait_list_is_direct, event_is_direct ? ( event != null ? event.getBuffer() : null ) : Buffers.getArray(event), event_is_direct ? Buffers.getDirectBufferByteOffset(event) : Buffers.getIndirectBufferByteOffset(event), event_is_direct, __addr_);
  }
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueMarkerWithWaitList}(cl_command_queue command_queue, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      @param event_wait_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  public int clEnqueueMarkerWithWaitList(long command_queue, int num_events_in_wait_list, PointerBuffer event_wait_list, PointerBuffer event)  {

    final boolean event_wait_list_is_direct = Buffers.isDirect(event_wait_list);
    final boolean event_is_direct = Buffers.isDirect(event);
    final long __addr_ = addressTable._addressof_clEnqueueMarkerWithWaitList;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clEnqueueMarkerWithWaitList"));
    }
        return dispatch_clEnqueueMarkerWithWaitList1(command_queue, num_events_in_wait_list, event_wait_list_is_direct ? ( event_wait_list != null ? event_wait_list.getBuffer() : null ) : Buffers.getArray(event_wait_list), event_wait_list_is_direct ? Buffers.getDirectBufferByteOffset(event_wait_list) : Buffers.getIndirectBufferByteOffset(event_wait_list), event_wait_list_is_direct, event_is_direct ? ( event != null ? event.getBuffer() : null ) : Buffers.getArray(event), event_is_direct ? Buffers.getDirectBufferByteOffset(event) : Buffers.getIndirectBufferByteOffset(event), event_is_direct, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueMarkerWithWaitList}(cl_command_queue command_queue, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      @param event_wait_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  private native int dispatch_clEnqueueMarkerWithWaitList1(long command_queue, int num_events_in_wait_list, Object event_wait_list, int event_wait_list_byte_offset, boolean event_wait_list_is_direct, Object event, int event_byte_offset, boolean event_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueBarrierWithWaitList}(cl_command_queue command_queue, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      @param event_wait_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  public int clEnqueueBarrierWithWaitList(long command_queue, int num_events_in_wait_list, PointerBuffer event_wait_list, PointerBuffer event)  {

    final boolean event_wait_list_is_direct = Buffers.isDirect(event_wait_list);
    final boolean event_is_direct = Buffers.isDirect(event);
    final long __addr_ = addressTable._addressof_clEnqueueBarrierWithWaitList;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clEnqueueBarrierWithWaitList"));
    }
        return dispatch_clEnqueueBarrierWithWaitList1(command_queue, num_events_in_wait_list, event_wait_list_is_direct ? ( event_wait_list != null ? event_wait_list.getBuffer() : null ) : Buffers.getArray(event_wait_list), event_wait_list_is_direct ? Buffers.getDirectBufferByteOffset(event_wait_list) : Buffers.getIndirectBufferByteOffset(event_wait_list), event_wait_list_is_direct, event_is_direct ? ( event != null ? event.getBuffer() : null ) : Buffers.getArray(event), event_is_direct ? Buffers.getDirectBufferByteOffset(event) : Buffers.getIndirectBufferByteOffset(event), event_is_direct, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueBarrierWithWaitList}(cl_command_queue command_queue, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      @param event_wait_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  private native int dispatch_clEnqueueBarrierWithWaitList1(long command_queue, int num_events_in_wait_list, Object event_wait_list, int event_wait_list_byte_offset, boolean event_wait_list_is_direct, Object event, int event_byte_offset, boolean event_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueSVMFree}(cl_command_queue command_queue, cl_uint num_svm_pointers, void *  * , void * , void *  user_data, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      @param arg2 a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param arg3 a direct or array-backed {@link java.nio.Buffer}
      @param user_data a direct or array-backed {@link java.nio.Buffer}
      @param event_wait_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  public int clEnqueueSVMFree(long command_queue, int num_svm_pointers, PointerBuffer arg2, Buffer arg3, Buffer user_data, int num_events_in_wait_list, PointerBuffer event_wait_list, PointerBuffer event)  {

    final boolean arg2_is_direct = Buffers.isDirect(arg2);
    final boolean arg3_is_direct = Buffers.isDirect(arg3);
    final boolean user_data_is_direct = Buffers.isDirect(user_data);
    final boolean event_wait_list_is_direct = Buffers.isDirect(event_wait_list);
    final boolean event_is_direct = Buffers.isDirect(event);
    final long __addr_ = addressTable._addressof_clEnqueueSVMFree;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clEnqueueSVMFree"));
    }
        return dispatch_clEnqueueSVMFree1(command_queue, num_svm_pointers, arg2_is_direct ? ( arg2 != null ? arg2.getBuffer() : null ) : Buffers.getArray(arg2), arg2_is_direct ? Buffers.getDirectBufferByteOffset(arg2) : Buffers.getIndirectBufferByteOffset(arg2), arg2_is_direct, arg3_is_direct ? arg3 : Buffers.getArray(arg3), arg3_is_direct ? Buffers.getDirectBufferByteOffset(arg3) : Buffers.getIndirectBufferByteOffset(arg3), arg3_is_direct, user_data_is_direct ? user_data : Buffers.getArray(user_data), user_data_is_direct ? Buffers.getDirectBufferByteOffset(user_data) : Buffers.getIndirectBufferByteOffset(user_data), user_data_is_direct, num_events_in_wait_list, event_wait_list_is_direct ? ( event_wait_list != null ? event_wait_list.getBuffer() : null ) : Buffers.getArray(event_wait_list), event_wait_list_is_direct ? Buffers.getDirectBufferByteOffset(event_wait_list) : Buffers.getIndirectBufferByteOffset(event_wait_list), event_wait_list_is_direct, event_is_direct ? ( event != null ? event.getBuffer() : null ) : Buffers.getArray(event), event_is_direct ? Buffers.getDirectBufferByteOffset(event) : Buffers.getIndirectBufferByteOffset(event), event_is_direct, __addr_);
  }
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueSVMFree}(cl_command_queue command_queue, cl_uint num_svm_pointers, void *  * , void * , void *  user_data, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      ...
      @param event_wait_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  private native int dispatch_clEnqueueSVMFree1(long command_queue, int num_svm_pointers, Object arg2, int arg2_byte_offset, boolean arg2_is_direct, Object arg3, int arg3_byte_offset, boolean arg3_is_direct, Object user_data, int user_data_byte_offset, boolean user_data_is_direct, int num_events_in_wait_list, Object event_wait_list, int event_wait_list_byte_offset, boolean event_wait_list_is_direct, Object event, int event_byte_offset, boolean event_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueSVMMemcpy}(cl_command_queue command_queue, cl_bool blocking_copy, void *  dst_ptr, const void *  src_ptr, size_t size, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      @param dst_ptr a direct or array-backed {@link java.nio.Buffer}
      @param src_ptr a direct or array-backed {@link java.nio.Buffer}
      @param event_wait_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  public int clEnqueueSVMMemcpy(long command_queue, int blocking_copy, Buffer dst_ptr, Buffer src_ptr, long size, int num_events_in_wait_list, PointerBuffer event_wait_list, PointerBuffer event)  {

    final boolean dst_ptr_is_direct = Buffers.isDirect(dst_ptr);
    final boolean src_ptr_is_direct = Buffers.isDirect(src_ptr);
    final boolean event_wait_list_is_direct = Buffers.isDirect(event_wait_list);
    final boolean event_is_direct = Buffers.isDirect(event);
    final long __addr_ = addressTable._addressof_clEnqueueSVMMemcpy;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clEnqueueSVMMemcpy"));
    }
        return dispatch_clEnqueueSVMMemcpy1(command_queue, blocking_copy, dst_ptr_is_direct ? dst_ptr : Buffers.getArray(dst_ptr), dst_ptr_is_direct ? Buffers.getDirectBufferByteOffset(dst_ptr) : Buffers.getIndirectBufferByteOffset(dst_ptr), dst_ptr_is_direct, src_ptr_is_direct ? src_ptr : Buffers.getArray(src_ptr), src_ptr_is_direct ? Buffers.getDirectBufferByteOffset(src_ptr) : Buffers.getIndirectBufferByteOffset(src_ptr), src_ptr_is_direct, size, num_events_in_wait_list, event_wait_list_is_direct ? ( event_wait_list != null ? event_wait_list.getBuffer() : null ) : Buffers.getArray(event_wait_list), event_wait_list_is_direct ? Buffers.getDirectBufferByteOffset(event_wait_list) : Buffers.getIndirectBufferByteOffset(event_wait_list), event_wait_list_is_direct, event_is_direct ? ( event != null ? event.getBuffer() : null ) : Buffers.getArray(event), event_is_direct ? Buffers.getDirectBufferByteOffset(event) : Buffers.getIndirectBufferByteOffset(event), event_is_direct, __addr_);
  }
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueSVMMemcpy}(cl_command_queue command_queue, cl_bool blocking_copy, void *  dst_ptr, const void *  src_ptr, size_t size, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      ...
      @param event_wait_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  private native int dispatch_clEnqueueSVMMemcpy1(long command_queue, int blocking_copy, Object dst_ptr, int dst_ptr_byte_offset, boolean dst_ptr_is_direct, Object src_ptr, int src_ptr_byte_offset, boolean src_ptr_is_direct, long size, int num_events_in_wait_list, Object event_wait_list, int event_wait_list_byte_offset, boolean event_wait_list_is_direct, Object event, int event_byte_offset, boolean event_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueSVMMemFill}(cl_command_queue command_queue, void *  svm_ptr, const void *  pattern, size_t pattern_size, size_t size, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      @param svm_ptr a direct or array-backed {@link java.nio.Buffer}
      @param pattern a direct or array-backed {@link java.nio.Buffer}
      @param event_wait_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  public int clEnqueueSVMMemFill(long command_queue, Buffer svm_ptr, Buffer pattern, long pattern_size, long size, int num_events_in_wait_list, PointerBuffer event_wait_list, PointerBuffer event)  {

    final boolean svm_ptr_is_direct = Buffers.isDirect(svm_ptr);
    final boolean pattern_is_direct = Buffers.isDirect(pattern);
    final boolean event_wait_list_is_direct = Buffers.isDirect(event_wait_list);
    final boolean event_is_direct = Buffers.isDirect(event);
    final long __addr_ = addressTable._addressof_clEnqueueSVMMemFill;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clEnqueueSVMMemFill"));
    }
        return dispatch_clEnqueueSVMMemFill1(command_queue, svm_ptr_is_direct ? svm_ptr : Buffers.getArray(svm_ptr), svm_ptr_is_direct ? Buffers.getDirectBufferByteOffset(svm_ptr) : Buffers.getIndirectBufferByteOffset(svm_ptr), svm_ptr_is_direct, pattern_is_direct ? pattern : Buffers.getArray(pattern), pattern_is_direct ? Buffers.getDirectBufferByteOffset(pattern) : Buffers.getIndirectBufferByteOffset(pattern), pattern_is_direct, pattern_size, size, num_events_in_wait_list, event_wait_list_is_direct ? ( event_wait_list != null ? event_wait_list.getBuffer() : null ) : Buffers.getArray(event_wait_list), event_wait_list_is_direct ? Buffers.getDirectBufferByteOffset(event_wait_list) : Buffers.getIndirectBufferByteOffset(event_wait_list), event_wait_list_is_direct, event_is_direct ? ( event != null ? event.getBuffer() : null ) : Buffers.getArray(event), event_is_direct ? Buffers.getDirectBufferByteOffset(event) : Buffers.getIndirectBufferByteOffset(event), event_is_direct, __addr_);
  }
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueSVMMemFill}(cl_command_queue command_queue, void *  svm_ptr, const void *  pattern, size_t pattern_size, size_t size, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      ...
      @param event_wait_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  private native int dispatch_clEnqueueSVMMemFill1(long command_queue, Object svm_ptr, int svm_ptr_byte_offset, boolean svm_ptr_is_direct, Object pattern, int pattern_byte_offset, boolean pattern_is_direct, long pattern_size, long size, int num_events_in_wait_list, Object event_wait_list, int event_wait_list_byte_offset, boolean event_wait_list_is_direct, Object event, int event_byte_offset, boolean event_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueSVMMap}(cl_command_queue command_queue, cl_bool blocking_map, cl_map_flags flags, void *  svm_ptr, size_t size, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      @param svm_ptr a direct or array-backed {@link java.nio.Buffer}
      @param event_wait_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  public int clEnqueueSVMMap(long command_queue, int blocking_map, long flags, Buffer svm_ptr, long size, int num_events_in_wait_list, PointerBuffer event_wait_list, PointerBuffer event)  {

    final boolean svm_ptr_is_direct = Buffers.isDirect(svm_ptr);
    final boolean event_wait_list_is_direct = Buffers.isDirect(event_wait_list);
    final boolean event_is_direct = Buffers.isDirect(event);
    final long __addr_ = addressTable._addressof_clEnqueueSVMMap;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clEnqueueSVMMap"));
    }
        return dispatch_clEnqueueSVMMap1(command_queue, blocking_map, flags, svm_ptr_is_direct ? svm_ptr : Buffers.getArray(svm_ptr), svm_ptr_is_direct ? Buffers.getDirectBufferByteOffset(svm_ptr) : Buffers.getIndirectBufferByteOffset(svm_ptr), svm_ptr_is_direct, size, num_events_in_wait_list, event_wait_list_is_direct ? ( event_wait_list != null ? event_wait_list.getBuffer() : null ) : Buffers.getArray(event_wait_list), event_wait_list_is_direct ? Buffers.getDirectBufferByteOffset(event_wait_list) : Buffers.getIndirectBufferByteOffset(event_wait_list), event_wait_list_is_direct, event_is_direct ? ( event != null ? event.getBuffer() : null ) : Buffers.getArray(event), event_is_direct ? Buffers.getDirectBufferByteOffset(event) : Buffers.getIndirectBufferByteOffset(event), event_is_direct, __addr_);
  }
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clEnqueueSVMUnmap}(cl_command_queue command_queue, void *  svm_ptr, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)</code><br>
      ...
      @param event_wait_list a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}
      @param event a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  private native int dispatch_clEnqueueSVMUnmap1(long command_queue, Object svm_ptr, int svm_ptr_byte_offset, boolean svm_ptr_is_direct, int num_events_in_wait_list, Object event_wait_list, int event_wait_list_byte_offset, boolean event_wait_list_is_direct, Object event, int event_byte_offset, boolean event_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>void *  {@native clGetExtensionFunctionAddressForPlatform}(cl_platform_id platform, const char *  func_name)</code><br>
      @param func_name a direct or array-backed {@link java.nio.ByteBuffer}   */
  public ByteBuffer clGetExtensionFunctionAddressForPlatform(long platform, ByteBuffer func_name)  {

    final boolean func_name_is_direct = Buffers.isDirect(func_name);
    final long __addr_ = addressTable._addressof_clGetExtensionFunctionAddressForPlatform;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clGetExtensionFunctionAddressForPlatform"));
    }
    final ByteBuffer _res;
    _res = dispatch_clGetExtensionFunctionAddressForPlatform1(platform, func_name_is_direct ? func_name : Buffers.getArray(func_name), func_name_is_direct ? Buffers.getDirectBufferByteOffset(func_name) : Buffers.getIndirectBufferByteOffset(func_name), func_name_is_direct, __addr_);
    if (_res == null) return null;
    Buffers.nativeOrder(_res);
    return _res;
  }
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>void *  {@native clGetExtensionFunctionAddressForPlatform}(cl_platform_id platform, const char *  func_name)</code><br>
      @param func_name a direct or array-backed {@link java.nio.ByteBuffer}   */
  private native ByteBuffer dispatch_clGetExtensionFunctionAddressForPlatform1(long platform, Object func_name, int func_name_byte_offset, boolean func_name_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>void *  {@native clGetExtensionFunctionAddressForPlatform}(cl_platform_id platform, const char *  func_name)</code><br>   */
  public ByteBuffer clGetExtensionFunctionAddressForPlatform(long platform, byte[] func_name, int func_name_offset)  {

    if(func_name != null && func_name.length <= func_name_offset)
      throw new IllegalArgumentException("array offset argument \"func_name_offset\" (" + func_name_offset + ") equals or exceeds array length (" + func_name.length + ")");
    final long __addr_ = addressTable._addressof_clGetExtensionFunctionAddressForPlatform;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clGetExtensionFunctionAddressForPlatform"));
    }
    final ByteBuffer _res;
    _res = dispatch_clGetExtensionFunctionAddressForPlatform1(platform, func_name, func_name_offset, false, __addr_);
    if (_res == null) return null;
    Buffers.nativeOrder(_res);
    return _res;
  }
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clUnloadCompiler}()</code><br>   */
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clTerminateContextKHR}(cl_context)</code><br>   */
  public int clTerminateContextKHR(long arg0)  {

    final long __addr_ = addressTable._addressof_clTerminateContextKHR;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clTerminateContextKHR"));
    }
        return dispatch_clTerminateContextKHR1(arg0, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_int {@native clTerminateContextKHR}(cl_context)</code><br>   */
  private native int dispatch_clTerminateContextKHR1(long arg0, long procAddress);
  ...
  /** Entry point (through function pointer) to C language function: <br> <code>cl_mem {@native clCreateFromGLTexture}(cl_context context, cl_mem_flags flags, cl_GLenum target, cl_GLint miplevel, cl_GLuint texture, cl_int *  errcode_ret)</code><br>
      @param errcode_ret a direct or array-backed {@link java.nio.IntBuffer}   */
  public long clCreateFromGLTexture(long context, long flags, int target, int miplevel, int texture, IntBuffer errcode_ret)  {

    final boolean errcode_ret_is_direct = Buffers.isDirect(errcode_ret);
    final long __addr_ = addressTable._addressof_clCreateFromGLTexture;
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clCreateFromGLTexture"));
    }
        return dispatch_clCreateFromGLTexture1(context, flags, target, miplevel, texture, errcode_ret_is_direct ? errcode_ret : Buffers.getArray(errcode_ret), errcode_ret_is_direct ? Buffers.getDirectBufferByteOffset(errcode_ret) : Buffers.getIndirectBufferByteOffset(errcode_ret), errcode_ret_is_direct, __addr_);
  }

  /** Entry point (through function pointer) to C language function: <br> <code>cl_mem {@native clCreateFromGLTexture}(cl_context context, cl_mem_flags flags, cl_GLenum target, cl_GLint miplevel, cl_GLuint texture, cl_int *  errcode_ret)</code><br>
      @param errcode_ret a direct or array-backed {@link java.nio.IntBuffer}   */
  private native long dispatch_clCreateFromGLTexture1(long context, long flags, int target, int miplevel, int texture, Object errcode_ret, int errcode_ret_byte_offset, boolean errcode_ret_is_direct, long procAddress);

  /** Entry point (through function pointer) to C language function: <br> <code>cl_mem {@native clCreateFromGLTexture}(cl_context context, cl_mem_flags flags, cl_GLenum target, cl_GLint miplevel, cl_GLuint texture, cl_int *  errcode_ret)</code><br>   */
  public long clCreateFromGLTexture(long context, long flags, int target, int miplevel, int texture, int[] errcode_ret, int errcode_ret_offset)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "clCreateFromGLTexture"));
        ...
        return dispatch_clCreateFromGLTexture1(context, flags, target, miplevel, texture, errcode_ret, Buffers.SIZEOF_INT * errcode_ret_offset, false, __addr_);
  }
