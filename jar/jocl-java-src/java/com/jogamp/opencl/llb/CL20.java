...
/* !---- Java-Unit: [pkg com.jogamp.opencl.llb, cls CL20], ../build/gensrc/java/com/jogamp/opencl/llb/CL20.java ----! */
...
public interface CL20 extends CL{
  ...
  /** Define "CL_COMMAND_MIGRATE_MEM_OBJECTS" with expression '<code>0x1206</code>', CType: int */
  ...
  /** Define "CL_sBGRA" with expression '<code>0x10C2</code>', CType: int */
  public static final int CL_sBGRA = 0x10c2;
  /** Define "CL_sRGBA" with expression '<code>0x10C1</code>', CType: int */
  ...
  /** Define "CL_PROGRAM_BUILD_GLOBAL_VARIABLE_TOTAL_SIZE" with expression '<code>0x1185</code>', CType: int */
  ...
  /** Define "CL_KERNEL_ARG_TYPE_RESTRICT" with expression '<code>(1 << 1)</code>', CType: int */
  public static final int CL_KERNEL_ARG_TYPE_RESTRICT = ( 0x1 << 0x1 );
  /** Define "CL_FP_INF_NAN" with expression '<code>(1 << 1)</code>', CType: int */
  public static final int CL_FP_INF_NAN = ( 0x1 << 0x1 );
  /** Define "CL_COMMAND_SVM_MEMCPY" with expression '<code>0x120A</code>', CType: int */
  ...
  /** Define "CL_DEPTH_STENCIL" with expression '<code>0x10BE</code>', CType: int */
  ...
  /** Define "CL_DEVICE_SVM_FINE_GRAIN_SYSTEM" with expression '<code>(1 << 2)</code>', CType: int */
  public static final int CL_DEVICE_SVM_FINE_GRAIN_SYSTEM = ( 0x1 << 0x2 );
  /** Define "CL_KERNEL_ATTRIBUTES" with expression '<code>0x1195</code>', CType: int */
  public static final int CL_KERNEL_ATTRIBUTES = 0x1195;
  /** Define "CL_KERNEL_ARG_TYPE_NONE" with expression '<code>0</code>', CType: int */
  public static final int CL_KERNEL_ARG_TYPE_NONE = 0x0;
  ...
  /** Define "CL_DEVICE_PREFERRED_INTEROP_USER_SYNC" with expression '<code>0x1048</code>', CType: int */
  public static final int CL_DEVICE_PREFERRED_INTEROP_USER_SYNC = 0x1048;
  /** Define "CL_CONTEXT_TERMINATE_KHR" with expression '<code>0x2010</code>', CType: int */
  ...
  /** Define "CL_IMAGE_BUFFER" with expression '<code>0x1118</code>', CType: int */
  ...
  /** Define "CL_COMPILE_PROGRAM_FAILURE" with expression '<code>-15</code>', CType: int */
  ...
  /** Define "CL_KERNEL_GLOBAL_WORK_SIZE" with expression '<code>0x11B5</code>', CType: int */
  ...
  /** Define "CL_MIGRATE_MEM_OBJECT_CONTENT_UNDEFINED" with expression '<code>(1 << 1)</code>', CType: int */
  public static final int CL_MIGRATE_MEM_OBJECT_CONTENT_UNDEFINED = ( 0x1 << 0x1 );
  /** Define "CL_DEVICE_BUILT_IN_KERNELS" with expression '<code>0x103F</code>', CType: int */
  ...
  /** Define "CL_DEVICE_QUEUE_ON_DEVICE_PROPERTIES" with expression '<code>0x104E</code>', CType: int */
  ...
  /** Define "CL_MEM_OBJECT_PIPE" with expression '<code>0x10F7</code>', CType: int */
  ...
  /** Define "CL_KERNEL_ARG_TYPE_VOLATILE" with expression '<code>(1 << 2)</code>', CType: int */
  public static final int CL_KERNEL_ARG_TYPE_VOLATILE = ( 0x1 << 0x2 );
  ...
  /** Define "CL_DEVICE_PIPE_MAX_ACTIVE_RESERVATIONS" with expression '<code>0x1056</code>', CType: int */
  public static final int CL_DEVICE_PIPE_MAX_ACTIVE_RESERVATIONS = 0x1056;
  /** Define "CL_DEVICE_PARTITION_FAILED" with expression '<code>-18</code>', CType: int */
  ...
  /** Define "CL_VERSION_1_2" with expression '<code>1</code>', CType: int */
  ...
  /** Define "CL_DEVICE_LINKER_AVAILABLE" with expression '<code>0x103E</code>', CType: int */
  public static final int CL_DEVICE_LINKER_AVAILABLE = 0x103e;
  /** Define "CL_KERNEL_ARG_TYPE_NAME" with expression '<code>0x1198</code>', CType: int */
  ...
  /** Define "CL_QUEUE_ON_DEVICE_DEFAULT" with expression '<code>(1 << 3)</code>', CType: int */
  public static final int CL_QUEUE_ON_DEVICE_DEFAULT = ( 0x1 << 0x3 );
  ...
  /** Define "CL_PROGRAM_KERNEL_NAMES" with expression '<code>0x1168</code>', CType: int */
  public static final int CL_PROGRAM_KERNEL_NAMES = 0x1168;
  /** Define "CL_COMMAND_SVM_MAP" with expression '<code>0x120C</code>', CType: int */
  ...
  /** Define "CL_KERNEL_ARG_INFO_NOT_AVAILABLE" with expression '<code>-19</code>', CType: int */
  public static final int CL_KERNEL_ARG_INFO_NOT_AVAILABLE = -19;
  /** Define "CL_IMAGE_NUM_SAMPLES" with expression '<code>0x111A</code>', CType: int */
  public static final int CL_IMAGE_NUM_SAMPLES = 0x111a;
  /** Define "CL_COMMAND_SVM_MEMFILL" with expression '<code>0x120B</code>', CType: int */
  public static final int CL_COMMAND_SVM_MEMFILL = 0x120b;
  /** Define "cl_khr_terminate_context" with expression '<code>1</code>', CType: int */
  public static final int cl_khr_terminate_context = 0x1;
  ...
  /** Define "CL_DEVICE_IMAGE_MAX_ARRAY_SIZE" with expression '<code>0x1041</code>', CType: int */
  public static final int CL_DEVICE_IMAGE_MAX_ARRAY_SIZE = 0x1041;
  /** Define "CL_UNORM_INT24" with expression '<code>0x10DF</code>', CType: int */
  ...
  /** Define "CL_DEVICE_MAX_GLOBAL_VARIABLE_SIZE" with expression '<code>0x104D</code>', CType: int */
  public static final int CL_DEVICE_MAX_GLOBAL_VARIABLE_SIZE = 0x104d;
  /** Define "CL_DEVICE_TERMINATE_CAPABILITY_KHR" with expression '<code>0x200F</code>', CType: int */
  ...
  /** Define "CL_IMAGE_NUM_MIP_LEVELS" with expression '<code>0x1119</code>', CType: int */
  ...
  /** Define "CL_DEVICE_PARENT_DEVICE" with expression '<code>0x1042</code>', CType: int */
  public static final int CL_DEVICE_PARENT_DEVICE = 0x1042;
  /** Define "CL_MEM_OBJECT_IMAGE2D_ARRAY" with expression '<code>0x10F3</code>', CType: int */
  ...
  /** Define "CL_VERSION_2_0" with expression '<code>1</code>', CType: int */
  public static final int CL_VERSION_2_0 = 0x1;
  /** Define "CL_DEVICE_PARTITION_BY_COUNTS" with expression '<code>0x1087</code>', CType: int */
  ...
  /** Define "CL_CONTEXT_INTEROP_USER_SYNC" with expression '<code>0x1085</code>', CType: int */
  ...
  /** Define "CL_KERNEL_ARG_ADDRESS_LOCAL" with expression '<code>0x119C</code>', CType: int */
  ...
  /** Define "CL_DEVICE_MAX_ON_DEVICE_QUEUES" with expression '<code>0x1051</code>', CType: int */
  public static final int CL_DEVICE_MAX_ON_DEVICE_QUEUES = 0x1051;
  /** Define "CL_KERNEL_ARG_ADDRESS_QUALIFIER" with expression '<code>0x1196</code>', CType: int */
  ...
  /** Define "CL_KERNEL_ARG_ACCESS_WRITE_ONLY" with expression '<code>0x11A1</code>', CType: int */
  ...
  /** Define "CL_INVALID_PIPE_SIZE" with expression '<code>-69</code>', CType: int */
  ...
  /** Define "CL_DEPTH" with expression '<code>0x10BD</code>', CType: int */
  ...
  /** Define "CL_DEVICE_QUEUE_ON_HOST_PROPERTIES" with expression '<code>0x102A</code>', CType: int */
  ...
  /** Define "CL_KERNEL_ARG_ADDRESS_PRIVATE" with expression '<code>0x119E</code>', CType: int */
  ...
  /** Define "CL_DEVICE_SVM_ATOMICS" with expression '<code>(1 << 3)</code>', CType: int */
  public static final int CL_DEVICE_SVM_ATOMICS = ( 0x1 << 0x3 );
  ...
  /** Define "CL_KERNEL_ARG_TYPE_QUALIFIER" with expression '<code>0x1199</code>', CType: int */
  public static final int CL_KERNEL_ARG_TYPE_QUALIFIER = 0x1199;
  /** Define "CL_DEVICE_AFFINITY_DOMAIN_L3_CACHE" with expression '<code>(1 << 2)</code>', CType: int */
  public static final int CL_DEVICE_AFFINITY_DOMAIN_L3_CACHE = ( 0x1 << 0x2 );
  ...
  /** Define "CL_INVALID_COMPILER_OPTIONS" with expression '<code>-66</code>', CType: int */
  ...
  /** Define "CL_INVALID_DEVICE_PARTITION_COUNT" with expression '<code>-68</code>', CType: int */
  ...
  /** Define "CL_MEM_HOST_NO_ACCESS" with expression '<code>(1 << 9)</code>', CType: int */
  public static final int CL_MEM_HOST_NO_ACCESS = ( 0x1 << 0x9 );
  ...
  /** Define "CL_BLOCKING" with expression '<code>1</code>', CType: int */
  ...
  /** Define "CL_DEVICE_REFERENCE_COUNT" with expression '<code>0x1047</code>', CType: int */
  ...
  /** Define "CL_DEVICE_AFFINITY_DOMAIN_L4_CACHE" with expression '<code>(1 << 1)</code>', CType: int */
  public static final int CL_DEVICE_AFFINITY_DOMAIN_L4_CACHE = ( 0x1 << 0x1 );
  /** Define "CL_KERNEL_ARG_ACCESS_READ_ONLY" with expression '<code>0x11A0</code>', CType: int */
  ...
  /** Define "CL_KERNEL_ARG_ADDRESS_GLOBAL" with expression '<code>0x119B</code>', CType: int */
  ...
  /** Define "CL_PROGRAM_BINARY_TYPE_INTERMEDIATE" with expression '<code>0x40E1</code>', CType: int */
  ...
  /** Define "CL_DEVICE_GLOBAL_VARIABLE_PREFERRED_TOTAL_SIZE" with expression '<code>0x1054</code>', CType: int */
  ...
  /** Define "CL_DEVICE_PIPE_MAX_PACKET_SIZE" with expression '<code>0x1057</code>', CType: int */
  public static final int CL_DEVICE_PIPE_MAX_PACKET_SIZE = 0x1057;
  /** Define "CL_INVALID_DEVICE_QUEUE" with expression '<code>-70</code>', CType: int */
  public static final int CL_INVALID_DEVICE_QUEUE = -70;
  /** Define "CL_DEVICE_SPIR_VERSIONS" with expression '<code>0x40E0</code>', CType: int */
  ...
  /** Define "CL_DEVICE_QUEUE_ON_DEVICE_PREFERRED_SIZE" with expression '<code>0x104F</code>', CType: int */
  public static final int CL_DEVICE_QUEUE_ON_DEVICE_PREFERRED_SIZE = 0x104f;
  /** Define "CL_DEVICE_PARTITION_BY_COUNTS_LIST_END" with expression '<code>0x0</code>', CType: int */
  ...
  /** Define "CL_DEVICE_AFFINITY_DOMAIN_L2_CACHE" with expression '<code>(1 << 3)</code>', CType: int */
  public static final int CL_DEVICE_AFFINITY_DOMAIN_L2_CACHE = ( 0x1 << 0x3 );
  ...
  /** Define "CL_DEVICE_IMAGE_MAX_BUFFER_SIZE" with expression '<code>0x1040</code>', CType: int */
  ...
  /** Define "CL_DEVICE_PRINTF_BUFFER_SIZE" with expression '<code>0x1049</code>', CType: int */
  ...
  /** Define "CL_ABGR" with expression '<code>0x10C3</code>', CType: int */
  ...
  /** Define "CL_IMAGE_ARRAY_SIZE" with expression '<code>0x1117</code>', CType: int */
  ...
  /** Define "CL_SAMPLER_LOD_MIN" with expression '<code>0x1156</code>', CType: int */
  ...
  /** Define "CL_COMMAND_SVM_UNMAP" with expression '<code>0x120D</code>', CType: int */
  public static final int CL_COMMAND_SVM_UNMAP = 0x120d;
  /** Define "CL_KERNEL_ARG_NAME" with expression '<code>0x119A</code>', CType: int */
  ...
  /** Define "CL_DEVICE_PREFERRED_GLOBAL_ATOMIC_ALIGNMENT" with expression '<code>0x1059</code>', CType: int */
  ...
  /** Define "CL_sRGBx" with expression '<code>0x10C0</code>', CType: int */
  ...
  /** Define "CL_PROGRAM_BINARY_TYPE_EXECUTABLE" with expression '<code>0x4</code>', CType: int */
  public static final int CL_PROGRAM_BINARY_TYPE_EXECUTABLE = 0x4;
  /** Define "CL_GL_NUM_SAMPLES" with expression '<code>0x2012</code>', CType: int */
  ...
  /** Define "CL_KERNEL_ARG_TYPE_PIPE" with expression '<code>(1 << 3)</code>', CType: int */
  public static final int CL_KERNEL_ARG_TYPE_PIPE = ( 0x1 << 0x3 );
  ...
  /** Define "CL_KERNEL_ARG_TYPE_CONST" with expression '<code>(1 << 0)</code>', CType: int */
  public static final int CL_KERNEL_ARG_TYPE_CONST = ( 0x1 << 0x0 );
  ...
  /** Define "CL_DEVICE_AFFINITY_DOMAIN_L1_CACHE" with expression '<code>(1 << 4)</code>', CType: int */
  public static final int CL_DEVICE_AFFINITY_DOMAIN_L1_CACHE = ( 0x1 << 0x4 );
  /** Define "CL_PIPE_MAX_PACKETS" with expression '<code>0x1121</code>', CType: int */
  ...
  /** Define "CL_sRGB" with expression '<code>0x10BF</code>', CType: int */
  ...
  /** Define "CL_DEVICE_PARTITION_MAX_SUB_DEVICES" with expression '<code>0x1043</code>', CType: int */
  ...
  /** Define "CL_DEVICE_SVM_CAPABILITIES" with expression '<code>0x1053</code>', CType: int */
  ...
  /** Define "CL_MEM_SVM_FINE_GRAIN_BUFFER" with expression '<code>(1 << 10)</code>', CType: int */
  public static final int CL_MEM_SVM_FINE_GRAIN_BUFFER = ( 0x1 << 0xa );
  ...
  /** Define "CL_MEM_HOST_READ_ONLY" with expression '<code>(1 << 8)</code>', CType: int */
  public static final int CL_MEM_HOST_READ_ONLY = ( 0x1 << 0x8 );
  ...
  /** Define "CL_GL_OBJECT_TEXTURE2D_ARRAY" with expression '<code>0x200E</code>', CType: int */
  ...
  /** Define "CL_DEVICE_PARTITION_PROPERTIES" with expression '<code>0x1044</code>', CType: int */
  ...
  /** Define "CL_KERNEL_ARG_ADDRESS_CONSTANT" with expression '<code>0x119D</code>', CType: int */
  public static final int CL_KERNEL_ARG_ADDRESS_CONSTANT = 0x119d;
  /** Define "CL_MEM_OBJECT_IMAGE1D_BUFFER" with expression '<code>0x10F6</code>', CType: int */
  ...
  /** Define "CL_PROGRAM_BINARY_TYPE_LIBRARY" with expression '<code>0x2</code>', CType: int */
  ...
  /** Define "CL_KERNEL_EXEC_INFO_SVM_FINE_GRAIN_SYSTEM" with expression '<code>0x11B7</code>', CType: int */
  ...
  /** Define "CL_DEVICE_MAX_READ_WRITE_IMAGE_ARGS" with expression '<code>0x104C</code>', CType: int */
  ...
  /** Define "CL_SAMPLER_LOD_MAX" with expression '<code>0x1157</code>', CType: int */
  ...
  /** Define "CL_SAMPLER_MIP_FILTER_MODE" with expression '<code>0x1155</code>', CType: int */
  ...
  /** Define "CL_DEVICE_PREFERRED_PLATFORM_ATOMIC_ALIGNMENT" with expression '<code>0x1058</code>', CType: int */
  ...
  /** Define "CL_DEVICE_PARTITION_AFFINITY_DOMAIN" with expression '<code>0x1045</code>', CType: int */
  ...
  /** Define "CL_INVALID_LINKER_OPTIONS" with expression '<code>-67</code>', CType: int */
  ...
  /** Define "CL_GL_OBJECT_TEXTURE_BUFFER" with expression '<code>0x2011</code>', CType: int */
  ...
  /** Define "CL_KERNEL_ARG_ACCESS_QUALIFIER" with expression '<code>0x1197</code>', CType: int */
  public static final int CL_KERNEL_ARG_ACCESS_QUALIFIER = 0x1197;
  /** Define "CL_CONTEXT_MEMORY_INITIALIZE_KHR" with expression '<code>0x200E</code>', CType: int */
  ...
  /** Define "CL_COMMAND_FILL_BUFFER" with expression '<code>0x1207</code>', CType: int */
  ...
  /** Define "CL_MEM_USES_SVM_POINTER" with expression '<code>0x1109</code>', CType: int */
  public static final int CL_MEM_USES_SVM_POINTER = 0x1109;
  /** Define "CL_DEVICE_PARTITION_EQUALLY" with expression '<code>0x1086</code>', CType: int */
  public static final int CL_DEVICE_PARTITION_EQUALLY = 0x1086;
  /** Define "CL_MEM_HOST_WRITE_ONLY" with expression '<code>(1 << 7)</code>', CType: int */
  public static final int CL_MEM_HOST_WRITE_ONLY = ( 0x1 << 0x7 );
  ...
  /** Define "CL_PROGRAM_BINARY_TYPE_COMPILED_OBJECT" with expression '<code>0x1</code>', CType: int */
  public static final int CL_PROGRAM_BINARY_TYPE_COMPILED_OBJECT = 0x1;
  /** Define "CL_KERNEL_ARG_ACCESS_NONE" with expression '<code>0x11A3</code>', CType: int */
  ...
  /** Define "CL_MEM_SVM_ATOMICS" with expression '<code>(1 << 11)</code>', CType: int */
  public static final int CL_MEM_SVM_ATOMICS = ( 0x1 << 0xb );
  ...
  /** Define "CL_QUEUE_ON_DEVICE" with expression '<code>(1 << 2)</code>', CType: int */
  public static final int CL_QUEUE_ON_DEVICE = ( 0x1 << 0x2 );
  ...
  /** Define "CL_PIPE_PACKET_SIZE" with expression '<code>0x1120</code>', CType: int */
  ...
  /** Define "CL_QUEUE_SIZE" with expression '<code>0x1094</code>', CType: int */
  public static final int CL_QUEUE_SIZE = 0x1094;
  /** Define "CL_COMMAND_BARRIER" with expression '<code>0x1205</code>', CType: int */
  ...
  /** Define "CL_MEM_OBJECT_IMAGE1D_ARRAY" with expression '<code>0x10F5</code>', CType: int */
  ...
  /** Define "CL_PROFILING_COMMAND_COMPLETE" with expression '<code>0x1284</code>', CType: int */
  ...
  /** Define "CL_GL_OBJECT_TEXTURE1D_ARRAY" with expression '<code>0x2010</code>', CType: int */
  ...
  /** Define "CL_COMMAND_SVM_FREE" with expression '<code>0x1209</code>', CType: int */
  ...
  /** Define "CL_KERNEL_EXEC_INFO_SVM_PTRS" with expression '<code>0x11B6</code>', CType: int */
  public static final int CL_KERNEL_EXEC_INFO_SVM_PTRS = 0x11b6;
  /** Define "CL_DEVICE_QUEUE_ON_DEVICE_MAX_SIZE" with expression '<code>0x1050</code>', CType: int */
  ...
  /** Define "CL_MAP_WRITE_INVALIDATE_REGION" with expression '<code>(1 << 2)</code>', CType: int */
  public static final int CL_MAP_WRITE_INVALIDATE_REGION = ( 0x1 << 0x2 );
  ...
  /** Define "CL_DEVICE_SVM_FINE_GRAIN_BUFFER" with expression '<code>(1 << 1)</code>', CType: int */
  public static final int CL_DEVICE_SVM_FINE_GRAIN_BUFFER = ( 0x1 << 0x1 );
  ...
  /** Define "CL_MEM_OBJECT_IMAGE1D" with expression '<code>0x10F4</code>', CType: int */
  ...
  /** Define "CL_DEVICE_PREFERRED_LOCAL_ATOMIC_ALIGNMENT" with expression '<code>0x105A</code>', CType: int */
  ...
  /** Define "CL_LINKER_NOT_AVAILABLE" with expression '<code>-16</code>', CType: int */
  ...
  /** Define "CL_COMMAND_FILL_IMAGE" with expression '<code>0x1208</code>', CType: int */
  public static final int CL_COMMAND_FILL_IMAGE = 0x1208;
  /** Define "CL_DEVICE_AFFINITY_DOMAIN_NUMA" with expression '<code>(1 << 0)</code>', CType: int */
  public static final int CL_DEVICE_AFFINITY_DOMAIN_NUMA = ( 0x1 << 0x0 );
  ...
  /** Define "CL_DEVICE_PARTITION_BY_AFFINITY_DOMAIN" with expression '<code>0x1088</code>', CType: int */
  ...
  /** Define "CL_DEVICE_MAX_ON_DEVICE_EVENTS" with expression '<code>0x1052</code>', CType: int */
  ...
  /** Define "CL_MIGRATE_MEM_OBJECT_HOST" with expression '<code>(1 << 0)</code>', CType: int */
  public static final int CL_MIGRATE_MEM_OBJECT_HOST = ( 0x1 << 0x0 );
  /** Define "CL_FP_CORRECTLY_ROUNDED_DIVIDE_SQRT" with expression '<code>(1 << 7)</code>', CType: int */
  public static final int CL_FP_CORRECTLY_ROUNDED_DIVIDE_SQRT = ( 0x1 << 0x7 );
  /** Define "CL_PROGRAM_BINARY_TYPE" with expression '<code>0x1184</code>', CType: int */
  ...
  /** Define "CL_LINK_PROGRAM_FAILURE" with expression '<code>-17</code>', CType: int */
  ...
  /** Define "CL_DEVICE_TYPE_CUSTOM" with expression '<code>(1 << 4)</code>', CType: int */
  public static final int CL_DEVICE_TYPE_CUSTOM = ( 0x1 << 0x4 );
  /** Define "CL_DEVICE_IMAGE_BASE_ADDRESS_ALIGNMENT" with expression '<code>0x104B</code>', CType: int */
  ...
  /** Define "CL_KERNEL_ARG_ACCESS_READ_WRITE" with expression '<code>0x11A2</code>', CType: int */
  ...
  /** Define "CL_INVALID_IMAGE_DESCRIPTOR" with expression '<code>-65</code>', CType: int */
  ...
  /** Define "CL_PROGRAM_BINARY_TYPE_NONE" with expression '<code>0x0</code>', CType: int */
  ...
  /** Define "CL_PROGRAM_NUM_KERNELS" with expression '<code>0x1167</code>', CType: int */
  public static final int CL_PROGRAM_NUM_KERNELS = 0x1167;
  /** Define "CL_GL_OBJECT_TEXTURE1D" with expression '<code>0x200F</code>', CType: int */
  public static final int CL_GL_OBJECT_TEXTURE1D = 0x200f;
  /** Define "CL_DEVICE_IMAGE_PITCH_ALIGNMENT" with expression '<code>0x104A</code>', CType: int */
  ...
  /** Define "CL_DEVICE_AFFINITY_DOMAIN_NEXT_PARTITIONABLE" with expression '<code>(1 << 5)</code>', CType: int */
  public static final int CL_DEVICE_AFFINITY_DOMAIN_NEXT_PARTITIONABLE = ( 0x1 << 0x5 );
  /** Define "CL_FALSE" with expression '<code>0</code>', CType: int */
  public static final int CL_FALSE = 0x0;
  /** Define "CL_DEVICE_MAX_PIPE_ARGS" with expression '<code>0x1055</code>', CType: int */
  public static final int CL_DEVICE_MAX_PIPE_ARGS = 0x1055;
  /** Define "CL_DEVICE_SVM_COARSE_GRAIN_BUFFER" with expression '<code>(1 << 0)</code>', CType: int */
  public static final int CL_DEVICE_SVM_COARSE_GRAIN_BUFFER = ( 0x1 << 0x0 );
  ...
  /** Define "CL_DEVICE_PARTITION_TYPE" with expression '<code>0x1046</code>', CType: int */
  public static final int CL_DEVICE_PARTITION_TYPE = 0x1046;
  /** Define "CL_NON_BLOCKING" with expression '<code>0</code>', CType: int */
  public static final int CL_NON_BLOCKING = 0x0;
