...
/* !---- C-Unit: CLImpl20_JNI.c, ../build/gensrc/native/jocl20/CLImpl20_JNI.c ----! */
...
/*   Java->C glue code:
 *   Java package: com.jogamp.opencl.llb.impl.CLImpl20
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetPlatformIDs0__ILjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jint num_entries, jobject platforms, jint platforms_byte_offset, jobject num_platforms, jint num_platforms_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetDeviceIDs0__JJILjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong platform, jlong device_type, jint num_entries, jobject devices, jint devices_byte_offset, jobject num_devices, jint num_devices_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetDeviceInfo0__JIJLjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong device, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clRetainDevice1__JJ(JNIEnv *env, jobject _unused, jlong device, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clReleaseDevice1__JJ(JNIEnv *env, jobject _unused, jlong device, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_device_id device);
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clRetainContext1__JJ(JNIEnv *env, jobject _unused, jlong context, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetContextInfo0__JIJLjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong context, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jlong procAddress) {
...
/*   Java->C glue code:
 *   Java package: com.jogamp.opencl.llb.impl.CLImpl20
 *    Java method: long clCreateCommandQueueWithProperties(long context, long device, java.nio.LongBuffer properties, java.nio.IntBuffer errcode_ret)
 *     C function: cl_command_queue clCreateCommandQueueWithProperties(cl_context context, cl_device_id device, const cl_queue_properties *  properties, cl_int *  errcode_ret)
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateCommandQueueWithProperties1__JJLjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong context, jlong device, jobject properties, jint properties_byte_offset, jboolean properties_is_nio, jobject errcode_ret, jint errcode_ret_byte_offset, jboolean errcode_ret_is_nio, jlong procAddress) {
  typedef cl_command_queue (CL_API_CALL*_local_ARG)(cl_context context, cl_device_id device, const cl_queue_properties *  properties, cl_int *  errcode_ret);
  _local_ARG ptr_clCreateCommandQueueWithProperties;
  cl_queue_properties * _properties_ptr = NULL;
  cl_int * _errcode_ret_ptr = NULL;
  cl_command_queue _res;
  if ( NULL != properties ) {
    _properties_ptr = (cl_queue_properties *) ( JNI_TRUE == properties_is_nio ?  (*env)->GetDirectBufferAddress(env, properties) :  (*env)->GetPrimitiveArrayCritical(env, properties, NULL) );  }
  if ( NULL != errcode_ret ) {
  ...
  ptr_clCreateCommandQueueWithProperties = (_local_ARG) (intptr_t) procAddress;
  assert(ptr_clCreateCommandQueueWithProperties != NULL);
  _res = (cl_command_queue) (* ptr_clCreateCommandQueueWithProperties) ((cl_context) (intptr_t) context, (cl_device_id) (intptr_t) device, (const cl_queue_properties * ) (((char *) _properties_ptr) + properties_byte_offset), (cl_int * ) (((char *) _errcode_ret_ptr) + errcode_ret_byte_offset));
  if ( JNI_FALSE == properties_is_nio && NULL != properties ) {
    (*env)->ReleasePrimitiveArrayCritical(env, properties, _properties_ptr, JNI_ABORT);  }
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clRetainCommandQueue1__JJ(JNIEnv *env, jobject _unused, jlong command_queue, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clReleaseCommandQueue1__JJ(JNIEnv *env, jobject _unused, jlong command_queue, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_command_queue command_queue);
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetCommandQueueInfo0__JIJLjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong command_queue, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateBuffer1__JJJLjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong context, jlong flags, jlong size, jobject host_ptr, jint host_ptr_byte_offset, jboolean host_ptr_is_nio, jobject errcode_ret, jint errcode_ret_byte_offset, jboolean errcode_ret_is_nio, jlong procAddress) {
 ...
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateImage1__JJLjava_nio_ByteBuffer_2Ljava_nio_ByteBuffer_2Ljava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong context, jlong flags, jobject image_format, jobject image_desc, jobject host_ptr, jint host_ptr_byte_offset, jboolean host_ptr_is_nio, jobject errcode_ret, jint errcode_ret_byte_offset, jboolean errcode_ret_is_nio, jlong procAddress) {
...
/*   Java->C glue code:
 *   Java package: com.jogamp.opencl.llb.impl.CLImpl20
 *    Java method: long clCreatePipe(long context, long flags, int pipe_packet_size, int pipe_max_packets, com.jogamp.common.nio.PointerBuffer properties, java.nio.IntBuffer errcode_ret)
 *     C function: cl_mem clCreatePipe(cl_context context, cl_mem_flags flags, cl_uint pipe_packet_size, cl_uint pipe_max_packets, const cl_pipe_properties *  properties, cl_int *  errcode_ret)
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreatePipe1__JJIILjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong context, jlong flags, jint pipe_packet_size, jint pipe_max_packets, jobject properties, jint properties_byte_offset, jboolean properties_is_nio, jobject errcode_ret, jint errcode_ret_byte_offset, jboolean errcode_ret_is_nio, jlong procAddress) {
  typedef cl_mem (CL_API_CALL*_local_ARG)(cl_context context, cl_mem_flags flags, cl_uint pipe_packet_size, cl_uint pipe_max_packets, const cl_pipe_properties *  properties, cl_int *  errcode_ret);
  _local_ARG ptr_clCreatePipe;
  cl_pipe_properties * _properties_ptr = NULL;
  cl_int * _errcode_ret_ptr = NULL;
  cl_mem _res;
  if ( NULL != properties ) {
    _properties_ptr = (cl_pipe_properties *) ( JNI_TRUE == properties_is_nio ?  (*env)->GetDirectBufferAddress(env, properties) :  (*env)->GetPrimitiveArrayCritical(env, properties, NULL) );  }
  if ( NULL != errcode_ret ) {
    _errcode_ret_ptr = (cl_int *) ( JNI_TRUE == errcode_ret_is_nio ?  (*env)->GetDirectBufferAddress(env, errcode_ret) :  (*env)->GetPrimitiveArrayCritical(env, errcode_ret, NULL) );  }
  ptr_clCreatePipe = (_local_ARG) (intptr_t) procAddress;
  assert(ptr_clCreatePipe != NULL);
  _res = (cl_mem) (* ptr_clCreatePipe) ((cl_context) (intptr_t) context, (cl_mem_flags) flags, (cl_uint) pipe_packet_size, (cl_uint) pipe_max_packets, (const cl_pipe_properties * ) (((char *) _properties_ptr) + properties_byte_offset), (cl_int * ) (((char *) _errcode_ret_ptr) + errcode_ret_byte_offset));
  if ( JNI_FALSE == properties_is_nio && NULL != properties ) {
    (*env)->ReleasePrimitiveArrayCritical(env, properties, _properties_ptr, JNI_ABORT);  }
  if ( JNI_FALSE == errcode_ret_is_nio && NULL != errcode_ret ) {
    (*env)->ReleasePrimitiveArrayCritical(env, errcode_ret, _errcode_ret_ptr, 0);  }
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clRetainMemObject1__JJ(JNIEnv *env, jobject _unused, jlong memobj, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clReleaseMemObject1__JJ(JNIEnv *env, jobject _unused, jlong memobj, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_mem memobj);
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetMemObjectInfo0__JIJLjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong memobj, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetImageInfo0__JIJLjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong image, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jlong procAddress) {
...
/*   Java->C glue code:
 *   Java package: com.jogamp.opencl.llb.impl.CLImpl20
 *    Java method: int clGetPipeInfo(long pipe, int param_name, long param_value_size, java.nio.Buffer param_value, com.jogamp.common.nio.PointerBuffer param_value_size_ret)
 *     C function: cl_int clGetPipeInfo(cl_mem pipe, cl_pipe_info param_name, size_t param_value_size, void *  param_value, size_t *  param_value_size_ret)
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetPipeInfo1__JIJLjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong pipe, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jboolean param_value_is_nio, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jboolean param_value_size_ret_is_nio, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_mem pipe, cl_pipe_info param_name, size_t param_value_size, void *  param_value, size_t *  param_value_size_ret);
  _local_ARG ptr_clGetPipeInfo;
  void * _param_value_ptr = NULL;
  size_t * _param_value_size_ret_ptr = NULL;
  cl_int _res;
  if ( NULL != param_value ) {
  ...
  ptr_clGetPipeInfo = (_local_ARG) (intptr_t) procAddress;
  assert(ptr_clGetPipeInfo != NULL);
  _res = (cl_int) (* ptr_clGetPipeInfo) ((cl_mem) (intptr_t) pipe, (cl_pipe_info) param_name, (size_t) param_value_size, (void * ) (((char *) _param_value_ptr) + param_value_byte_offset), (size_t * ) (((char *) _param_value_size_ret_ptr) + param_value_size_ret_byte_offset));
...
/*   Java->C glue code:
 *   Java package: com.jogamp.opencl.llb.impl.CLImpl20
 *    Java method: java.nio.ByteBuffer clSVMAlloc(long context, long flags, long size, int alignment)
 *     C function: void *  clSVMAlloc(cl_context context, cl_svm_mem_flags flags, size_t size, cl_uint alignment)
 */
JNIEXPORT jobject JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clSVMAlloc1__JJJIJ(JNIEnv *env, jobject _unused, jlong context, jlong flags, jlong size, jint alignment, jlong procAddress) {
  typedef void *  (CL_API_CALL*_local_ARG)(cl_context context, cl_svm_mem_flags flags, size_t size, cl_uint alignment);
  _local_ARG ptr_clSVMAlloc;
  void * _res;
  ptr_clSVMAlloc = (_local_ARG) (intptr_t) procAddress;
  assert(ptr_clSVMAlloc != NULL);
  _res = (void *) (* ptr_clSVMAlloc) ((cl_context) (intptr_t) context, (cl_svm_mem_flags) flags, (size_t) size, (cl_uint) alignment);
  jobject _res_jni;
  if(NULL == _res) {
    _res_jni = NULL;
  } else {
...
/*   Java->C glue code:
 *   Java package: com.jogamp.opencl.llb.impl.CLImpl20
 *    Java method: void clSVMFree(long context, java.nio.Buffer svm_pointer)
 *     C function: void clSVMFree(cl_context context, void *  svm_pointer)
 */
JNIEXPORT void JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clSVMFree1__JLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong context, jobject svm_pointer, jint svm_pointer_byte_offset, jboolean svm_pointer_is_nio, jlong procAddress) {
  typedef void (CL_API_CALL*_local_ARG)(cl_context context, void *  svm_pointer);
  _local_ARG ptr_clSVMFree;
  void * _svm_pointer_ptr = NULL;
  if ( NULL != svm_pointer ) {
    _svm_pointer_ptr = (void *) ( JNI_TRUE == svm_pointer_is_nio ?  (*env)->GetDirectBufferAddress(env, svm_pointer) :  (*env)->GetPrimitiveArrayCritical(env, svm_pointer, NULL) );  }
  ptr_clSVMFree = (_local_ARG) (intptr_t) procAddress;
  assert(ptr_clSVMFree != NULL);
  (* ptr_clSVMFree) ((cl_context) (intptr_t) context, (void * ) (((char *) _svm_pointer_ptr) + svm_pointer_byte_offset));
  if ( JNI_FALSE == svm_pointer_is_nio && NULL != svm_pointer ) {
    (*env)->ReleasePrimitiveArrayCritical(env, svm_pointer, _svm_pointer_ptr, 0);  }
}


/*   Java->C glue code:
 *   Java package: com.jogamp.opencl.llb.impl.CLImpl20
 *    Java method: long clCreateSamplerWithProperties(long context, java.nio.LongBuffer normalized_coords, java.nio.IntBuffer errcode_ret)
 *     C function: cl_sampler clCreateSamplerWithProperties(cl_context context, const cl_sampler_properties *  normalized_coords, cl_int *  errcode_ret)
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateSamplerWithProperties1__JLjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong context, jobject normalized_coords, jint normalized_coords_byte_offset, jboolean normalized_coords_is_nio, jobject errcode_ret, jint errcode_ret_byte_offset, jboolean errcode_ret_is_nio, jlong procAddress) {
  typedef cl_sampler (CL_API_CALL*_local_ARG)(cl_context context, const cl_sampler_properties *  normalized_coords, cl_int *  errcode_ret);
  _local_ARG ptr_clCreateSamplerWithProperties;
  cl_sampler_properties * _normalized_coords_ptr = NULL;
  cl_int * _errcode_ret_ptr = NULL;
  cl_sampler _res;
  if ( NULL != normalized_coords ) {
    _normalized_coords_ptr = (cl_sampler_properties *) ( JNI_TRUE == normalized_coords_is_nio ?  (*env)->GetDirectBufferAddress(env, normalized_coords) :  (*env)->GetPrimitiveArrayCritical(env, normalized_coords, NULL) );  }
  if ( NULL != errcode_ret ) {
    _errcode_ret_ptr = (cl_int *) ( JNI_TRUE == errcode_ret_is_nio ?  (*env)->GetDirectBufferAddress(env, errcode_ret) :  (*env)->GetPrimitiveArrayCritical(env, errcode_ret, NULL) );  }
  ptr_clCreateSamplerWithProperties = (_local_ARG) (intptr_t) procAddress;
  assert(ptr_clCreateSamplerWithProperties != NULL);
  _res = (cl_sampler) (* ptr_clCreateSamplerWithProperties) ((cl_context) (intptr_t) context, (const cl_sampler_properties * ) (((char *) _normalized_coords_ptr) + normalized_coords_byte_offset), (cl_int * ) (((char *) _errcode_ret_ptr) + errcode_ret_byte_offset));
  if ( JNI_FALSE == normalized_coords_is_nio && NULL != normalized_coords ) {
    (*env)->ReleasePrimitiveArrayCritical(env, normalized_coords, _normalized_coords_ptr, JNI_ABORT);  }
  if ( JNI_FALSE == errcode_ret_is_nio && NULL != errcode_ret ) {
    (*env)->ReleasePrimitiveArrayCritical(env, errcode_ret, _errcode_ret_ptr, 0);  }
  jlong _res_jni = (jlong) (intptr_t) _res;
  return _res_jni;
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clRetainSampler1__JJ(JNIEnv *env, jobject _unused, jlong sampler, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clReleaseSampler1__JJ(JNIEnv *env, jobject _unused, jlong sampler, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_sampler sampler);
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetSamplerInfo0__JIJLjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong sampler, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clRetainProgram1__JJ(JNIEnv *env, jobject _unused, jlong program, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clReleaseProgram1__JJ(JNIEnv *env, jobject _unused, jlong program, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_program program);
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clUnloadPlatformCompiler1__JJ(JNIEnv *env, jobject _unused, jlong platform, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetProgramInfo0__JIJLjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong program, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetProgramBuildInfo0__JJIJLjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong program, jlong device, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateKernel1__JLjava_lang_String_2Ljava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong program, jstring kernel_name, jobject errcode_ret, jint errcode_ret_byte_offset, jboolean errcode_ret_is_nio, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateKernelsInProgram0__JILjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong program, jint num_kernels, jobject kernels, jint kernels_byte_offset, jobject num_kernels_ret, jint num_kernels_ret_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clRetainKernel1__JJ(JNIEnv *env, jobject _unused, jlong kernel, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clReleaseKernel1__JJ(JNIEnv *env, jobject _unused, jlong kernel, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_kernel kernel);
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clSetKernelArg0__JIJLjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong kernel, jint arg_index, jlong arg_size, jobject arg_value, jint arg_value_byte_offset, jlong procAddress) {
...
/*   Java->C glue code:
 *   Java package: com.jogamp.opencl.llb.impl.CLImpl20
 *    Java method: int clSetKernelArgSVMPointer(long kernel, int arg_index, java.nio.Buffer arg_value)
 *     C function: cl_int clSetKernelArgSVMPointer(cl_kernel kernel, cl_uint arg_index, const void *  arg_value)
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clSetKernelArgSVMPointer1__JILjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong kernel, jint arg_index, jobject arg_value, jint arg_value_byte_offset, jboolean arg_value_is_nio, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_kernel kernel, cl_uint arg_index, const void *  arg_value);
  _local_ARG ptr_clSetKernelArgSVMPointer;
  void * _arg_value_ptr = NULL;
  cl_int _res;
  if ( NULL != arg_value ) {
    _arg_value_ptr = (void *) ( JNI_TRUE == arg_value_is_nio ?  (*env)->GetDirectBufferAddress(env, arg_value) :  (*env)->GetPrimitiveArrayCritical(env, arg_value, NULL) );  }
  ptr_clSetKernelArgSVMPointer = (_local_ARG) (intptr_t) procAddress;
  assert(ptr_clSetKernelArgSVMPointer != NULL);
  _res = (cl_int) (* ptr_clSetKernelArgSVMPointer) ((cl_kernel) (intptr_t) kernel, (cl_uint) arg_index, (const void * ) (((char *) _arg_value_ptr) + arg_value_byte_offset));
  if ( JNI_FALSE == arg_value_is_nio && NULL != arg_value ) {
    (*env)->ReleasePrimitiveArrayCritical(env, arg_value, _arg_value_ptr, JNI_ABORT);  }
  jint _res_jni = _res;
  return _res_jni;
}
...
/*   Java->C glue code:
 *   Java package: com.jogamp.opencl.llb.impl.CLImpl20
 *    Java method: int clSetKernelExecInfo(long kernel, int param_name, long param_value_size, java.nio.Buffer param_value)
 *     C function: cl_int clSetKernelExecInfo(cl_kernel kernel, cl_kernel_exec_info param_name, size_t param_value_size, const void *  param_value)
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clSetKernelExecInfo1__JIJLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong kernel, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jboolean param_value_is_nio, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_kernel kernel, cl_kernel_exec_info param_name, size_t param_value_size, const void *  param_value);
  _local_ARG ptr_clSetKernelExecInfo;
  void * _param_value_ptr = NULL;
  cl_int _res;
  if ( NULL != param_value ) {
    _param_value_ptr = (void *) ( JNI_TRUE == param_value_is_nio ?  (*env)->GetDirectBufferAddress(env, param_value) :  (*env)->GetPrimitiveArrayCritical(env, param_value, NULL) );  }
  ptr_clSetKernelExecInfo = (_local_ARG) (intptr_t) procAddress;
  assert(ptr_clSetKernelExecInfo != NULL);
  _res = (cl_int) (* ptr_clSetKernelExecInfo) ((cl_kernel) (intptr_t) kernel, (cl_kernel_exec_info) param_name, (size_t) param_value_size, (const void * ) (((char *) _param_value_ptr) + param_value_byte_offset));
  if ( JNI_FALSE == param_value_is_nio && NULL != param_value ) {
    (*env)->ReleasePrimitiveArrayCritical(env, param_value, _param_value_ptr, JNI_ABORT);  }
  jint _res_jni = _res;
  return _res_jni;
}
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetKernelInfo0__JIJLjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong kernel, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetKernelArgInfo1__JIIJLjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong kernel, jint arg_indx, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jboolean param_value_is_nio, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jboolean param_value_size_ret_is_nio, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetKernelWorkGroupInfo0__JJIJLjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong kernel, jlong device, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clWaitForEvents0__ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jint num_events, jobject event_list, jint event_list_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetEventInfo0__JIJLjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong event, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateUserEvent1__JLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong context, jobject errcode_ret, jint errcode_ret_byte_offset, jboolean errcode_ret_is_nio, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clRetainEvent1__JJ(JNIEnv *env, jobject _unused, jlong event, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clReleaseEvent1__JJ(JNIEnv *env, jobject _unused, jlong event, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_event event);
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clSetUserEventStatus1__JIJ(JNIEnv *env, jobject _unused, jlong event, jint execution_status, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetEventProfilingInfo0__JIJLjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong event, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clFlush1__JJ(JNIEnv *env, jobject _unused, jlong command_queue, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_command_queue command_queue);
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clFinish1__JJ(JNIEnv *env, jobject _unused, jlong command_queue, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_command_queue command_queue);
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueReadBuffer0__JJIJJLjava_lang_Object_2IILjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong command_queue, jlong buffer, jint blocking_read, jlong offset, jlong size, jobject ptr, jint ptr_byte_offset, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jobject event, jint event_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueWriteBuffer0__JJIJJLjava_lang_Object_2IILjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong command_queue, jlong buffer, jint blocking_write, jlong offset, jlong size, jobject ptr, jint ptr_byte_offset, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jobject event, jint event_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueWriteBufferRect0__JJILjava_lang_Object_2ILjava_lang_Object_2ILjava_lang_Object_2IJJJJLjava_lang_Object_2IILjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong command_queue, jlong buffer, jint blocking_write, jobject buffer_offset, jint buffer_offset_byte_offset, jobject host_offset, jint host_offset_byte_offset, jobject region, jint region_byte_offset, jlong buffer_row_pitch, jlong buffer_slice_pitch, jlong host_row_pitch, jlong host_slice_pitch, jobject ptr, jint ptr_byte_offset, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jobject event, jint event_byte_offset, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_write, const size_t *  buffer_offset, const size_t *  host_offset, const size_t *  region, size_t buffer_row_pitch, size_t buffer_slice_pitch, size_t host_row_pitch, size_t host_slice_pitch, const void *  ptr, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event);
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueCopyBufferToImage0__JJJJLjava_lang_Object_2ILjava_lang_Object_2IILjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong command_queue, jlong src_buffer, jlong dst_image, jlong src_offset, jobject arg4, jint arg4_byte_offset, jobject arg5, jint arg5_byte_offset, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jobject event, jint event_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueUnmapMemObject0__JJLjava_lang_Object_2IILjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong command_queue, jlong memobj, jobject mapped_ptr, jint mapped_ptr_byte_offset, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jobject event, jint event_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueMarkerWithWaitList1__JILjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong command_queue, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jboolean event_wait_list_is_nio, jobject event, jint event_byte_offset, jboolean event_is_nio, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueBarrierWithWaitList1__JILjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong command_queue, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jboolean event_wait_list_is_nio, jobject event, jint event_byte_offset, jboolean event_is_nio, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_command_queue command_queue, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event);
...
/*   Java->C glue code:
 *   Java package: com.jogamp.opencl.llb.impl.CLImpl20
 *    Java method: int clEnqueueSVMFree(long command_queue, int num_svm_pointers, com.jogamp.common.nio.PointerBuffer arg2, java.nio.Buffer arg3, java.nio.Buffer user_data, int num_events_in_wait_list, com.jogamp.common.nio.PointerBuffer event_wait_list, com.jogamp.common.nio.PointerBuffer event)
 *     C function: cl_int clEnqueueSVMFree(cl_command_queue command_queue, cl_uint num_svm_pointers, void *  * , void * , void *  user_data, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueSVMFree1__JILjava_lang_Object_2IZLjava_lang_Object_2IZLjava_lang_Object_2IZILjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong command_queue, jint num_svm_pointers, jobject arg2, jint arg2_byte_offset, jboolean arg2_is_nio, jobject arg3, jint arg3_byte_offset, jboolean arg3_is_nio, jobject user_data, jint user_data_byte_offset, jboolean user_data_is_nio, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jboolean event_wait_list_is_nio, jobject event, jint event_byte_offset, jboolean event_is_nio, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_command_queue command_queue, cl_uint num_svm_pointers, void *  * , void * , void *  user_data, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event);
  _local_ARG ptr_clEnqueueSVMFree;
  void * * _arg2_ptr = NULL;
  void * _arg3_ptr = NULL;
  void * _user_data_ptr = NULL;
  cl_event * _event_wait_list_ptr = NULL;
  cl_event * _event_ptr = NULL;
  cl_int _res;
  if ( NULL != arg2 ) {
    _arg2_ptr = (void * *) ( JNI_TRUE == arg2_is_nio ?  (*env)->GetDirectBufferAddress(env, arg2) :  (*env)->GetPrimitiveArrayCritical(env, arg2, NULL) );  }
  if ( NULL != arg3 ) {
    _arg3_ptr = (void *) ( JNI_TRUE == arg3_is_nio ?  (*env)->GetDirectBufferAddress(env, arg3) :  (*env)->GetPrimitiveArrayCritical(env, arg3, NULL) );  }
  if ( NULL != user_data ) {
    _user_data_ptr = (void *) ( JNI_TRUE == user_data_is_nio ?  (*env)->GetDirectBufferAddress(env, user_data) :  (*env)->GetPrimitiveArrayCritical(env, user_data, NULL) );  }
  if ( NULL != event_wait_list ) {
    _event_wait_list_ptr = (cl_event *) ( JNI_TRUE == event_wait_list_is_nio ?  (*env)->GetDirectBufferAddress(env, event_wait_list) :  (*env)->GetPrimitiveArrayCritical(env, event_wait_list, NULL) );  }
  if ( NULL != event ) {
    _event_ptr = (cl_event *) ( JNI_TRUE == event_is_nio ?  (*env)->GetDirectBufferAddress(env, event) :  (*env)->GetPrimitiveArrayCritical(env, event, NULL) );  }
  ptr_clEnqueueSVMFree = (_local_ARG) (intptr_t) procAddress;
  assert(ptr_clEnqueueSVMFree != NULL);
  _res = (cl_int) (* ptr_clEnqueueSVMFree) ((cl_command_queue) (intptr_t) command_queue, (cl_uint) num_svm_pointers, (void *  * ) (((char *) _arg2_ptr) + arg2_byte_offset), (void * ) (((char *) _arg3_ptr) + arg3_byte_offset), (void * ) (((char *) _user_data_ptr) + user_data_byte_offset), (cl_uint) num_events_in_wait_list, (const cl_event * ) (((char *) _event_wait_list_ptr) + event_wait_list_byte_offset), (cl_event * ) (((char *) _event_ptr) + event_byte_offset));
  ...
  if ( JNI_FALSE == user_data_is_nio && NULL != user_data ) {
    (*env)->ReleasePrimitiveArrayCritical(env, user_data, _user_data_ptr, 0);  }
  if ( JNI_FALSE == event_wait_list_is_nio && NULL != event_wait_list ) {
    (*env)->ReleasePrimitiveArrayCritical(env, event_wait_list, _event_wait_list_ptr, 0);  }
  if ( JNI_FALSE == event_is_nio && NULL != event ) {
    (*env)->ReleasePrimitiveArrayCritical(env, event, _event_ptr, 0);  }
...
/*   Java->C glue code:
 *   Java package: com.jogamp.opencl.llb.impl.CLImpl20
 *    Java method: int clEnqueueSVMMemcpy(long command_queue, int blocking_copy, java.nio.Buffer dst_ptr, java.nio.Buffer src_ptr, long size, int num_events_in_wait_list, com.jogamp.common.nio.PointerBuffer event_wait_list, com.jogamp.common.nio.PointerBuffer event)
 *     C function: cl_int clEnqueueSVMMemcpy(cl_command_queue command_queue, cl_bool blocking_copy, void *  dst_ptr, const void *  src_ptr, size_t size, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueSVMMemcpy1__JILjava_lang_Object_2IZLjava_lang_Object_2IZJILjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong command_queue, jint blocking_copy, jobject dst_ptr, jint dst_ptr_byte_offset, jboolean dst_ptr_is_nio, jobject src_ptr, jint src_ptr_byte_offset, jboolean src_ptr_is_nio, jlong size, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jboolean event_wait_list_is_nio, jobject event, jint event_byte_offset, jboolean event_is_nio, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_command_queue command_queue, cl_bool blocking_copy, void *  dst_ptr, const void *  src_ptr, size_t size, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event);
  _local_ARG ptr_clEnqueueSVMMemcpy;
  void * _dst_ptr_ptr = NULL;
  void * _src_ptr_ptr = NULL;
  cl_event * _event_wait_list_ptr = NULL;
  cl_event * _event_ptr = NULL;
  cl_int _res;
  if ( NULL != dst_ptr ) {
    _dst_ptr_ptr = (void *) ( JNI_TRUE == dst_ptr_is_nio ?  (*env)->GetDirectBufferAddress(env, dst_ptr) :  (*env)->GetPrimitiveArrayCritical(env, dst_ptr, NULL) );  }
  if ( NULL != src_ptr ) {
    _src_ptr_ptr = (void *) ( JNI_TRUE == src_ptr_is_nio ?  (*env)->GetDirectBufferAddress(env, src_ptr) :  (*env)->GetPrimitiveArrayCritical(env, src_ptr, NULL) );  }
  if ( NULL != event_wait_list ) {
    _event_wait_list_ptr = (cl_event *) ( JNI_TRUE == event_wait_list_is_nio ?  (*env)->GetDirectBufferAddress(env, event_wait_list) :  (*env)->GetPrimitiveArrayCritical(env, event_wait_list, NULL) );  }
  if ( NULL != event ) {
    _event_ptr = (cl_event *) ( JNI_TRUE == event_is_nio ?  (*env)->GetDirectBufferAddress(env, event) :  (*env)->GetPrimitiveArrayCritical(env, event, NULL) );  }
  ptr_clEnqueueSVMMemcpy = (_local_ARG) (intptr_t) procAddress;
  assert(ptr_clEnqueueSVMMemcpy != NULL);
  _res = (cl_int) (* ptr_clEnqueueSVMMemcpy) ((cl_command_queue) (intptr_t) command_queue, (cl_bool) blocking_copy, (void * ) (((char *) _dst_ptr_ptr) + dst_ptr_byte_offset), (const void * ) (((char *) _src_ptr_ptr) + src_ptr_byte_offset), (size_t) size, (cl_uint) num_events_in_wait_list, (const cl_event * ) (((char *) _event_wait_list_ptr) + event_wait_list_byte_offset), (cl_event * ) (((char *) _event_ptr) + event_byte_offset));
  if ( JNI_FALSE == dst_ptr_is_nio && NULL != dst_ptr ) {
    (*env)->ReleasePrimitiveArrayCritical(env, dst_ptr, _dst_ptr_ptr, 0);  }
  if ( JNI_FALSE == src_ptr_is_nio && NULL != src_ptr ) {
    (*env)->ReleasePrimitiveArrayCritical(env, src_ptr, _src_ptr_ptr, JNI_ABORT);  }
  if ( JNI_FALSE == event_wait_list_is_nio && NULL != event_wait_list ) {
    (*env)->ReleasePrimitiveArrayCritical(env, event_wait_list, _event_wait_list_ptr, 0);  }
  if ( JNI_FALSE == event_is_nio && NULL != event ) {
    (*env)->ReleasePrimitiveArrayCritical(env, event, _event_ptr, 0);  }
...
/*   Java->C glue code:
 *   Java package: com.jogamp.opencl.llb.impl.CLImpl20
 *    Java method: int clEnqueueSVMMemFill(long command_queue, java.nio.Buffer svm_ptr, java.nio.Buffer pattern, long pattern_size, long size, int num_events_in_wait_list, com.jogamp.common.nio.PointerBuffer event_wait_list, com.jogamp.common.nio.PointerBuffer event)
 *     C function: cl_int clEnqueueSVMMemFill(cl_command_queue command_queue, void *  svm_ptr, const void *  pattern, size_t pattern_size, size_t size, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueSVMMemFill1__JLjava_lang_Object_2IZLjava_lang_Object_2IZJJILjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong command_queue, jobject svm_ptr, jint svm_ptr_byte_offset, jboolean svm_ptr_is_nio, jobject pattern, jint pattern_byte_offset, jboolean pattern_is_nio, jlong pattern_size, jlong size, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jboolean event_wait_list_is_nio, jobject event, jint event_byte_offset, jboolean event_is_nio, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_command_queue command_queue, void *  svm_ptr, const void *  pattern, size_t pattern_size, size_t size, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event);
  _local_ARG ptr_clEnqueueSVMMemFill;
  void * _svm_ptr_ptr = NULL;
  void * _pattern_ptr = NULL;
  cl_event * _event_wait_list_ptr = NULL;
  cl_event * _event_ptr = NULL;
  cl_int _res;
  if ( NULL != svm_ptr ) {
    _svm_ptr_ptr = (void *) ( JNI_TRUE == svm_ptr_is_nio ?  (*env)->GetDirectBufferAddress(env, svm_ptr) :  (*env)->GetPrimitiveArrayCritical(env, svm_ptr, NULL) );  }
  if ( NULL != pattern ) {
    _pattern_ptr = (void *) ( JNI_TRUE == pattern_is_nio ?  (*env)->GetDirectBufferAddress(env, pattern) :  (*env)->GetPrimitiveArrayCritical(env, pattern, NULL) );  }
  if ( NULL != event_wait_list ) {
    _event_wait_list_ptr = (cl_event *) ( JNI_TRUE == event_wait_list_is_nio ?  (*env)->GetDirectBufferAddress(env, event_wait_list) :  (*env)->GetPrimitiveArrayCritical(env, event_wait_list, NULL) );  }
  if ( NULL != event ) {
    _event_ptr = (cl_event *) ( JNI_TRUE == event_is_nio ?  (*env)->GetDirectBufferAddress(env, event) :  (*env)->GetPrimitiveArrayCritical(env, event, NULL) );  }
  ptr_clEnqueueSVMMemFill = (_local_ARG) (intptr_t) procAddress;
  assert(ptr_clEnqueueSVMMemFill != NULL);
  _res = (cl_int) (* ptr_clEnqueueSVMMemFill) ((cl_command_queue) (intptr_t) command_queue, (void * ) (((char *) _svm_ptr_ptr) + svm_ptr_byte_offset), (const void * ) (((char *) _pattern_ptr) + pattern_byte_offset), (size_t) pattern_size, (size_t) size, (cl_uint) num_events_in_wait_list, (const cl_event * ) (((char *) _event_wait_list_ptr) + event_wait_list_byte_offset), (cl_event * ) (((char *) _event_ptr) + event_byte_offset));
  if ( JNI_FALSE == svm_ptr_is_nio && NULL != svm_ptr ) {
    (*env)->ReleasePrimitiveArrayCritical(env, svm_ptr, _svm_ptr_ptr, 0);  }
  if ( JNI_FALSE == pattern_is_nio && NULL != pattern ) {
    (*env)->ReleasePrimitiveArrayCritical(env, pattern, _pattern_ptr, JNI_ABORT);  }
  if ( JNI_FALSE == event_wait_list_is_nio && NULL != event_wait_list ) {
    (*env)->ReleasePrimitiveArrayCritical(env, event_wait_list, _event_wait_list_ptr, 0);  }
...
/*   Java->C glue code:
 *   Java package: com.jogamp.opencl.llb.impl.CLImpl20
 *    Java method: int clEnqueueSVMMap(long command_queue, int blocking_map, long flags, java.nio.Buffer svm_ptr, long size, int num_events_in_wait_list, com.jogamp.common.nio.PointerBuffer event_wait_list, com.jogamp.common.nio.PointerBuffer event)
 *     C function: cl_int clEnqueueSVMMap(cl_command_queue command_queue, cl_bool blocking_map, cl_map_flags flags, void *  svm_ptr, size_t size, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueSVMMap1__JIJLjava_lang_Object_2IZJILjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong command_queue, jint blocking_map, jlong flags, jobject svm_ptr, jint svm_ptr_byte_offset, jboolean svm_ptr_is_nio, jlong size, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jboolean event_wait_list_is_nio, jobject event, jint event_byte_offset, jboolean event_is_nio, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_command_queue command_queue, cl_bool blocking_map, cl_map_flags flags, void *  svm_ptr, size_t size, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event);
  _local_ARG ptr_clEnqueueSVMMap;
  void * _svm_ptr_ptr = NULL;
  cl_event * _event_wait_list_ptr = NULL;
  cl_event * _event_ptr = NULL;
  cl_int _res;
  ...
  if ( NULL != event ) {
    _event_ptr = (cl_event *) ( JNI_TRUE == event_is_nio ?  (*env)->GetDirectBufferAddress(env, event) :  (*env)->GetPrimitiveArrayCritical(env, event, NULL) );  }
  ptr_clEnqueueSVMMap = (_local_ARG) (intptr_t) procAddress;
  assert(ptr_clEnqueueSVMMap != NULL);
  _res = (cl_int) (* ptr_clEnqueueSVMMap) ((cl_command_queue) (intptr_t) command_queue, (cl_bool) blocking_map, (cl_map_flags) flags, (void * ) (((char *) _svm_ptr_ptr) + svm_ptr_byte_offset), (size_t) size, (cl_uint) num_events_in_wait_list, (const cl_event * ) (((char *) _event_wait_list_ptr) + event_wait_list_byte_offset), (cl_event * ) (((char *) _event_ptr) + event_byte_offset));
  if ( JNI_FALSE == svm_ptr_is_nio && NULL != svm_ptr ) {
    (*env)->ReleasePrimitiveArrayCritical(env, svm_ptr, _svm_ptr_ptr, 0);  }
  if ( JNI_FALSE == event_wait_list_is_nio && NULL != event_wait_list ) {
    (*env)->ReleasePrimitiveArrayCritical(env, event_wait_list, _event_wait_list_ptr, 0);  }
...
/*   Java->C glue code:
 *   Java package: com.jogamp.opencl.llb.impl.CLImpl20
 *    Java method: int clEnqueueSVMUnmap(long command_queue, java.nio.Buffer svm_ptr, int num_events_in_wait_list, com.jogamp.common.nio.PointerBuffer event_wait_list, com.jogamp.common.nio.PointerBuffer event)
 *     C function: cl_int clEnqueueSVMUnmap(cl_command_queue command_queue, void *  svm_ptr, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event)
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueSVMUnmap1__JLjava_lang_Object_2IZILjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong command_queue, jobject svm_ptr, jint svm_ptr_byte_offset, jboolean svm_ptr_is_nio, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jboolean event_wait_list_is_nio, jobject event, jint event_byte_offset, jboolean event_is_nio, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_command_queue command_queue, void *  svm_ptr, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event);
  _local_ARG ptr_clEnqueueSVMUnmap;
  void * _svm_ptr_ptr = NULL;
  cl_event * _event_wait_list_ptr = NULL;
  cl_event * _event_ptr = NULL;
  cl_int _res;
  ...
  if ( NULL != event ) {
    _event_ptr = (cl_event *) ( JNI_TRUE == event_is_nio ?  (*env)->GetDirectBufferAddress(env, event) :  (*env)->GetPrimitiveArrayCritical(env, event, NULL) );  }
  ptr_clEnqueueSVMUnmap = (_local_ARG) (intptr_t) procAddress;
  assert(ptr_clEnqueueSVMUnmap != NULL);
  _res = (cl_int) (* ptr_clEnqueueSVMUnmap) ((cl_command_queue) (intptr_t) command_queue, (void * ) (((char *) _svm_ptr_ptr) + svm_ptr_byte_offset), (cl_uint) num_events_in_wait_list, (const cl_event * ) (((char *) _event_wait_list_ptr) + event_wait_list_byte_offset), (cl_event * ) (((char *) _event_ptr) + event_byte_offset));
  if ( JNI_FALSE == svm_ptr_is_nio && NULL != svm_ptr ) {
    (*env)->ReleasePrimitiveArrayCritical(env, svm_ptr, _svm_ptr_ptr, 0);  }
  if ( JNI_FALSE == event_wait_list_is_nio && NULL != event_wait_list ) {
    (*env)->ReleasePrimitiveArrayCritical(env, event_wait_list, _event_wait_list_ptr, 0);  }
 ...
 */
JNIEXPORT jobject JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetExtensionFunctionAddressForPlatform1__JLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong platform, jobject func_name, jint func_name_byte_offset, jboolean func_name_is_nio, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueMarker0__JLjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong command_queue, jobject event, jint event_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueWaitForEvents0__JILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong command_queue, jint num_events, jobject event_list, jint event_list_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueBarrier0__JJ(JNIEnv *env, jobject _unused, jlong command_queue, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_command_queue command_queue);
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clUnloadCompiler1__J(JNIEnv *env, jobject _unused, jlong procAddress) {
 ...
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateCommandQueue1__JJJLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong context, jlong device, jlong properties, jobject errcode_ret, jint errcode_ret_byte_offset, jboolean errcode_ret_is_nio, jlong procAddress) {
 ...
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateSampler1__JIIILjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong context, jint normalized_coords, jint addressing_mode, jint filter_mode, jobject errcode_ret, jint errcode_ret_byte_offset, jboolean errcode_ret_is_nio, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueTask0__JJILjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong command_queue, jlong kernel, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jobject event, jint event_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clIcdGetPlatformIDsKHR0__ILjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jint arg0, jobject arg1, jint arg1_byte_offset, jobject arg2, jint arg2_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clTerminateContextKHR1__JJ(JNIEnv *env, jobject _unused, jlong arg0, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clReleaseDeviceEXT1__JJ(JNIEnv *env, jobject _unused, jlong arg0, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clRetainDeviceEXT1__JJ(JNIEnv *env, jobject _unused, jlong arg0, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_device_id);
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateSubDevicesEXT1__JLjava_lang_Object_2IZILjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong arg0, jobject arg1, jint arg1_byte_offset, jboolean arg1_is_nio, jint arg2, jobject arg3, jint arg3_byte_offset, jboolean arg3_is_nio, jobject arg4, jint arg4_byte_offset, jboolean arg4_is_nio, jlong procAddress) {
 ...
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateFromGLBuffer1__JJILjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong context, jlong flags, jint bufobj, jobject errcode_ret, jint errcode_ret_byte_offset, jboolean errcode_ret_is_nio, jlong procAddress) {
 ...
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateFromGLTexture1__JJIIILjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong context, jlong flags, jint target, jint miplevel, jint texture, jobject errcode_ret, jint errcode_ret_byte_offset, jboolean errcode_ret_is_nio, jlong procAddress) {
 ...
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateFromGLRenderbuffer1__JJILjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong context, jlong flags, jint renderbuffer, jobject errcode_ret, jint errcode_ret_byte_offset, jboolean errcode_ret_is_nio, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetGLTextureInfo1__JIJLjava_lang_Object_2IZLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong memobj, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jboolean param_value_is_nio, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jboolean param_value_size_ret_is_nio, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueAcquireGLObjects0__JILjava_lang_Object_2IILjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong command_queue, jint num_objects, jobject mem_objects, jint mem_objects_byte_offset, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jobject event, jint event_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clEnqueueReleaseGLObjects0__JILjava_lang_Object_2IILjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jlong command_queue, jint num_objects, jobject mem_objects, jint mem_objects_byte_offset, jint num_events_in_wait_list, jobject event_wait_list, jint event_wait_list_byte_offset, jobject event, jint event_byte_offset, jlong procAddress) {
  typedef cl_int (CL_API_CALL*_local_ARG)(cl_command_queue command_queue, cl_uint num_objects, const cl_mem *  mem_objects, cl_uint num_events_in_wait_list, const cl_event *  event_wait_list, cl_event *  event);
 ...
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateFromGLTexture2D1__JJIIILjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong context, jlong flags, jint target, jint miplevel, jint texture, jobject errcode_ret, jint errcode_ret_byte_offset, jboolean errcode_ret_is_nio, jlong procAddress) {
  typedef cl_mem (CL_API_CALL*_local_ARG)(cl_context context, cl_mem_flags flags, cl_GLenum target, cl_GLint miplevel, cl_GLuint texture, cl_int *  errcode_ret);
 ...
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateFromGLTexture3D1__JJIIILjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong context, jlong flags, jint target, jint miplevel, jint texture, jobject errcode_ret, jint errcode_ret_byte_offset, jboolean errcode_ret_is_nio, jlong procAddress) {
  typedef cl_mem (CL_API_CALL*_local_ARG)(cl_context context, cl_mem_flags flags, cl_GLenum target, cl_GLint miplevel, cl_GLuint texture, cl_int *  errcode_ret);
 ...
 */
JNIEXPORT jint JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clGetGLContextInfoKHR0__Ljava_lang_Object_2IIJLjava_lang_Object_2ILjava_lang_Object_2IJ(JNIEnv *env, jobject _unused, jobject properties, jint properties_byte_offset, jint param_name, jlong param_value_size, jobject param_value, jint param_value_byte_offset, jobject param_value_size_ret, jint param_value_size_ret_byte_offset, jlong procAddress) {
 ...
 */
JNIEXPORT jlong JNICALL 
Java_com_jogamp_opencl_llb_impl_CLImpl20_dispatch_1clCreateEventFromGLsyncKHR1__JJLjava_lang_Object_2IZJ(JNIEnv *env, jobject _unused, jlong arg0, jlong arg1, jobject arg2, jint arg2_byte_offset, jboolean arg2_is_nio, jlong procAddress) {
