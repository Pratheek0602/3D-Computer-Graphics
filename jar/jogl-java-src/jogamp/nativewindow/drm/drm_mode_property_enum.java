...
/* !---- Java-Unit: [pkg jogamp.nativewindow.drm, cls drm_mode_property_enum], ../build/nativewindow/gensrc/classes/jogamp/nativewindow/drm/drm_mode_property_enum.java ----! */
...
public class drm_mode_property_enum {
  ...
  private static final int[] drm_mode_property_enum_size = new int[] { 0 /* ARM_MIPS_32 */, 0 /* X86_32_UNIX */, 0 /* X86_32_ANDROID */, 0 /* X86_32_MACOS */, 0 /* PPC_32_UNIX */, 0 /* SPARC_32_SUNOS */, 0 /* X86_32_WINDOWS */, 0 /* LP64_UNIX */, 0 /* X86_64_WINDOWS */, 0 /* ARM64_IOS */  };
  ...
  public static drm_mode_property_enum create(java.nio.ByteBuffer buf) {
      return new drm_mode_property_enum(buf);
  }

  /** Returns new instance dereferencing ByteBuffer at given native address `addr` with size {@link #size()}. */
  public static drm_mode_property_enum derefPointer(final long addr) {
      return create( ElementBuffer.derefPointer(size(), addr, 1).getByteBuffer() );
  }

  drm_mode_property_enum(java.nio.ByteBuffer buf) {
