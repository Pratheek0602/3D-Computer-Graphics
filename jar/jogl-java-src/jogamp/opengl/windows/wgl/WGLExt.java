...
/* !---- Java-Unit: [pkg jogamp.opengl.windows.wgl, cls WGLExt], ../build/jogl/gensrc/classes/jogamp/opengl/windows/wgl/WGLExt.java ----! */
...
public interface WGLExt {
  ...
  /** <code>WGL_ARB_create_context_robustness</code><br>Define "WGL_LOSE_CONTEXT_ON_RESET_ARB" with expression '<code>0x8252</code>', CType: int */
  public static final int WGL_LOSE_CONTEXT_ON_RESET_ARB = 0x8252;
  /** Part of CORE DEF<br>Define "WGL_NV_DX_interop" with expression '<code>1</code>', CType: int */
  public static final int WGL_NV_DX_interop = 0x1;
  /** Part of CORE DEF<br>Define "BI_RLE8" with expression '<code>1</code>', CType: int */
  public static final int BI_RLE8 = 0x1;
  /** Part of CORE DEF<br>Define "BI_RLE4" with expression '<code>2</code>', CType: int */
  public static final int BI_RLE4 = 0x2;
  /** <code>WGL_EXT_multisample</code><br>Define "WGL_SAMPLE_BUFFERS_EXT" with expression '<code>0x2041</code>', CType: int */
  public static final int WGL_SAMPLE_BUFFERS_EXT = 0x2041;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_TEXTURE_CUBE_MAP_NEGATIVE_Z_ARB" with expression '<code>0x2082</code>', CType: int */
  public static final int WGL_TEXTURE_CUBE_MAP_NEGATIVE_Z_ARB = 0x2082;
  /** Part of CORE DEF<br>Define "WGL_EXT_make_current_read" with expression '<code>1</code>', CType: int */
  public static final int WGL_EXT_make_current_read = 0x1;
  /** Part of CORE DEF<br>Define "WGL_ARB_pixel_format_float" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_pixel_format_float = 0x1;
  /** Part of CORE DEF<br>Define "ERROR_INVALID_WINDOW_HANDLE" with expression '<code>1400</code>', CType: int */
  public static final int ERROR_INVALID_WINDOW_HANDLE = 0x578;
  /** <code>WGL_I3D_image_buffer</code><br>Define "WGL_IMAGE_BUFFER_LOCK_I3D" with expression '<code>0x00000002</code>', CType: int */
  public static final int WGL_IMAGE_BUFFER_LOCK_I3D = 0x2;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_NEED_PALETTE_ARB" with expression '<code>0x2004</code>', CType: int */
  public static final int WGL_NEED_PALETTE_ARB = 0x2004;
  /** Part of CORE DEF<br>Define "OBJ_BRUSH" with expression '<code>2</code>', CType: int */
  public static final int OBJ_BRUSH = 0x2;
  /** <code>WGL_NV_video_output</code><br>Define "WGL_VIDEO_OUT_COLOR_AND_ALPHA_NV" with expression '<code>0x20C6</code>', CType: int */
  public static final int WGL_VIDEO_OUT_COLOR_AND_ALPHA_NV = 0x20c6;
  /** Part of CORE DEF<br>Define "OBJ_BITMAP" with expression '<code>7</code>', CType: int */
  public static final int OBJ_BITMAP = 0x7;
  /** <code>WGL_I3D_genlock</code><br>Define "WGL_GENLOCK_SOURCE_EDGE_RISING_I3D" with expression '<code>0x204B</code>', CType: int */
  public static final int WGL_GENLOCK_SOURCE_EDGE_RISING_I3D = 0x204b;
  /** Part of CORE DEF<br>Define "SW_SHOWMINNOACTIVE" with expression '<code>7</code>', CType: int */
  public static final int SW_SHOWMINNOACTIVE = 0x7;
  /** <code>WGL_3DL_stereo_control</code><br>Define "WGL_STEREO_EMITTER_ENABLE_3DL" with expression '<code>0x2055</code>', CType: int */
  public static final int WGL_STEREO_EMITTER_ENABLE_3DL = 0x2055;
  /** Part of CORE DEF<br>Define "SW_MINIMIZE" with expression '<code>6</code>', CType: int */
  public static final int SW_MINIMIZE = 0x6;
  /** Part of CORE DEF<br>Define "SW_RESTORE" with expression '<code>9</code>', CType: int */
  public static final int SW_RESTORE = 0x9;
  /** Part of CORE DEF<br>Define "WGL_ARB_buffer_region" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_buffer_region = 0x1;
  /** Part of CORE DEF<br>Define "WGL_EXT_pbuffer" with expression '<code>1</code>', CType: int */
  public static final int WGL_EXT_pbuffer = 0x1;
  /** Part of CORE DEF<br>Define "OBJ_EXTPEN" with expression '<code>11</code>', CType: int */
  public static final int OBJ_EXTPEN = 0xb;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_NUMBER_OVERLAYS_EXT" with expression '<code>0x2008</code>', CType: int */
  public static final int WGL_NUMBER_OVERLAYS_EXT = 0x2008;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_AUX2_ARB" with expression '<code>0x2089</code>', CType: int */
  public static final int WGL_AUX2_ARB = 0x2089;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_STENCIL_BITS_ARB" with expression '<code>0x2023</code>', CType: int */
  public static final int WGL_STENCIL_BITS_ARB = 0x2023;
  /** <code>WGL_NV_video_capture</code><br>Define "WGL_UNIQUE_ID_NV" with expression '<code>0x20CE</code>', CType: int */
  public static final int WGL_UNIQUE_ID_NV = 0x20ce;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_TRANSPARENT_VALUE_EXT" with expression '<code>0x200B</code>', CType: int */
  public static final int WGL_TRANSPARENT_VALUE_EXT = 0x200b;
  /** Part of CORE DEF<br>Define "PFD_DRAW_TO_WINDOW" with expression '<code>0x00000004</code>', CType: int */
  public static final int PFD_DRAW_TO_WINDOW = 0x4;
  /** <code>WGL_ARB_create_context_robustness</code><br>Define "WGL_NO_RESET_NOTIFICATION_ARB" with expression '<code>0x8261</code>', CType: int */
  public static final int WGL_NO_RESET_NOTIFICATION_ARB = 0x8261;
  /** Part of CORE DEF<br>Define "BI_RGB" with expression '<code>0</code>', CType: int */
  public static final int BI_RGB = 0x0;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_SWAP_COPY_ARB" with expression '<code>0x2029</code>', CType: int */
  public static final int WGL_SWAP_COPY_ARB = 0x2029;
  /** <code>WGL_ARB_create_context</code><br>Define "WGL_CONTEXT_LAYER_PLANE_ARB" with expression '<code>0x2093</code>', CType: int */
  public static final int WGL_CONTEXT_LAYER_PLANE_ARB = 0x2093;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_SUPPORT_GDI_ARB" with expression '<code>0x200F</code>', CType: int */
  public static final int WGL_SUPPORT_GDI_ARB = 0x200f;
  /** Part of CORE DEF<br>Define "WGL_NV_vertex_array_range" with expression '<code>1</code>', CType: int */
  public static final int WGL_NV_vertex_array_range = 0x1;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_AUX9_ARB" with expression '<code>0x2090</code>', CType: int */
  public static final int WGL_AUX9_ARB = 0x2090;
  /** Part of CORE DEF<br>Define "WGL_ARB_context_flush_control" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_context_flush_control = 0x1;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_FULL_ACCELERATION_ARB" with expression '<code>0x2027</code>', CType: int */
  public static final int WGL_FULL_ACCELERATION_ARB = 0x2027;
  /** Part of CORE DEF<br>Define "DIB_PAL_COLORS" with expression '<code>1</code>', CType: int */
  public static final int DIB_PAL_COLORS = 0x1;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_GREEN_BITS_ARB" with expression '<code>0x2017</code>', CType: int */
  public static final int WGL_GREEN_BITS_ARB = 0x2017;
  /** <code>WGL_I3D_genlock</code><br>Define "WGL_GENLOCK_SOURCE_EXTERNAL_FIELD_I3D" with expression '<code>0x2046</code>', CType: int */
  public static final int WGL_GENLOCK_SOURCE_EXTERNAL_FIELD_I3D = 0x2046;
  /** <code>WGL_EXT_pbuffer</code><br>Define "WGL_MAX_PBUFFER_HEIGHT_EXT" with expression '<code>0x2030</code>', CType: int */
  public static final int WGL_MAX_PBUFFER_HEIGHT_EXT = 0x2030;
  /** <code>WGL_NV_float_buffer</code><br>Define "WGL_TEXTURE_FLOAT_RGBA_NV" with expression '<code>0x20B8</code>', CType: int */
  public static final int WGL_TEXTURE_FLOAT_RGBA_NV = 0x20b8;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_ACCUM_GREEN_BITS_EXT" with expression '<code>0x201F</code>', CType: int */
  public static final int WGL_ACCUM_GREEN_BITS_EXT = 0x201f;
  /** Part of CORE DEF<br>Define "WGL_NV_float_buffer" with expression '<code>1</code>', CType: int */
  public static final int WGL_NV_float_buffer = 0x1;
  /** Part of CORE DEF<br>Define "WGL_3DL_stereo_control" with expression '<code>1</code>', CType: int */
  public static final int WGL_3DL_stereo_control = 0x1;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_TEXTURE_1D_ARB" with expression '<code>0x2079</code>', CType: int */
  public static final int WGL_TEXTURE_1D_ARB = 0x2079;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_ACCUM_GREEN_BITS_ARB" with expression '<code>0x201F</code>', CType: int */
  public static final int WGL_ACCUM_GREEN_BITS_ARB = 0x201f;
  /** <code>WGL_NV_video_output</code><br>Define "WGL_BIND_TO_VIDEO_RGBA_NV" with expression '<code>0x20C1</code>', CType: int */
  public static final int WGL_BIND_TO_VIDEO_RGBA_NV = 0x20c1;
  /** Part of CORE DEF<br>Define "WGL_EXT_extensions_string" with expression '<code>1</code>', CType: int */
  public static final int WGL_EXT_extensions_string = 0x1;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_AUX3_ARB" with expression '<code>0x208A</code>', CType: int */
  public static final int WGL_AUX3_ARB = 0x208a;
  /** Part of CORE DEF<br>Define "PFD_MAIN_PLANE" with expression '<code>0</code>', CType: int */
  public static final int PFD_MAIN_PLANE = 0x0;
  /** <code>WGL_NV_video_output</code><br>Define "WGL_BIND_TO_VIDEO_RGB_NV" with expression '<code>0x20C0</code>', CType: int */
  public static final int WGL_BIND_TO_VIDEO_RGB_NV = 0x20c0;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_AUX_BUFFERS_ARB" with expression '<code>0x2024</code>', CType: int */
  public static final int WGL_AUX_BUFFERS_ARB = 0x2024;
  /** <code>WGL_NV_multisample_coverage</code><br>Define "WGL_COLOR_SAMPLES_NV" with expression '<code>0x20B9</code>', CType: int */
  public static final int WGL_COLOR_SAMPLES_NV = 0x20b9;
  /** Part of CORE DEF<br>Define "WGL_EXT_framebuffer_sRGB" with expression '<code>1</code>', CType: int */
  public static final int WGL_EXT_framebuffer_sRGB = 0x1;
  /** Part of CORE DEF<br>Define "WGL_NV_present_video" with expression '<code>1</code>', CType: int */
  public static final int WGL_NV_present_video = 0x1;
  /** <code>WGL_ARB_context_flush_control</code><br>Define "WGL_CONTEXT_RELEASE_BEHAVIOR_NONE_ARB" with expression '<code>0</code>', CType: int */
  public static final int WGL_CONTEXT_RELEASE_BEHAVIOR_NONE_ARB = 0x0;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_NUMBER_PIXEL_FORMATS_ARB" with expression '<code>0x2000</code>', CType: int */
  public static final int WGL_NUMBER_PIXEL_FORMATS_ARB = 0x2000;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_GREEN_BITS_EXT" with expression '<code>0x2017</code>', CType: int */
  public static final int WGL_GREEN_BITS_EXT = 0x2017;
  /** Part of CORE DEF<br>Define "PFD_TYPE_COLORINDEX" with expression '<code>1</code>', CType: int */
  public static final int PFD_TYPE_COLORINDEX = 0x1;
  /** <code>WGL_NV_multisample_coverage</code><br>Define "WGL_COVERAGE_SAMPLES_NV" with expression '<code>0x2042</code>', CType: int */
  public static final int WGL_COVERAGE_SAMPLES_NV = 0x2042;
  /** Part of CORE DEF<br>Define "GLEXT_64_TYPES_DEFINED" with expression '<code>1</code>', CType: int */
  public static final int GLEXT_64_TYPES_DEFINED = 0x1;
  /** Part of CORE DEF<br>Define "WGL_OML_sync_control" with expression '<code>1</code>', CType: int */
  public static final int WGL_OML_sync_control = 0x1;
  /** Part of CORE DEF<br>Define "WGL_I3D_genlock" with expression '<code>1</code>', CType: int */
  public static final int WGL_I3D_genlock = 0x1;
  /** Part of CORE DEF<br>Define "WGL_3DFX_multisample" with expression '<code>1</code>', CType: int */
  public static final int WGL_3DFX_multisample = 0x1;
  /** <code>WGL_AMD_gpu_association</code><br>Define "WGL_GPU_NUM_SIMD_AMD" with expression '<code>0x21A6</code>', CType: int */
  public static final int WGL_GPU_NUM_SIMD_AMD = 0x21a6;
  /** <code>WGL_ARB_create_context</code><br>Define "WGL_CONTEXT_DEBUG_BIT_ARB" with expression '<code>0x00000001</code>', CType: int */
  public static final int WGL_CONTEXT_DEBUG_BIT_ARB = 0x1;
  /** Part of CORE DEF<br>Define "WGL_NV_DX_interop2" with expression '<code>1</code>', CType: int */
  public static final int WGL_NV_DX_interop2 = 0x1;
  /** <code>WGL_ARB_create_context</code><br>Define "WGL_CONTEXT_FLAGS_ARB" with expression '<code>0x2094</code>', CType: int */
  public static final int WGL_CONTEXT_FLAGS_ARB = 0x2094;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_AUX8_ARB" with expression '<code>0x208F</code>', CType: int */
  public static final int WGL_AUX8_ARB = 0x208f;
  /** <code>WGL_ARB_multisample</code><br>Define "WGL_SAMPLE_BUFFERS_ARB" with expression '<code>0x2041</code>', CType: int */
  public static final int WGL_SAMPLE_BUFFERS_ARB = 0x2041;
  /** <code>WGL_EXT_pbuffer</code><br>Define "WGL_OPTIMAL_PBUFFER_HEIGHT_EXT" with expression '<code>0x2032</code>', CType: int */
  public static final int WGL_OPTIMAL_PBUFFER_HEIGHT_EXT = 0x2032;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_RED_SHIFT_ARB" with expression '<code>0x2016</code>', CType: int */
  public static final int WGL_RED_SHIFT_ARB = 0x2016;
  /** <code>WGL_NV_render_depth_texture</code><br>Define "WGL_DEPTH_TEXTURE_FORMAT_NV" with expression '<code>0x20A5</code>', CType: int */
  public static final int WGL_DEPTH_TEXTURE_FORMAT_NV = 0x20a5;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_NUMBER_PIXEL_FORMATS_EXT" with expression '<code>0x2000</code>', CType: int */
  public static final int WGL_NUMBER_PIXEL_FORMATS_EXT = 0x2000;
  /** Part of CORE DEF<br>Define "WGL_I3D_gamma" with expression '<code>1</code>', CType: int */
  public static final int WGL_I3D_gamma = 0x1;
  /** Part of CORE DEF<br>Define "WGL_I3D_swap_frame_lock" with expression '<code>1</code>', CType: int */
  public static final int WGL_I3D_swap_frame_lock = 0x1;
  /** Part of CORE DEF<br>Define "WGL_NV_copy_image" with expression '<code>1</code>', CType: int */
  public static final int WGL_NV_copy_image = 0x1;
  /** Part of CORE DEF<br>Define "PFD_OVERLAY_PLANE" with expression '<code>1</code>', CType: int */
  public static final int PFD_OVERLAY_PLANE = 0x1;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_NEED_PALETTE_EXT" with expression '<code>0x2004</code>', CType: int */
  public static final int WGL_NEED_PALETTE_EXT = 0x2004;
  /** Part of CORE DEF<br>Define "PFD_STEREO" with expression '<code>0x00000002</code>', CType: int */
  public static final int PFD_STEREO = 0x2;
  /** <code>WGL_I3D_digital_video_control</code><br>Define "WGL_DIGITAL_VIDEO_GAMMA_CORRECTED_I3D" with expression '<code>0x2053</code>', CType: int */
  public static final int WGL_DIGITAL_VIDEO_GAMMA_CORRECTED_I3D = 0x2053;
  /** Part of CORE DEF<br>Define "PFD_GENERIC_ACCELERATED" with expression '<code>0x00001000</code>', CType: int */
  public static final int PFD_GENERIC_ACCELERATED = 0x1000;
  /** <code>WGL_NV_float_buffer</code><br>Define "WGL_BIND_TO_TEXTURE_RECTANGLE_FLOAT_RGBA_NV" with expression '<code>0x20B4</code>', CType: int */
  public static final int WGL_BIND_TO_TEXTURE_RECTANGLE_FLOAT_RGBA_NV = 0x20b4;
  /** Part of CORE DEF<br>Define "ERROR_INCOMPATIBLE_DEVICE_CONTEXTS_ARB" with expression '<code>0x2054</code>', CType: int */
  public static final int ERROR_INCOMPATIBLE_DEVICE_CONTEXTS_ARB = 0x2054;
  /** <code>WGL_EXT_pbuffer</code><br>Define "WGL_PBUFFER_HEIGHT_EXT" with expression '<code>0x2035</code>', CType: int */
  public static final int WGL_PBUFFER_HEIGHT_EXT = 0x2035;
  /** Part of CORE DEF<br>Define "WGL_WGLEXT_VERSION" with expression '<code>20150623</code>', CType: int */
  public static final int WGL_WGLEXT_VERSION = 0x133795f;
  /** Part of CORE DEF<br>Define "WGL_ATI_pixel_format_float" with expression '<code>1</code>', CType: int */
  public static final int WGL_ATI_pixel_format_float = 0x1;
  /** Part of CORE DEF<br>Define "ERROR_NO_SYSTEM_RESOURCES" with expression '<code>1450</code>', CType: int */
  public static final int ERROR_NO_SYSTEM_RESOURCES = 0x5aa;
  /** Part of CORE DEF<br>Define "WGL_ARB_framebuffer_sRGB" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_framebuffer_sRGB = 0x1;
  /** Part of CORE DEF<br>Define "WGL_AMD_gpu_association" with expression '<code>1</code>', CType: int */
  public static final int WGL_AMD_gpu_association = 0x1;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_TRANSPARENT_RED_VALUE_ARB" with expression '<code>0x2037</code>', CType: int */
  public static final int WGL_TRANSPARENT_RED_VALUE_ARB = 0x2037;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_AUX4_ARB" with expression '<code>0x208B</code>', CType: int */
  public static final int WGL_AUX4_ARB = 0x208b;
  /** <code>WGL_3DFX_multisample</code><br>Define "WGL_SAMPLE_BUFFERS_3DFX" with expression '<code>0x2060</code>', CType: int */
  public static final int WGL_SAMPLE_BUFFERS_3DFX = 0x2060;
  /** <code>WGL_NV_video_output</code><br>Define "WGL_VIDEO_OUT_STACKED_FIELDS_1_2" with expression '<code>0x20CB</code>', CType: int */
  public static final int WGL_VIDEO_OUT_STACKED_FIELDS_1_2 = 0x20cb;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_RED_SHIFT_EXT" with expression '<code>0x2016</code>', CType: int */
  public static final int WGL_RED_SHIFT_EXT = 0x2016;
  /** Part of CORE DEF<br>Define "WGL_ARB_multisample" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_multisample = 0x1;
  /** <code>WGL_NV_float_buffer</code><br>Define "WGL_TEXTURE_FLOAT_RG_NV" with expression '<code>0x20B6</code>', CType: int */
  public static final int WGL_TEXTURE_FLOAT_RG_NV = 0x20b6;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_PIXEL_TYPE_EXT" with expression '<code>0x2013</code>', CType: int */
  public static final int WGL_PIXEL_TYPE_EXT = 0x2013;
  /** <code>WGL_NV_render_depth_texture</code><br>Define "WGL_BIND_TO_TEXTURE_RECTANGLE_DEPTH_NV" with expression '<code>0x20A4</code>', CType: int */
  public static final int WGL_BIND_TO_TEXTURE_RECTANGLE_DEPTH_NV = 0x20a4;
  /** <code>WGL_ARB_pbuffer</code><br>Define "WGL_MAX_PBUFFER_HEIGHT_ARB" with expression '<code>0x2030</code>', CType: int */
  public static final int WGL_MAX_PBUFFER_HEIGHT_ARB = 0x2030;
  /** Part of CORE DEF<br>Define "__wglext_h_" with expression '<code>1</code>', CType: int */
  public static final int __wglext_h_ = 0x1;
  /** <code>WGL_ARB_pbuffer</code><br>Define "WGL_MAX_PBUFFER_PIXELS_ARB" with expression '<code>0x202E</code>', CType: int */
  public static final int WGL_MAX_PBUFFER_PIXELS_ARB = 0x202e;
  /** Part of CORE DEF<br>Define "ERROR_MISSING_AFFINITY_MASK_NV" with expression '<code>0x20D1</code>', CType: int */
  public static final int ERROR_MISSING_AFFINITY_MASK_NV = 0x20d1;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_SWAP_EXCHANGE_EXT" with expression '<code>0x2028</code>', CType: int */
  public static final int WGL_SWAP_EXCHANGE_EXT = 0x2028;
  /** <code>WGL_ARB_pbuffer</code><br>Define "WGL_PBUFFER_HEIGHT_ARB" with expression '<code>0x2035</code>', CType: int */
  public static final int WGL_PBUFFER_HEIGHT_ARB = 0x2035;
  /** <code>WGL_AMD_gpu_association</code><br>Define "WGL_GPU_CLOCK_AMD" with expression '<code>0x21A4</code>', CType: int */
  public static final int WGL_GPU_CLOCK_AMD = 0x21a4;
  /** <code>WGL_EXT_create_context_es2_profile</code><br>Define "WGL_CONTEXT_ES2_PROFILE_BIT_EXT" with expression '<code>0x00000004</code>', CType: int */
  public static final int WGL_CONTEXT_ES2_PROFILE_BIT_EXT = 0x4;
  /** Part of CORE DEF<br>Define "SW_SHOWNA" with expression '<code>8</code>', CType: int */
  public static final int SW_SHOWNA = 0x8;
  /** Part of CORE DEF<br>Define "WGL_NV_render_texture_rectangle" with expression '<code>1</code>', CType: int */
  public static final int WGL_NV_render_texture_rectangle = 0x1;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_NO_TEXTURE_ARB" with expression '<code>0x2077</code>', CType: int */
  public static final int WGL_NO_TEXTURE_ARB = 0x2077;
  /** Part of CORE DEF<br>Define "WGL_EXT_multisample" with expression '<code>1</code>', CType: int */
  public static final int WGL_EXT_multisample = 0x1;
  /** <code>WGL_NV_video_output</code><br>Define "WGL_VIDEO_OUT_STACKED_FIELDS_2_1" with expression '<code>0x20CC</code>', CType: int */
  public static final int WGL_VIDEO_OUT_STACKED_FIELDS_2_1 = 0x20cc;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_FULL_ACCELERATION_EXT" with expression '<code>0x2027</code>', CType: int */
  public static final int WGL_FULL_ACCELERATION_EXT = 0x2027;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_SWAP_EXCHANGE_ARB" with expression '<code>0x2028</code>', CType: int */
  public static final int WGL_SWAP_EXCHANGE_ARB = 0x2028;
  /** Part of CORE DEF<br>Define "WGL_I3D_digital_video_control" with expression '<code>1</code>', CType: int */
  public static final int WGL_I3D_digital_video_control = 0x1;
  /** <code>WGL_NV_float_buffer</code><br>Define "WGL_BIND_TO_TEXTURE_RECTANGLE_FLOAT_RGB_NV" with expression '<code>0x20B3</code>', CType: int */
  public static final int WGL_BIND_TO_TEXTURE_RECTANGLE_FLOAT_RGB_NV = 0x20b3;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_NEED_SYSTEM_PALETTE_EXT" with expression '<code>0x2005</code>', CType: int */
  public static final int WGL_NEED_SYSTEM_PALETTE_EXT = 0x2005;
  /** Part of CORE DEF<br>Define "OBJ_METADC" with expression '<code>4</code>', CType: int */
  public static final int OBJ_METADC = 0x4;
  /** <code>WGL_NV_render_depth_texture</code><br>Define "WGL_DEPTH_COMPONENT_NV" with expression '<code>0x20A7</code>', CType: int */
  public static final int WGL_DEPTH_COMPONENT_NV = 0x20a7;
  /** <code>WGL_NV_video_output</code><br>Define "WGL_VIDEO_OUT_ALPHA_NV" with expression '<code>0x20C4</code>', CType: int */
  public static final int WGL_VIDEO_OUT_ALPHA_NV = 0x20c4;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_SWAP_LAYER_BUFFERS_EXT" with expression '<code>0x2006</code>', CType: int */
  public static final int WGL_SWAP_LAYER_BUFFERS_EXT = 0x2006;
  /** <code>WGL_NV_float_buffer</code><br>Define "WGL_BIND_TO_TEXTURE_RECTANGLE_FLOAT_RG_NV" with expression '<code>0x20B2</code>', CType: int */
  public static final int WGL_BIND_TO_TEXTURE_RECTANGLE_FLOAT_RG_NV = 0x20b2;
  /** <code>WGL_EXT_pbuffer</code><br>Define "WGL_MAX_PBUFFER_PIXELS_EXT" with expression '<code>0x202E</code>', CType: int */
  public static final int WGL_MAX_PBUFFER_PIXELS_EXT = 0x202e;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_STEREO_EXT" with expression '<code>0x2012</code>', CType: int */
  public static final int WGL_STEREO_EXT = 0x2012;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_MIPMAP_TEXTURE_ARB" with expression '<code>0x2074</code>', CType: int */
  public static final int WGL_MIPMAP_TEXTURE_ARB = 0x2074;
  /** <code>WGL_NV_render_texture_rectangle</code><br>Define "WGL_TEXTURE_RECTANGLE_NV" with expression '<code>0x20A2</code>', CType: int */
  public static final int WGL_TEXTURE_RECTANGLE_NV = 0x20a2;
  /** <code>WGL_3DFX_multisample</code><br>Define "WGL_SAMPLES_3DFX" with expression '<code>0x2061</code>', CType: int */
  public static final int WGL_SAMPLES_3DFX = 0x2061;
  /** Part of CORE DEF<br>Define "SW_NORMAL" with expression '<code>1</code>', CType: int */
  public static final int SW_NORMAL = 0x1;
  /** <code>WGL_EXT_pbuffer</code><br>Define "WGL_DRAW_TO_PBUFFER_EXT" with expression '<code>0x202D</code>', CType: int */
  public static final int WGL_DRAW_TO_PBUFFER_EXT = 0x202d;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_SUPPORT_GDI_EXT" with expression '<code>0x200F</code>', CType: int */
  public static final int WGL_SUPPORT_GDI_EXT = 0x200f;
  /** Part of CORE DEF<br>Define "WGL_ARB_render_texture" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_render_texture = 0x1;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_STENCIL_BITS_EXT" with expression '<code>0x2023</code>', CType: int */
  public static final int WGL_STENCIL_BITS_EXT = 0x2023;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_TEXTURE_CUBE_MAP_ARB" with expression '<code>0x2078</code>', CType: int */
  public static final int WGL_TEXTURE_CUBE_MAP_ARB = 0x2078;
  /** <code>WGL_I3D_digital_video_control</code><br>Define "WGL_DIGITAL_VIDEO_CURSOR_ALPHA_VALUE_I3D" with expression '<code>0x2051</code>', CType: int */
  public static final int WGL_DIGITAL_VIDEO_CURSOR_ALPHA_VALUE_I3D = 0x2051;
  /** <code>WGL_I3D_genlock</code><br>Define "WGL_GENLOCK_SOURCE_DIGITAL_FIELD_I3D" with expression '<code>0x2049</code>', CType: int */
  public static final int WGL_GENLOCK_SOURCE_DIGITAL_FIELD_I3D = 0x2049;
  /** Part of CORE DEF<br>Define "PFD_STEREO_DONTCARE" with expression '<code>0x80000000</code>', CType: long */
  public static final long PFD_STEREO_DONTCARE = 0x80000000L;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_AUX5_ARB" with expression '<code>0x208C</code>', CType: int */
  public static final int WGL_AUX5_ARB = 0x208c;
  /** Part of CORE DEF<br>Define "OBJ_COLORSPACE" with expression '<code>14</code>', CType: int */
  public static final int OBJ_COLORSPACE = 0xe;
  /** <code>WGL_EXT_pbuffer</code><br>Define "WGL_MAX_PBUFFER_WIDTH_EXT" with expression '<code>0x202F</code>', CType: int */
  public static final int WGL_MAX_PBUFFER_WIDTH_EXT = 0x202f;
  /** Part of CORE DEF<br>Define "OBJ_MEMDC" with expression '<code>10</code>', CType: int */
  public static final int OBJ_MEMDC = 0xa;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_TEXTURE_FORMAT_ARB" with expression '<code>0x2072</code>', CType: int */
  public static final int WGL_TEXTURE_FORMAT_ARB = 0x2072;
  /** <code>WGL_AMD_gpu_association</code><br>Define "WGL_GPU_OPENGL_VERSION_STRING_AMD" with expression '<code>0x1F02</code>', CType: int */
  public static final int WGL_GPU_OPENGL_VERSION_STRING_AMD = 0x1f02;
  /** Part of CORE DEF<br>Define "WGL_EXT_create_context_es2_profile" with expression '<code>1</code>', CType: int */
  public static final int WGL_EXT_create_context_es2_profile = 0x1;
  /** <code>WGL_NV_video_output</code><br>Define "WGL_VIDEO_OUT_COLOR_NV" with expression '<code>0x20C3</code>', CType: int */
  public static final int WGL_VIDEO_OUT_COLOR_NV = 0x20c3;
  /** <code>WGL_AMD_gpu_association</code><br>Define "WGL_GPU_VENDOR_AMD" with expression '<code>0x1F00</code>', CType: int */
  public static final int WGL_GPU_VENDOR_AMD = 0x1f00;
  /** Part of CORE DEF<br>Define "PFD_SWAP_EXCHANGE" with expression '<code>0x00000200</code>', CType: int */
  public static final int PFD_SWAP_EXCHANGE = 0x200;
  /** Part of CORE DEF<br>Define "PFD_DRAW_TO_BITMAP" with expression '<code>0x00000008</code>', CType: int */
  public static final int PFD_DRAW_TO_BITMAP = 0x8;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_NEED_SYSTEM_PALETTE_ARB" with expression '<code>0x2005</code>', CType: int */
  public static final int WGL_NEED_SYSTEM_PALETTE_ARB = 0x2005;
  /** Part of CORE DEF<br>Define "WGL_NV_gpu_affinity" with expression '<code>1</code>', CType: int */
  public static final int WGL_NV_gpu_affinity = 0x1;
  /** Part of CORE DEF<br>Define "WGL_ARB_make_current_read" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_make_current_read = 0x1;
  /** <code>WGL_I3D_gamma</code><br>Define "WGL_GAMMA_EXCLUDE_DESKTOP_I3D" with expression '<code>0x204F</code>', CType: int */
  public static final int WGL_GAMMA_EXCLUDE_DESKTOP_I3D = 0x204f;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_GREEN_SHIFT_EXT" with expression '<code>0x2018</code>', CType: int */
  public static final int WGL_GREEN_SHIFT_EXT = 0x2018;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_SWAP_LAYER_BUFFERS_ARB" with expression '<code>0x2006</code>', CType: int */
  public static final int WGL_SWAP_LAYER_BUFFERS_ARB = 0x2006;
  /** Part of CORE DEF<br>Define "PFD_DOUBLEBUFFER" with expression '<code>0x00000001</code>', CType: int */
  public static final int PFD_DOUBLEBUFFER = 0x1;
  /** <code>WGL_EXT_create_context_es_profile</code><br>Define "WGL_CONTEXT_ES_PROFILE_BIT_EXT" with expression '<code>0x00000004</code>', CType: int */
  public static final int WGL_CONTEXT_ES_PROFILE_BIT_EXT = 0x4;
  /** <code>WGL_I3D_genlock</code><br>Define "WGL_GENLOCK_SOURCE_EXTERNAL_SYNC_I3D" with expression '<code>0x2045</code>', CType: int */
  public static final int WGL_GENLOCK_SOURCE_EXTERNAL_SYNC_I3D = 0x2045;
  /** <code>WGL_I3D_image_buffer</code><br>Define "WGL_IMAGE_BUFFER_MIN_ACCESS_I3D" with expression '<code>0x00000001</code>', CType: int */
  public static final int WGL_IMAGE_BUFFER_MIN_ACCESS_I3D = 0x1;
  /** Part of CORE DEF<br>Define "OBJ_ENHMETADC" with expression '<code>12</code>', CType: int */
  public static final int OBJ_ENHMETADC = 0xc;
  /** <code>WGL_ARB_create_context</code><br>Define "WGL_CONTEXT_MAJOR_VERSION_ARB" with expression '<code>0x2091</code>', CType: int */
  public static final int WGL_CONTEXT_MAJOR_VERSION_ARB = 0x2091;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_GREEN_SHIFT_ARB" with expression '<code>0x2018</code>', CType: int */
  public static final int WGL_GREEN_SHIFT_ARB = 0x2018;
  /** <code>WGL_ARB_pbuffer</code><br>Define "WGL_MAX_PBUFFER_WIDTH_ARB" with expression '<code>0x202F</code>', CType: int */
  public static final int WGL_MAX_PBUFFER_WIDTH_ARB = 0x202f;
  /** <code>WGL_ARB_pbuffer</code><br>Define "WGL_DRAW_TO_PBUFFER_ARB" with expression '<code>0x202D</code>', CType: int */
  public static final int WGL_DRAW_TO_PBUFFER_ARB = 0x202d;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_PIXEL_TYPE_ARB" with expression '<code>0x2013</code>', CType: int */
  public static final int WGL_PIXEL_TYPE_ARB = 0x2013;
  /** Part of CORE DEF<br>Define "WGL_NV_video_output" with expression '<code>1</code>', CType: int */
  public static final int WGL_NV_video_output = 0x1;
  /** Part of CORE DEF<br>Define "PFD_GENERIC_FORMAT" with expression '<code>0x00000040</code>', CType: int */
  public static final int PFD_GENERIC_FORMAT = 0x40;
  /** <code>WGL_ARB_create_context</code><br>Define "WGL_CONTEXT_MINOR_VERSION_ARB" with expression '<code>0x2092</code>', CType: int */
  public static final int WGL_CONTEXT_MINOR_VERSION_ARB = 0x2092;
  /** Part of CORE DEF<br>Define "SW_SHOWMAXIMIZED" with expression '<code>3</code>', CType: int */
  public static final int SW_SHOWMAXIMIZED = 0x3;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_COLOR_BITS_ARB" with expression '<code>0x2014</code>', CType: int */
  public static final int WGL_COLOR_BITS_ARB = 0x2014;
  /** <code>WGL_NV_render_depth_texture</code><br>Define "WGL_BIND_TO_TEXTURE_DEPTH_NV" with expression '<code>0x20A3</code>', CType: int */
  public static final int WGL_BIND_TO_TEXTURE_DEPTH_NV = 0x20a3;
  /** <code>WGL_I3D_genlock</code><br>Define "WGL_GENLOCK_SOURCE_DIGITAL_SYNC_I3D" with expression '<code>0x2048</code>', CType: int */
  public static final int WGL_GENLOCK_SOURCE_DIGITAL_SYNC_I3D = 0x2048;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_TRANSPARENT_GREEN_VALUE_ARB" with expression '<code>0x2038</code>', CType: int */
  public static final int WGL_TRANSPARENT_GREEN_VALUE_ARB = 0x2038;
  /** Part of CORE DEF<br>Define "WGL_I3D_swap_frame_usage" with expression '<code>1</code>', CType: int */
  public static final int WGL_I3D_swap_frame_usage = 0x1;
  /** Part of CORE DEF<br>Define "ERROR_INVALID_PIXEL_TYPE_ARB" with expression '<code>0x2043</code>', CType: int */
  public static final int ERROR_INVALID_PIXEL_TYPE_ARB = 0x2043;
  /** <code>WGL_NV_float_buffer</code><br>Define "WGL_TEXTURE_FLOAT_R_NV" with expression '<code>0x20B5</code>', CType: int */
  public static final int WGL_TEXTURE_FLOAT_R_NV = 0x20b5;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_ALPHA_BITS_EXT" with expression '<code>0x201B</code>', CType: int */
  public static final int WGL_ALPHA_BITS_EXT = 0x201b;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_AUX6_ARB" with expression '<code>0x208D</code>', CType: int */
  public static final int WGL_AUX6_ARB = 0x208d;
  /** <code>WGL_NV_video_output</code><br>Define "WGL_VIDEO_OUT_FIELD_2" with expression '<code>0x20CA</code>', CType: int */
  public static final int WGL_VIDEO_OUT_FIELD_2 = 0x20ca;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_COLOR_BITS_EXT" with expression '<code>0x2014</code>', CType: int */
  public static final int WGL_COLOR_BITS_EXT = 0x2014;
  /** <code>WGL_NV_video_output</code><br>Define "WGL_VIDEO_OUT_FIELD_1" with expression '<code>0x20C9</code>', CType: int */
  public static final int WGL_VIDEO_OUT_FIELD_1 = 0x20c9;
  /** Part of CORE DEF<br>Define "ERROR_INVALID_DATA" with expression '<code>13</code>', CType: int */
  public static final int ERROR_INVALID_DATA = 0xd;
  /** <code>WGL_EXT_pbuffer</code><br>Define "WGL_PBUFFER_LARGEST_EXT" with expression '<code>0x2033</code>', CType: int */
  public static final int WGL_PBUFFER_LARGEST_EXT = 0x2033;
  /** <code>WGL_EXT_multisample</code><br>Define "WGL_SAMPLES_EXT" with expression '<code>0x2042</code>', CType: int */
  public static final int WGL_SAMPLES_EXT = 0x2042;
  /** Part of CORE DEF<br>Define "PFD_UNDERLAY_PLANE" with expression '<code>(-1)</code>', CType: int */
  public static final int PFD_UNDERLAY_PLANE = ( - 0x1 );
  /** <code>WGL_I3D_digital_video_control</code><br>Define "WGL_DIGITAL_VIDEO_CURSOR_INCLUDED_I3D" with expression '<code>0x2052</code>', CType: int */
  public static final int WGL_DIGITAL_VIDEO_CURSOR_INCLUDED_I3D = 0x2052;
  /** Part of CORE DEF<br>Define "WGL_ARB_pbuffer" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_pbuffer = 0x1;
  /** <code>WGL_NV_float_buffer</code><br>Define "WGL_FLOAT_COMPONENTS_NV" with expression '<code>0x20B0</code>', CType: int */
  public static final int WGL_FLOAT_COMPONENTS_NV = 0x20b0;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_TRANSPARENT_BLUE_VALUE_ARB" with expression '<code>0x2039</code>', CType: int */
  public static final int WGL_TRANSPARENT_BLUE_VALUE_ARB = 0x2039;
  /** <code>WGL_3DL_stereo_control</code><br>Define "WGL_STEREO_POLARITY_INVERT_3DL" with expression '<code>0x2058</code>', CType: int */
  public static final int WGL_STEREO_POLARITY_INVERT_3DL = 0x2058;
  /** <code>WGL_ARB_pbuffer</code><br>Define "WGL_PBUFFER_LARGEST_ARB" with expression '<code>0x2033</code>', CType: int */
  public static final int WGL_PBUFFER_LARGEST_ARB = 0x2033;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_NO_ACCELERATION_ARB" with expression '<code>0x2025</code>', CType: int */
  public static final int WGL_NO_ACCELERATION_ARB = 0x2025;
  /** Part of CORE DEF<br>Define "PFD_SUPPORT_GDI" with expression '<code>0x00000010</code>', CType: int */
  public static final int PFD_SUPPORT_GDI = 0x10;
  /** <code>WGL_NV_float_buffer</code><br>Define "WGL_TEXTURE_FLOAT_RGB_NV" with expression '<code>0x20B7</code>', CType: int */
  public static final int WGL_TEXTURE_FLOAT_RGB_NV = 0x20b7;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_ALPHA_BITS_ARB" with expression '<code>0x201B</code>', CType: int */
  public static final int WGL_ALPHA_BITS_ARB = 0x201b;
  /** Part of CORE DEF<br>Define "WGL_ARB_robustness_application_isolation" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_robustness_application_isolation = 0x1;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_BIND_TO_TEXTURE_RGB_ARB" with expression '<code>0x2070</code>', CType: int */
  public static final int WGL_BIND_TO_TEXTURE_RGB_ARB = 0x2070;
  /** <code>WGL_I3D_digital_video_control</code><br>Define "WGL_DIGITAL_VIDEO_CURSOR_ALPHA_FRAMEBUFFER_I3D" with expression '<code>0x2050</code>', CType: int */
  public static final int WGL_DIGITAL_VIDEO_CURSOR_ALPHA_FRAMEBUFFER_I3D = 0x2050;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_TYPE_RGBA_EXT" with expression '<code>0x202B</code>', CType: int */
  public static final int WGL_TYPE_RGBA_EXT = 0x202b;
  /** <code>WGL_AMD_gpu_association</code><br>Define "WGL_GPU_RAM_AMD" with expression '<code>0x21A3</code>', CType: int */
  public static final int WGL_GPU_RAM_AMD = 0x21a3;
  /** Part of CORE DEF<br>Define "PFD_NEED_SYSTEM_PALETTE" with expression '<code>0x00000100</code>', CType: int */
  public static final int PFD_NEED_SYSTEM_PALETTE = 0x100;
  /** Part of CORE DEF<br>Define "SW_MAXIMIZE" with expression '<code>3</code>', CType: int */
  public static final int SW_MAXIMIZE = 0x3;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_STEREO_ARB" with expression '<code>0x2012</code>', CType: int */
  public static final int WGL_STEREO_ARB = 0x2012;
  /** Part of CORE DEF<br>Define "WGL_NV_delay_before_swap" with expression '<code>1</code>', CType: int */
  public static final int WGL_NV_delay_before_swap = 0x1;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_TYPE_COLORINDEX_EXT" with expression '<code>0x202C</code>', CType: int */
  public static final int WGL_TYPE_COLORINDEX_EXT = 0x202c;
  /** Part of CORE DEF<br>Define "SW_HIDE" with expression '<code>0</code>', CType: int */
  public static final int SW_HIDE = 0x0;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_MIPMAP_LEVEL_ARB" with expression '<code>0x207B</code>', CType: int */
  public static final int WGL_MIPMAP_LEVEL_ARB = 0x207b;
  /** <code>WGL_ARB_buffer_region</code><br>Define "WGL_STENCIL_BUFFER_BIT_ARB" with expression '<code>0x00000008</code>', CType: int */
  public static final int WGL_STENCIL_BUFFER_BIT_ARB = 0x8;
  /** Part of CORE DEF<br>Define "OBJ_METAFILE" with expression '<code>9</code>', CType: int */
  public static final int OBJ_METAFILE = 0x9;
  /** Part of CORE DEF<br>Define "WGL_ARB_extensions_string" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_extensions_string = 0x1;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_SWAP_UNDEFINED_ARB" with expression '<code>0x202A</code>', CType: int */
  public static final int WGL_SWAP_UNDEFINED_ARB = 0x202a;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_ACCUM_ALPHA_BITS_EXT" with expression '<code>0x2021</code>', CType: int */
  public static final int WGL_ACCUM_ALPHA_BITS_EXT = 0x2021;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_TRANSPARENT_ALPHA_VALUE_ARB" with expression '<code>0x203A</code>', CType: int */
  public static final int WGL_TRANSPARENT_ALPHA_VALUE_ARB = 0x203a;
  /** Part of CORE DEF<br>Define "WGL_NV_video_capture" with expression '<code>1</code>', CType: int */
  public static final int WGL_NV_video_capture = 0x1;
  /** Part of CORE DEF<br>Define "SW_SHOWMINIMIZED" with expression '<code>2</code>', CType: int */
  public static final int SW_SHOWMINIMIZED = 0x2;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_DRAW_TO_WINDOW_ARB" with expression '<code>0x2001</code>', CType: int */
  public static final int WGL_DRAW_TO_WINDOW_ARB = 0x2001;
  /** Part of CORE DEF<br>Define "PFD_DOUBLEBUFFER_DONTCARE" with expression '<code>0x40000000</code>', CType: int */
  public static final int PFD_DOUBLEBUFFER_DONTCARE = 0x40000000;
  /** <code>WGL_ARB_create_context_robustness</code><br>Define "WGL_CONTEXT_ROBUST_ACCESS_BIT_ARB" with expression '<code>0x00000004</code>', CType: int */
  public static final int WGL_CONTEXT_ROBUST_ACCESS_BIT_ARB = 0x4;
  /** Part of CORE DEF<br>Define "SW_MAX" with expression '<code>11</code>', CType: int */
  public static final int SW_MAX = 0xb;
  /** <code>WGL_ARB_create_context</code><br>Define "WGL_CONTEXT_FORWARD_COMPATIBLE_BIT_ARB" with expression '<code>0x00000002</code>', CType: int */
  public static final int WGL_CONTEXT_FORWARD_COMPATIBLE_BIT_ARB = 0x2;
  /** Part of CORE DEF<br>Define "OBJ_DC" with expression '<code>3</code>', CType: int */
  public static final int OBJ_DC = 0x3;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_NO_ACCELERATION_EXT" with expression '<code>0x2025</code>', CType: int */
  public static final int WGL_NO_ACCELERATION_EXT = 0x2025;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_BACK_RIGHT_ARB" with expression '<code>0x2086</code>', CType: int */
  public static final int WGL_BACK_RIGHT_ARB = 0x2086;
  /** Part of CORE DEF<br>Define "WGL_ARB_robustness_share_group_isolation" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_robustness_share_group_isolation = 0x1;
  /** Part of CORE DEF<br>Define "OBJ_PEN" with expression '<code>1</code>', CType: int */
  public static final int OBJ_PEN = 0x1;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_FRONT_RIGHT_ARB" with expression '<code>0x2084</code>', CType: int */
  public static final int WGL_FRONT_RIGHT_ARB = 0x2084;
  /** Part of CORE DEF<br>Define "WGL_I3D_image_buffer" with expression '<code>1</code>', CType: int */
  public static final int WGL_I3D_image_buffer = 0x1;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_ACCUM_RED_BITS_EXT" with expression '<code>0x201E</code>', CType: int */
  public static final int WGL_ACCUM_RED_BITS_EXT = 0x201e;
  /** <code>WGL_ARB_buffer_region</code><br>Define "WGL_BACK_COLOR_BUFFER_BIT_ARB" with expression '<code>0x00000002</code>', CType: int */
  public static final int WGL_BACK_COLOR_BUFFER_BIT_ARB = 0x2;
  /** Part of CORE DEF<br>Define "OBJ_ENHMETAFILE" with expression '<code>13</code>', CType: int */
  public static final int OBJ_ENHMETAFILE = 0xd;
  /** Part of CORE DEF<br>Define "SW_FORCEMINIMIZE" with expression '<code>11</code>', CType: int */
  public static final int SW_FORCEMINIMIZE = 0xb;
  /** Part of CORE DEF<br>Define "ERROR_SUCCESS" with expression '<code>0</code>', CType: int */
  public static final int ERROR_SUCCESS = 0x0;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_SWAP_UNDEFINED_EXT" with expression '<code>0x202A</code>', CType: int */
  public static final int WGL_SWAP_UNDEFINED_EXT = 0x202a;
  /** <code>WGL_NV_DX_interop</code><br>Define "WGL_ACCESS_READ_WRITE_NV" with expression '<code>0x00000001</code>', CType: int */
  public static final int WGL_ACCESS_READ_WRITE_NV = 0x1;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_AUX7_ARB" with expression '<code>0x208E</code>', CType: int */
  public static final int WGL_AUX7_ARB = 0x208e;
  /** <code>WGL_AMD_gpu_association</code><br>Define "WGL_GPU_FASTEST_TARGET_GPUS_AMD" with expression '<code>0x21A2</code>', CType: int */
  public static final int WGL_GPU_FASTEST_TARGET_GPUS_AMD = 0x21a2;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_TYPE_COLORINDEX_ARB" with expression '<code>0x202C</code>', CType: int */
  public static final int WGL_TYPE_COLORINDEX_ARB = 0x202c;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_GENERIC_ACCELERATION_ARB" with expression '<code>0x2026</code>', CType: int */
  public static final int WGL_GENERIC_ACCELERATION_ARB = 0x2026;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_BLUE_SHIFT_ARB" with expression '<code>0x201A</code>', CType: int */
  public static final int WGL_BLUE_SHIFT_ARB = 0x201a;
  /** Part of CORE DEF<br>Define "ERROR_INCOMPATIBLE_AFFINITY_MASKS_NV" with expression '<code>0x20D0</code>', CType: int */
  public static final int ERROR_INCOMPATIBLE_AFFINITY_MASKS_NV = 0x20d0;
  /** Part of CORE DEF<br>Define "ERROR_INVALID_VERSION_ARB" with expression '<code>0x2095</code>', CType: int */
  public static final int ERROR_INVALID_VERSION_ARB = 0x2095;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_SHARE_DEPTH_ARB" with expression '<code>0x200C</code>', CType: int */
  public static final int WGL_SHARE_DEPTH_ARB = 0x200c;
  /** <code>WGL_ATI_pixel_format_float</code><br>Define "WGL_TYPE_RGBA_FLOAT_ATI" with expression '<code>0x21A0</code>', CType: int */
  public static final int WGL_TYPE_RGBA_FLOAT_ATI = 0x21a0;
  /** <code>WGL_ARB_create_context_profile</code><br>Define "WGL_CONTEXT_CORE_PROFILE_BIT_ARB" with expression '<code>0x00000001</code>', CType: int */
  public static final int WGL_CONTEXT_CORE_PROFILE_BIT_ARB = 0x1;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_ACCUM_ALPHA_BITS_ARB" with expression '<code>0x2021</code>', CType: int */
  public static final int WGL_ACCUM_ALPHA_BITS_ARB = 0x2021;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_DOUBLE_BUFFER_EXT" with expression '<code>0x2011</code>', CType: int */
  public static final int WGL_DOUBLE_BUFFER_EXT = 0x2011;
  /** <code>WGL_NV_video_output</code><br>Define "WGL_VIDEO_OUT_COLOR_AND_DEPTH_NV" with expression '<code>0x20C7</code>', CType: int */
  public static final int WGL_VIDEO_OUT_COLOR_AND_DEPTH_NV = 0x20c7;
  /** <code>WGL_I3D_genlock</code><br>Define "WGL_GENLOCK_SOURCE_EXTERNAL_TTL_I3D" with expression '<code>0x2047</code>', CType: int */
  public static final int WGL_GENLOCK_SOURCE_EXTERNAL_TTL_I3D = 0x2047;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_DRAW_TO_WINDOW_EXT" with expression '<code>0x2001</code>', CType: int */
  public static final int WGL_DRAW_TO_WINDOW_EXT = 0x2001;
  /** Part of CORE DEF<br>Define "WGL_EXT_pixel_format_packed_float" with expression '<code>1</code>', CType: int */
  public static final int WGL_EXT_pixel_format_packed_float = 0x1;
  /** <code>WGL_ARB_buffer_region</code><br>Define "WGL_FRONT_COLOR_BUFFER_BIT_ARB" with expression '<code>0x00000001</code>', CType: int */
  public static final int WGL_FRONT_COLOR_BUFFER_BIT_ARB = 0x1;
  /** Part of CORE DEF<br>Define "SW_SHOWNORMAL" with expression '<code>1</code>', CType: int */
  public static final int SW_SHOWNORMAL = 0x1;
  /** Part of CORE DEF<br>Define "ERROR_INVALID_PROFILE_ARB" with expression '<code>0x2096</code>', CType: int */
  public static final int ERROR_INVALID_PROFILE_ARB = 0x2096;
  /** Part of CORE DEF<br>Define "WGL_EXT_pixel_format" with expression '<code>1</code>', CType: int */
  public static final int WGL_EXT_pixel_format = 0x1;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_ACCUM_RED_BITS_ARB" with expression '<code>0x201E</code>', CType: int */
  public static final int WGL_ACCUM_RED_BITS_ARB = 0x201e;
  /** Part of CORE DEF<br>Define "ERROR_PROC_NOT_FOUND" with expression '<code>127</code>', CType: int */
  public static final int ERROR_PROC_NOT_FOUND = 0x7f;
  /** Part of CORE DEF<br>Define "WGL_ARB_create_context" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_create_context = 0x1;
  /** <code>WGL_ARB_create_context_profile</code><br>Define "WGL_CONTEXT_PROFILE_MASK_ARB" with expression '<code>0x9126</code>', CType: int */
  public static final int WGL_CONTEXT_PROFILE_MASK_ARB = 0x9126;
  /** <code>WGL_3DL_stereo_control</code><br>Define "WGL_STEREO_EMITTER_DISABLE_3DL" with expression '<code>0x2056</code>', CType: int */
  public static final int WGL_STEREO_EMITTER_DISABLE_3DL = 0x2056;
  /** Part of CORE DEF<br>Define "PFD_SWAP_LAYER_BUFFERS" with expression '<code>0x00000800</code>', CType: int */
  public static final int PFD_SWAP_LAYER_BUFFERS = 0x800;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_DOUBLE_BUFFER_ARB" with expression '<code>0x2011</code>', CType: int */
  public static final int WGL_DOUBLE_BUFFER_ARB = 0x2011;
  /** <code>WGL_EXT_pbuffer</code><br>Define "WGL_PBUFFER_WIDTH_EXT" with expression '<code>0x2034</code>', CType: int */
  public static final int WGL_PBUFFER_WIDTH_EXT = 0x2034;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_TEXTURE_CUBE_MAP_POSITIVE_Z_ARB" with expression '<code>0x2081</code>', CType: int */
  public static final int WGL_TEXTURE_CUBE_MAP_POSITIVE_Z_ARB = 0x2081;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_TEXTURE_2D_ARB" with expression '<code>0x207A</code>', CType: int */
  public static final int WGL_TEXTURE_2D_ARB = 0x207a;
  /** <code>WGL_ARB_multisample</code><br>Define "WGL_SAMPLES_ARB" with expression '<code>0x2042</code>', CType: int */
  public static final int WGL_SAMPLES_ARB = 0x2042;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_BIND_TO_TEXTURE_RGBA_ARB" with expression '<code>0x2071</code>', CType: int */
  public static final int WGL_BIND_TO_TEXTURE_RGBA_ARB = 0x2071;
  /** <code>WGL_ARB_buffer_region</code><br>Define "WGL_DEPTH_BUFFER_BIT_ARB" with expression '<code>0x00000004</code>', CType: int */
  public static final int WGL_DEPTH_BUFFER_BIT_ARB = 0x4;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_TRANSPARENT_INDEX_VALUE_ARB" with expression '<code>0x203B</code>', CType: int */
  public static final int WGL_TRANSPARENT_INDEX_VALUE_ARB = 0x203b;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_GENERIC_ACCELERATION_EXT" with expression '<code>0x2026</code>', CType: int */
  public static final int WGL_GENERIC_ACCELERATION_EXT = 0x2026;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_BLUE_SHIFT_EXT" with expression '<code>0x201A</code>', CType: int */
  public static final int WGL_BLUE_SHIFT_EXT = 0x201a;
  /** Part of CORE DEF<br>Define "WGL_NV_render_depth_texture" with expression '<code>1</code>', CType: int */
  public static final int WGL_NV_render_depth_texture = 0x1;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_TYPE_RGBA_ARB" with expression '<code>0x202B</code>', CType: int */
  public static final int WGL_TYPE_RGBA_ARB = 0x202b;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_SHARE_DEPTH_EXT" with expression '<code>0x200C</code>', CType: int */
  public static final int WGL_SHARE_DEPTH_EXT = 0x200c;
  /** <code>WGL_NV_DX_interop</code><br>Define "WGL_ACCESS_READ_ONLY_NV" with expression '<code>0x00000000</code>', CType: int */
  public static final int WGL_ACCESS_READ_ONLY_NV = 0x0;
  /** Part of CORE DEF<br>Define "OBJ_PAL" with expression '<code>5</code>', CType: int */
  public static final int OBJ_PAL = 0x5;
  /** <code>WGL_I3D_genlock</code><br>Define "WGL_GENLOCK_SOURCE_EDGE_BOTH_I3D" with expression '<code>0x204C</code>', CType: int */
  public static final int WGL_GENLOCK_SOURCE_EDGE_BOTH_I3D = 0x204c;
  /** <code>WGL_NV_video_capture</code><br>Define "WGL_NUM_VIDEO_CAPTURE_SLOTS_NV" with expression '<code>0x20CF</code>', CType: int */
  public static final int WGL_NUM_VIDEO_CAPTURE_SLOTS_NV = 0x20cf;
  /** <code>WGL_AMD_gpu_association</code><br>Define "WGL_GPU_NUM_RB_AMD" with expression '<code>0x21A7</code>', CType: int */
  public static final int WGL_GPU_NUM_RB_AMD = 0x21a7;
  /** <code>WGL_EXT_depth_float</code><br>Define "WGL_DEPTH_FLOAT_EXT" with expression '<code>0x2040</code>', CType: int */
  public static final int WGL_DEPTH_FLOAT_EXT = 0x2040;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_NUMBER_UNDERLAYS_EXT" with expression '<code>0x2009</code>', CType: int */
  public static final int WGL_NUMBER_UNDERLAYS_EXT = 0x2009;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_BLUE_BITS_EXT" with expression '<code>0x2019</code>', CType: int */
  public static final int WGL_BLUE_BITS_EXT = 0x2019;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_TRANSPARENT_ARB" with expression '<code>0x200A</code>', CType: int */
  public static final int WGL_TRANSPARENT_ARB = 0x200a;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_ACCUM_BLUE_BITS_ARB" with expression '<code>0x2020</code>', CType: int */
  public static final int WGL_ACCUM_BLUE_BITS_ARB = 0x2020;
  /** <code>WGL_I3D_genlock</code><br>Define "WGL_GENLOCK_SOURCE_MULTIVIEW_I3D" with expression '<code>0x2044</code>', CType: int */
  public static final int WGL_GENLOCK_SOURCE_MULTIVIEW_I3D = 0x2044;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_TEXTURE_CUBE_MAP_POSITIVE_Y_ARB" with expression '<code>0x207F</code>', CType: int */
  public static final int WGL_TEXTURE_CUBE_MAP_POSITIVE_Y_ARB = 0x207f;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_SUPPORT_OPENGL_ARB" with expression '<code>0x2010</code>', CType: int */
  public static final int WGL_SUPPORT_OPENGL_ARB = 0x2010;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_RED_BITS_EXT" with expression '<code>0x2015</code>', CType: int */
  public static final int WGL_RED_BITS_EXT = 0x2015;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_CUBE_MAP_FACE_ARB" with expression '<code>0x207C</code>', CType: int */
  public static final int WGL_CUBE_MAP_FACE_ARB = 0x207c;
  /** Part of CORE DEF<br>Define "WGL_EXT_depth_float" with expression '<code>1</code>', CType: int */
  public static final int WGL_EXT_depth_float = 0x1;
  /** Part of CORE DEF<br>Define "PFD_DEPTH_DONTCARE" with expression '<code>0x20000000</code>', CType: int */
  public static final int PFD_DEPTH_DONTCARE = 0x20000000;
  /** <code>WGL_ARB_pbuffer</code><br>Define "WGL_PBUFFER_WIDTH_ARB" with expression '<code>0x2034</code>', CType: int */
  public static final int WGL_PBUFFER_WIDTH_ARB = 0x2034;
  /** <code>WGL_NV_video_output</code><br>Define "WGL_VIDEO_OUT_DEPTH_NV" with expression '<code>0x20C5</code>', CType: int */
  public static final int WGL_VIDEO_OUT_DEPTH_NV = 0x20c5;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_BLUE_BITS_ARB" with expression '<code>0x2019</code>', CType: int */
  public static final int WGL_BLUE_BITS_ARB = 0x2019;
  /** <code>WGL_NV_render_depth_texture</code><br>Define "WGL_TEXTURE_DEPTH_COMPONENT_NV" with expression '<code>0x20A6</code>', CType: int */
  public static final int WGL_TEXTURE_DEPTH_COMPONENT_NV = 0x20a6;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_TEXTURE_CUBE_MAP_NEGATIVE_X_ARB" with expression '<code>0x207E</code>', CType: int */
  public static final int WGL_TEXTURE_CUBE_MAP_NEGATIVE_X_ARB = 0x207e;
  /** <code>WGL_ARB_context_flush_control</code><br>Define "WGL_CONTEXT_RELEASE_BEHAVIOR_FLUSH_ARB" with expression '<code>0x2098</code>', CType: int */
  public static final int WGL_CONTEXT_RELEASE_BEHAVIOR_FLUSH_ARB = 0x2098;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_ACCUM_BLUE_BITS_EXT" with expression '<code>0x2020</code>', CType: int */
  public static final int WGL_ACCUM_BLUE_BITS_EXT = 0x2020;
  /** <code>WGL_I3D_gamma</code><br>Define "WGL_GAMMA_TABLE_SIZE_I3D" with expression '<code>0x204E</code>', CType: int */
  public static final int WGL_GAMMA_TABLE_SIZE_I3D = 0x204e;
  /** Part of CORE DEF<br>Define "PFD_SWAP_COPY" with expression '<code>0x00000400</code>', CType: int */
  public static final int PFD_SWAP_COPY = 0x400;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_ALPHA_SHIFT_EXT" with expression '<code>0x201C</code>', CType: int */
  public static final int WGL_ALPHA_SHIFT_EXT = 0x201c;
  /** Part of CORE DEF<br>Define "WGL_EXT_create_context_es_profile" with expression '<code>1</code>', CType: int */
  public static final int WGL_EXT_create_context_es_profile = 0x1;
  /** Part of CORE DEF<br>Define "PFD_SUPPORT_OPENGL" with expression '<code>0x00000020</code>', CType: int */
  public static final int PFD_SUPPORT_OPENGL = 0x20;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_ALPHA_SHIFT_ARB" with expression '<code>0x201C</code>', CType: int */
  public static final int WGL_ALPHA_SHIFT_ARB = 0x201c;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_NUMBER_UNDERLAYS_ARB" with expression '<code>0x2009</code>', CType: int */
  public static final int WGL_NUMBER_UNDERLAYS_ARB = 0x2009;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_SUPPORT_OPENGL_EXT" with expression '<code>0x2010</code>', CType: int */
  public static final int WGL_SUPPORT_OPENGL_EXT = 0x2010;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_TEXTURE_RGBA_ARB" with expression '<code>0x2076</code>', CType: int */
  public static final int WGL_TEXTURE_RGBA_ARB = 0x2076;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_TRANSPARENT_EXT" with expression '<code>0x200A</code>', CType: int */
  public static final int WGL_TRANSPARENT_EXT = 0x200a;
  /** <code>WGL_NV_float_buffer</code><br>Define "WGL_BIND_TO_TEXTURE_RECTANGLE_FLOAT_R_NV" with expression '<code>0x20B1</code>', CType: int */
  public static final int WGL_BIND_TO_TEXTURE_RECTANGLE_FLOAT_R_NV = 0x20b1;
  /** <code>WGL_ARB_robustness_application_isolation</code><br>Define "WGL_CONTEXT_RESET_ISOLATION_BIT_ARB" with expression '<code>0x00000008</code>', CType: int */
  public static final int WGL_CONTEXT_RESET_ISOLATION_BIT_ARB = 0x8;
  /** <code>WGL_NV_DX_interop</code><br>Define "WGL_ACCESS_WRITE_DISCARD_NV" with expression '<code>0x00000002</code>', CType: int */
  public static final int WGL_ACCESS_WRITE_DISCARD_NV = 0x2;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_AUX_BUFFERS_EXT" with expression '<code>0x2024</code>', CType: int */
  public static final int WGL_AUX_BUFFERS_EXT = 0x2024;
  /** Part of CORE DEF<br>Define "SW_SHOWNOACTIVATE" with expression '<code>4</code>', CType: int */
  public static final int SW_SHOWNOACTIVATE = 0x4;
  /** <code>WGL_ARB_pbuffer</code><br>Define "WGL_PBUFFER_LOST_ARB" with expression '<code>0x2036</code>', CType: int */
  public static final int WGL_PBUFFER_LOST_ARB = 0x2036;
  /** <code>WGL_ARB_pixel_format_float</code><br>Define "WGL_TYPE_RGBA_FLOAT_ARB" with expression '<code>0x21A0</code>', CType: int */
  public static final int WGL_TYPE_RGBA_FLOAT_ARB = 0x21a0;
  /** Part of CORE DEF<br>Define "WGL_NV_multisample_coverage" with expression '<code>1</code>', CType: int */
  public static final int WGL_NV_multisample_coverage = 0x1;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_SHARE_STENCIL_EXT" with expression '<code>0x200D</code>', CType: int */
  public static final int WGL_SHARE_STENCIL_EXT = 0x200d;
  /** <code>WGL_AMD_gpu_association</code><br>Define "WGL_GPU_RENDERER_STRING_AMD" with expression '<code>0x1F01</code>', CType: int */
  public static final int WGL_GPU_RENDERER_STRING_AMD = 0x1f01;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_RED_BITS_ARB" with expression '<code>0x2015</code>', CType: int */
  public static final int WGL_RED_BITS_ARB = 0x2015;
  /** Part of CORE DEF<br>Define "WGL_EXT_swap_control" with expression '<code>1</code>', CType: int */
  public static final int WGL_EXT_swap_control = 0x1;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_AUX0_ARB" with expression '<code>0x2087</code>', CType: int */
  public static final int WGL_AUX0_ARB = 0x2087;
  /** Part of CORE DEF<br>Define "PFD_TYPE_RGBA" with expression '<code>0</code>', CType: int */
  public static final int PFD_TYPE_RGBA = 0x0;
  /** Part of CORE DEF<br>Define "SW_SHOW" with expression '<code>5</code>', CType: int */
  public static final int SW_SHOW = 0x5;
  /** Part of CORE DEF<br>Define "SW_SHOWDEFAULT" with expression '<code>10</code>', CType: int */
  public static final int SW_SHOWDEFAULT = 0xa;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_NUMBER_OVERLAYS_ARB" with expression '<code>0x2008</code>', CType: int */
  public static final int WGL_NUMBER_OVERLAYS_ARB = 0x2008;
  /** <code>WGL_3DL_stereo_control</code><br>Define "WGL_STEREO_POLARITY_NORMAL_3DL" with expression '<code>0x2057</code>', CType: int */
  public static final int WGL_STEREO_POLARITY_NORMAL_3DL = 0x2057;
  /** <code>WGL_AMD_gpu_association</code><br>Define "WGL_GPU_NUM_SPI_AMD" with expression '<code>0x21A8</code>', CType: int */
  public static final int WGL_GPU_NUM_SPI_AMD = 0x21a8;
  /** Part of CORE DEF<br>Define "PFD_SUPPORT_DIRECTDRAW" with expression '<code>0x00002000</code>', CType: int */
  public static final int PFD_SUPPORT_DIRECTDRAW = 0x2000;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_ACCUM_BITS_EXT" with expression '<code>0x201D</code>', CType: int */
  public static final int WGL_ACCUM_BITS_EXT = 0x201d;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_TEXTURE_CUBE_MAP_NEGATIVE_Y_ARB" with expression '<code>0x2080</code>', CType: int */
  public static final int WGL_TEXTURE_CUBE_MAP_NEGATIVE_Y_ARB = 0x2080;
  /** <code>WGL_ARB_create_context_profile</code><br>Define "WGL_CONTEXT_COMPATIBILITY_PROFILE_BIT_ARB" with expression '<code>0x00000002</code>', CType: int */
  public static final int WGL_CONTEXT_COMPATIBILITY_PROFILE_BIT_ARB = 0x2;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_DEPTH_BITS_EXT" with expression '<code>0x2022</code>', CType: int */
  public static final int WGL_DEPTH_BITS_EXT = 0x2022;
  /** Part of CORE DEF<br>Define "WGL_ARB_create_context_robustness" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_create_context_robustness = 0x1;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_SWAP_COPY_EXT" with expression '<code>0x2029</code>', CType: int */
  public static final int WGL_SWAP_COPY_EXT = 0x2029;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_TEXTURE_CUBE_MAP_POSITIVE_X_ARB" with expression '<code>0x207D</code>', CType: int */
  public static final int WGL_TEXTURE_CUBE_MAP_POSITIVE_X_ARB = 0x207d;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_TEXTURE_TARGET_ARB" with expression '<code>0x2073</code>', CType: int */
  public static final int WGL_TEXTURE_TARGET_ARB = 0x2073;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_BACK_LEFT_ARB" with expression '<code>0x2085</code>', CType: int */
  public static final int WGL_BACK_LEFT_ARB = 0x2085;
  /** <code>WGL_NV_render_texture_rectangle</code><br>Define "WGL_BIND_TO_TEXTURE_RECTANGLE_RGBA_NV" with expression '<code>0x20A1</code>', CType: int */
  public static final int WGL_BIND_TO_TEXTURE_RECTANGLE_RGBA_NV = 0x20a1;
  /** Part of CORE DEF<br>Define "DIB_RGB_COLORS" with expression '<code>0</code>', CType: int */
  public static final int DIB_RGB_COLORS = 0x0;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_ACCELERATION_EXT" with expression '<code>0x2003</code>', CType: int */
  public static final int WGL_ACCELERATION_EXT = 0x2003;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_TEXTURE_RGB_ARB" with expression '<code>0x2075</code>', CType: int */
  public static final int WGL_TEXTURE_RGB_ARB = 0x2075;
  /** Part of CORE DEF<br>Define "WGL_EXT_swap_control_tear" with expression '<code>1</code>', CType: int */
  public static final int WGL_EXT_swap_control_tear = 0x1;
  /** Part of CORE DEF<br>Define "BI_BITFIELDS" with expression '<code>3</code>', CType: int */
  public static final int BI_BITFIELDS = 0x3;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_SHARE_STENCIL_ARB" with expression '<code>0x200D</code>', CType: int */
  public static final int WGL_SHARE_STENCIL_ARB = 0x200d;
  /** <code>WGL_EXT_pbuffer</code><br>Define "WGL_OPTIMAL_PBUFFER_WIDTH_EXT" with expression '<code>0x2031</code>', CType: int */
  public static final int WGL_OPTIMAL_PBUFFER_WIDTH_EXT = 0x2031;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_DRAW_TO_BITMAP_ARB" with expression '<code>0x2002</code>', CType: int */
  public static final int WGL_DRAW_TO_BITMAP_ARB = 0x2002;
  /** <code>WGL_NV_video_output</code><br>Define "WGL_VIDEO_OUT_FRAME" with expression '<code>0x20C8</code>', CType: int */
  public static final int WGL_VIDEO_OUT_FRAME = 0x20c8;
  /** Part of CORE DEF<br>Define "HAS_STDDEF" with expression '<code>1</code>', CType: int */
  public static final int HAS_STDDEF = 0x1;
  /** Part of CORE DEF<br>Define "WGL_EXT_display_color_table" with expression '<code>1</code>', CType: int */
  public static final int WGL_EXT_display_color_table = 0x1;
  /** <code>WGL_ARB_framebuffer_sRGB</code><br>Define "WGL_FRAMEBUFFER_SRGB_CAPABLE_ARB" with expression '<code>0x20A9</code>', CType: int */
  public static final int WGL_FRAMEBUFFER_SRGB_CAPABLE_ARB = 0x20a9;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_DEPTH_BITS_ARB" with expression '<code>0x2022</code>', CType: int */
  public static final int WGL_DEPTH_BITS_ARB = 0x2022;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_SHARE_ACCUM_EXT" with expression '<code>0x200E</code>', CType: int */
  public static final int WGL_SHARE_ACCUM_EXT = 0x200e;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_FRONT_LEFT_ARB" with expression '<code>0x2083</code>', CType: int */
  public static final int WGL_FRONT_LEFT_ARB = 0x2083;
  /** Part of CORE DEF<br>Define "WGL_ARB_create_context_profile" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_create_context_profile = 0x1;
  /** <code>WGL_ARB_render_texture</code><br>Define "WGL_AUX1_ARB" with expression '<code>0x2088</code>', CType: int */
  public static final int WGL_AUX1_ARB = 0x2088;
  /** <code>WGL_AMD_gpu_association</code><br>Define "WGL_GPU_NUM_PIPES_AMD" with expression '<code>0x21A5</code>', CType: int */
  public static final int WGL_GPU_NUM_PIPES_AMD = 0x21a5;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_SWAP_METHOD_ARB" with expression '<code>0x2007</code>', CType: int */
  public static final int WGL_SWAP_METHOD_ARB = 0x2007;
  /** Part of CORE DEF<br>Define "WGL_NV_swap_group" with expression '<code>1</code>', CType: int */
  public static final int WGL_NV_swap_group = 0x1;
  /** Part of CORE DEF<br>Define "OBJ_FONT" with expression '<code>6</code>', CType: int */
  public static final int OBJ_FONT = 0x6;
  /** <code>WGL_NV_present_video</code><br>Define "WGL_NUM_VIDEO_SLOTS_NV" with expression '<code>0x20F0</code>', CType: int */
  public static final int WGL_NUM_VIDEO_SLOTS_NV = 0x20f0;
  /** Part of CORE DEF<br>Define "PFD_NEED_PALETTE" with expression '<code>0x00000080</code>', CType: int */
  public static final int PFD_NEED_PALETTE = 0x80;
  /** Part of CORE DEF<br>Define "ERROR_INVALID_PIXEL_TYPE_EXT" with expression '<code>0x2043</code>', CType: int */
  public static final int ERROR_INVALID_PIXEL_TYPE_EXT = 0x2043;
  /** <code>WGL_ARB_create_context_robustness</code><br>Define "WGL_CONTEXT_RESET_NOTIFICATION_STRATEGY_ARB" with expression '<code>0x8256</code>', CType: int */
  public static final int WGL_CONTEXT_RESET_NOTIFICATION_STRATEGY_ARB = 0x8256;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_ACCELERATION_ARB" with expression '<code>0x2003</code>', CType: int */
  public static final int WGL_ACCELERATION_ARB = 0x2003;
  /** <code>WGL_ARB_context_flush_control</code><br>Define "WGL_CONTEXT_RELEASE_BEHAVIOR_ARB" with expression '<code>0x2097</code>', CType: int */
  public static final int WGL_CONTEXT_RELEASE_BEHAVIOR_ARB = 0x2097;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_ACCUM_BITS_ARB" with expression '<code>0x201D</code>', CType: int */
  public static final int WGL_ACCUM_BITS_ARB = 0x201d;
  /** <code>WGL_I3D_genlock</code><br>Define "WGL_GENLOCK_SOURCE_EDGE_FALLING_I3D" with expression '<code>0x204A</code>', CType: int */
  public static final int WGL_GENLOCK_SOURCE_EDGE_FALLING_I3D = 0x204a;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_DRAW_TO_BITMAP_EXT" with expression '<code>0x2002</code>', CType: int */
  public static final int WGL_DRAW_TO_BITMAP_EXT = 0x2002;
  /** Part of CORE DEF<br>Define "OBJ_REGION" with expression '<code>8</code>', CType: int */
  public static final int OBJ_REGION = 0x8;
  /** <code>WGL_ARB_pixel_format</code><br>Define "WGL_SHARE_ACCUM_ARB" with expression '<code>0x200E</code>', CType: int */
  public static final int WGL_SHARE_ACCUM_ARB = 0x200e;
  /** <code>WGL_EXT_framebuffer_sRGB</code><br>Define "WGL_FRAMEBUFFER_SRGB_CAPABLE_EXT" with expression '<code>0x20A9</code>', CType: int */
  public static final int WGL_FRAMEBUFFER_SRGB_CAPABLE_EXT = 0x20a9;
  /** <code>WGL_EXT_pixel_format_packed_float</code><br>Define "WGL_TYPE_RGBA_UNSIGNED_FLOAT_EXT" with expression '<code>0x20A8</code>', CType: int */
  public static final int WGL_TYPE_RGBA_UNSIGNED_FLOAT_EXT = 0x20a8;
  /** <code>WGL_NV_video_output</code><br>Define "WGL_BIND_TO_VIDEO_RGB_AND_DEPTH_NV" with expression '<code>0x20C2</code>', CType: int */
  public static final int WGL_BIND_TO_VIDEO_RGB_AND_DEPTH_NV = 0x20c2;
  /** <code>WGL_EXT_pixel_format</code><br>Define "WGL_SWAP_METHOD_EXT" with expression '<code>0x2007</code>', CType: int */
  public static final int WGL_SWAP_METHOD_EXT = 0x2007;
  /** Part of CORE DEF<br>Define "WGL_ARB_pixel_format" with expression '<code>1</code>', CType: int */
  public static final int WGL_ARB_pixel_format = 0x1;
  /** Part of CORE DEF<br>Define "ERROR_INVALID_PIXEL_FORMAT" with expression '<code>2000</code>', CType: int */
  public static final int ERROR_INVALID_PIXEL_FORMAT = 0x7d0;
  /** <code>WGL_NV_render_texture_rectangle</code><br>Define "WGL_BIND_TO_TEXTURE_RECTANGLE_RGB_NV" with expression '<code>0x20A0</code>', CType: int */
  ...
  /** Entry point to C language function: <code> HDC wglGetCurrentReadDC() </code> <br>Part of <code>WGL_ARB_make_current_read</code>, <code>WGL_EXT_make_current_read</code><br>Alias for: <code>wglGetCurrentReadDCARB</code>, <code>wglGetCurrentReadDCEXT</code>   */
  ...
  /** Entry point to C language function: <code> HGLRC wglGetCurrentAssociatedContextAMD() </code> <br>Part of <code>WGL_AMD_gpu_association</code><br>   */
  ...
  /** Entry point to C language function: <code> const char *  wglGetExtensionsStringEXT() </code> <br>Part of <code>WGL_EXT_extensions_string</code><br>   */
  ...
  /** Entry point to C language function: <code> int wglGetSwapIntervalEXT() </code> <br>Part of <code>WGL_EXT_swap_control</code><br>   */
  public int wglGetSwapIntervalEXT();

  /** Entry point to C language function: <code> BOOL wglEnableFrameLockI3D() </code> <br>Part of <code>WGL_I3D_swap_frame_lock</code><br>   */
  public boolean wglEnableFrameLockI3D();

  /** Entry point to C language function: <code> BOOL wglDisableFrameLockI3D() </code> <br>Part of <code>WGL_I3D_swap_frame_lock</code><br>   */
  ...
  /** Entry point to C language function: <code> BOOL wglBeginFrameTrackingI3D() </code> <br>Part of <code>WGL_I3D_swap_frame_usage</code><br>   */
  public boolean wglBeginFrameTrackingI3D();

  /** Entry point to C language function: <code> BOOL wglEndFrameTrackingI3D() </code> <br>Part of <code>WGL_I3D_swap_frame_usage</code><br>   */
