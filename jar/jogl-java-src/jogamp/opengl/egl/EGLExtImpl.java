...
/* !---- Java-Unit: [pkg jogamp.opengl.egl, cls EGLExtImpl], ../build/jogl/gensrc/classes/jogamp/opengl/egl/EGLExtImpl.java ----! */
...
public class EGLExtImpl implements EGLExt{
  ...
  /** Entry point to C language function: <code> EGLSurface eglCreatePbufferFromClientBuffer(EGLDisplay dpy, EGLenum buftype, EGLClientBuffer buffer, EGLConfig config, const EGLint *  attrib_list) </code> <br>Part of <code>EGL_VERSION_1_2</code><br>
      @param attrib_list a direct only {@link java.nio.IntBuffer}   */
  private native long dispatch_eglCreatePbufferFromClientBuffer0(long dpy, int buftype, long buffer, long config, Object attrib_list, int attrib_list_byte_offset, long procAddress);
  ...
  public long eglCreateSync(long dpy, int type, PointerBuffer attrib_list)  {
  ...
  /** Entry point to C language function: <code> EGLSync eglCreateSync(EGLDisplay dpy, EGLenum type, const EGLAttrib *  attrib_list) </code> <br>Part of <code>EGL_VERSION_1_5</code>, <code>EGL_KHR_fence_sync</code><br>Alias for: <code>eglCreateSyncKHR</code>
      @param attrib_list a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  private native long dispatch_eglCreateSync0(long dpy, int type, Object attrib_list, int attrib_list_byte_offset, long procAddress);
  ...
  public boolean eglDestroySync(long dpy, long sync)  {
  ...
  /** Entry point to C language function: <code> EGLBoolean eglDestroySync(EGLDisplay dpy, EGLSync sync) </code> <br>Part of <code>EGL_VERSION_1_5</code>, <code>EGL_KHR_fence_sync</code>, <code>EGL_NV_sync</code><br>Alias for: <code>eglDestroySyncKHR</code>, <code>eglDestroySyncNV</code>   */
  private native boolean dispatch_eglDestroySync0(long dpy, long sync, long procAddress);
  ...
  public int eglClientWaitSync(long dpy, long sync, int flags, long timeout)  {
  ...
  /** Entry point to C language function: <code> EGLint eglClientWaitSync(EGLDisplay dpy, EGLSync sync, EGLint flags, EGLTime timeout) </code> <br>Part of <code>EGL_VERSION_1_5</code>, <code>EGL_KHR_fence_sync</code>, <code>EGL_NV_sync</code><br>Alias for: <code>eglClientWaitSyncKHR</code>, <code>eglClientWaitSyncNV</code>   */
  private native int dispatch_eglClientWaitSync0(long dpy, long sync, int flags, long timeout, long procAddress);
  ...
  public boolean eglGetSyncAttrib(long dpy, long sync, int attribute, PointerBuffer value)  {
  ...
  /** Entry point to C language function: <code> EGLBoolean eglGetSyncAttrib(EGLDisplay dpy, EGLSync sync, EGLint attribute, EGLAttrib *  value) </code> <br>Part of <code>EGL_VERSION_1_5</code>, <code>EGL_NV_sync</code>, <code>EGL_KHR_fence_sync</code><br>Alias for: <code>eglGetSyncAttribNV</code>, <code>eglGetSyncAttribKHR</code>
      @param value a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  private native boolean dispatch_eglGetSyncAttrib0(long dpy, long sync, int attribute, Object value, int value_byte_offset, long procAddress);
  ...
  /** Entry point to C language function: <code> EGLImage eglCreateImage(EGLDisplay dpy, EGLContext ctx, EGLenum target, EGLClientBuffer buffer, const EGLAttrib *  attrib_list) </code> <br>Part of <code>EGL_VERSION_1_5</code>, <code>EGL_KHR_image</code><br>Alias for: <code>eglCreateImageKHR</code>
      @param attrib_list a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  public long eglCreateImage(long dpy, long ctx, int target, long buffer, PointerBuffer attrib_list)  {
  ...
  /** Entry point to C language function: <code> EGLImage eglCreateImage(EGLDisplay dpy, EGLContext ctx, EGLenum target, EGLClientBuffer buffer, const EGLAttrib *  attrib_list) </code> <br>Part of <code>EGL_VERSION_1_5</code>, <code>EGL_KHR_image</code><br>Alias for: <code>eglCreateImageKHR</code>
      @param attrib_list a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  private native long dispatch_eglCreateImage0(long dpy, long ctx, int target, long buffer, Object attrib_list, int attrib_list_byte_offset, long procAddress);
  ...
  public boolean eglDestroyImage(long dpy, long image)  {
  ...
  /** Entry point to C language function: <code> EGLBoolean eglDestroyImage(EGLDisplay dpy, EGLImage image) </code> <br>Part of <code>EGL_VERSION_1_5</code>, <code>EGL_KHR_image</code><br>Alias for: <code>eglDestroyImageKHR</code>   */
  private native boolean dispatch_eglDestroyImage0(long dpy, long image, long procAddress);
  ...
  /** Entry point to C language function: <code> EGLDisplay eglGetPlatformDisplay(EGLenum platform, void *  native_display, const EGLAttrib *  attrib_list) </code> <br>Part of <code>EGL_VERSION_1_5</code>, <code>EGL_EXT_platform_base</code><br>Alias for: <code>eglGetPlatformDisplayEXT</code>
      @param attrib_list a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  public long eglGetPlatformDisplay(int platform, long native_display, PointerBuffer attrib_list)  {
  ...
  /** Entry point to C language function: <code> EGLDisplay eglGetPlatformDisplay(EGLenum platform, void *  native_display, const EGLAttrib *  attrib_list) </code> <br>Part of <code>EGL_VERSION_1_5</code>, <code>EGL_EXT_platform_base</code><br>Alias for: <code>eglGetPlatformDisplayEXT</code>
      @param attrib_list a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  private native long dispatch_eglGetPlatformDisplay0(int platform, long native_display, Object attrib_list, int attrib_list_byte_offset, long procAddress);
  ...
  /** Entry point to C language function: <code> EGLSurface eglCreatePlatformWindowSurface(EGLDisplay dpy, EGLConfig config, void *  native_window, const EGLAttrib *  attrib_list) </code> <br>Part of <code>EGL_VERSION_1_5</code>, <code>EGL_EXT_platform_base</code><br>Alias for: <code>eglCreatePlatformWindowSurfaceEXT</code>
      @param attrib_list a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  public long eglCreatePlatformWindowSurface(long dpy, long config, long native_window, PointerBuffer attrib_list)  {
  ...
  /** Entry point to C language function: <code> EGLSurface eglCreatePlatformWindowSurface(EGLDisplay dpy, EGLConfig config, void *  native_window, const EGLAttrib *  attrib_list) </code> <br>Part of <code>EGL_VERSION_1_5</code>, <code>EGL_EXT_platform_base</code><br>Alias for: <code>eglCreatePlatformWindowSurfaceEXT</code>
      @param attrib_list a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  private native long dispatch_eglCreatePlatformWindowSurface0(long dpy, long config, long native_window, Object attrib_list, int attrib_list_byte_offset, long procAddress);
  ...
  /** Entry point to C language function: <code> EGLSurface eglCreatePlatformPixmapSurface(EGLDisplay dpy, EGLConfig config, void *  native_pixmap, const EGLAttrib *  attrib_list) </code> <br>Part of <code>EGL_VERSION_1_5</code>, <code>EGL_EXT_platform_base</code><br>Alias for: <code>eglCreatePlatformPixmapSurfaceEXT</code>
      @param attrib_list a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  public long eglCreatePlatformPixmapSurface(long dpy, long config, long native_pixmap, PointerBuffer attrib_list)  {
  ...
  /** Entry point to C language function: <code> EGLSurface eglCreatePlatformPixmapSurface(EGLDisplay dpy, EGLConfig config, void *  native_pixmap, const EGLAttrib *  attrib_list) </code> <br>Part of <code>EGL_VERSION_1_5</code>, <code>EGL_EXT_platform_base</code><br>Alias for: <code>eglCreatePlatformPixmapSurfaceEXT</code>
      @param attrib_list a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  private native long dispatch_eglCreatePlatformPixmapSurface0(long dpy, long config, long native_pixmap, Object attrib_list, int attrib_list_byte_offset, long procAddress);
  ...
  public boolean eglWaitSync(long dpy, long sync, int flags)  {
  ...
  /** Entry point to C language function: <code> EGLBoolean eglWaitSync(EGLDisplay dpy, EGLSync sync, EGLint flags) </code> <br>Part of <code>EGL_VERSION_1_5</code>, <code>EGL_KHR_wait_sync</code><br>Alias for: <code>eglWaitSyncKHR</code>   */
  private native boolean dispatch_eglWaitSync0(long dpy, long sync, int flags, long procAddress);
  ...
  public int eglLabelObjectKHR(long display, int objectType, long object, long label)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglLabelObjectKHR"));
        ...
        return dispatch_eglLabelObjectKHR0(display, objectType, object, label, __addr_);
  }

  /** Entry point to C language function: <code> EGLint eglLabelObjectKHR(EGLDisplay display, EGLenum objectType, EGLObjectKHR object, EGLLabelKHR label) </code> <br>Part of <code>EGL_KHR_debug</code><br>   */
  private native int dispatch_eglLabelObjectKHR0(long display, int objectType, long object, long label, long procAddress);
  ...
  public long eglCreateImageKHR(long dpy, long ctx, int target, long buffer, IntBuffer attrib_list)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglCreateImageKHR"));
        ...
        return dispatch_eglCreateImageKHR0(dpy, ctx, target, buffer, attrib_list, Buffers.getDirectBufferByteOffset(attrib_list), __addr_);
  }

  /** Entry point to C language function: <code> EGLImageKHR eglCreateImageKHR(EGLDisplay dpy, EGLContext ctx, EGLenum target, EGLClientBuffer buffer, const EGLint *  attrib_list) </code> <br>Part of <code>EGL_KHR_image</code><br>
      @param attrib_list a direct only {@link java.nio.IntBuffer}   */
  private native long dispatch_eglCreateImageKHR0(long dpy, long ctx, int target, long buffer, Object attrib_list, int attrib_list_byte_offset, long procAddress);
  ...
  public long eglCreateStreamKHR(long dpy, IntBuffer attrib_list)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglCreateStreamKHR"));
        ...
        return dispatch_eglCreateStreamKHR0(dpy, attrib_list, Buffers.getDirectBufferByteOffset(attrib_list), __addr_);
  }

  /** Entry point to C language function: <code> EGLStreamKHR eglCreateStreamKHR(EGLDisplay dpy, const EGLint *  attrib_list) </code> <br>Part of <code>EGL_KHR_stream</code><br>
      @param attrib_list a direct only {@link java.nio.IntBuffer}   */
  private native long dispatch_eglCreateStreamKHR0(long dpy, Object attrib_list, int attrib_list_byte_offset, long procAddress);
  ...
  public boolean eglDestroyStreamKHR(long dpy, long stream)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglDestroyStreamKHR"));
        ...
        return dispatch_eglDestroyStreamKHR0(dpy, stream, __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglDestroyStreamKHR(EGLDisplay dpy, EGLStreamKHR stream) </code> <br>Part of <code>EGL_KHR_stream</code><br>   */
  private native boolean dispatch_eglDestroyStreamKHR0(long dpy, long stream, long procAddress);
  ...
  public boolean eglStreamAttribKHR(long dpy, long stream, int attribute, int value)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglStreamAttribKHR"));
        ...
        return dispatch_eglStreamAttribKHR0(dpy, stream, attribute, value, __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglStreamAttribKHR(EGLDisplay dpy, EGLStreamKHR stream, EGLenum attribute, EGLint value) </code> <br>Part of <code>EGL_KHR_stream</code><br>   */
  private native boolean dispatch_eglStreamAttribKHR0(long dpy, long stream, int attribute, int value, long procAddress);
  ...
  public boolean eglQueryStreamKHR(long dpy, long stream, int attribute, IntBuffer value)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglQueryStreamKHR"));
        ...
        return dispatch_eglQueryStreamKHR0(dpy, stream, attribute, value, Buffers.getDirectBufferByteOffset(value), __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglQueryStreamKHR(EGLDisplay dpy, EGLStreamKHR stream, EGLenum attribute, EGLint *  value) </code> <br>Part of <code>EGL_KHR_stream</code><br>
      @param value a direct only {@link java.nio.IntBuffer}   */
  private native boolean dispatch_eglQueryStreamKHR0(long dpy, long stream, int attribute, Object value, int value_byte_offset, long procAddress);
  ...
  public boolean eglQueryStreamu64KHR(long dpy, long stream, int attribute, LongBuffer value)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglQueryStreamu64KHR"));
        ...
        return dispatch_eglQueryStreamu64KHR0(dpy, stream, attribute, value, Buffers.getDirectBufferByteOffset(value), __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglQueryStreamu64KHR(EGLDisplay dpy, EGLStreamKHR stream, EGLenum attribute, EGLuint64KHR *  value) </code> <br>Part of <code>EGL_KHR_stream</code><br>
      @param value a direct only {@link java.nio.LongBuffer}   */
  private native boolean dispatch_eglQueryStreamu64KHR0(long dpy, long stream, int attribute, Object value, int value_byte_offset, long procAddress);
  ...
  public boolean eglStreamConsumerGLTextureExternalKHR(long dpy, long stream)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglStreamConsumerGLTextureExternalKHR"));
        ...
        return dispatch_eglStreamConsumerGLTextureExternalKHR0(dpy, stream, __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglStreamConsumerGLTextureExternalKHR(EGLDisplay dpy, EGLStreamKHR stream) </code> <br>Part of <code>EGL_KHR_stream_consumer_gltexture</code><br>   */
  private native boolean dispatch_eglStreamConsumerGLTextureExternalKHR0(long dpy, long stream, long procAddress);
  ...
  public boolean eglStreamConsumerAcquireKHR(long dpy, long stream)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglStreamConsumerAcquireKHR"));
        ...
        return dispatch_eglStreamConsumerAcquireKHR0(dpy, stream, __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglStreamConsumerAcquireKHR(EGLDisplay dpy, EGLStreamKHR stream) </code> <br>Part of <code>EGL_KHR_stream_consumer_gltexture</code><br>   */
  private native boolean dispatch_eglStreamConsumerAcquireKHR0(long dpy, long stream, long procAddress);
  ...
  public boolean eglStreamConsumerReleaseKHR(long dpy, long stream)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglStreamConsumerReleaseKHR"));
        ...
        return dispatch_eglStreamConsumerReleaseKHR0(dpy, stream, __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglStreamConsumerReleaseKHR(EGLDisplay dpy, EGLStreamKHR stream) </code> <br>Part of <code>EGL_KHR_stream_consumer_gltexture</code><br>   */
  private native boolean dispatch_eglStreamConsumerReleaseKHR0(long dpy, long stream, long procAddress);
  ...
  public int eglGetStreamFileDescriptorKHR(long dpy, long stream)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglGetStreamFileDescriptorKHR"));
        ...
        return dispatch_eglGetStreamFileDescriptorKHR0(dpy, stream, __addr_);
  }

  /** Entry point to C language function: <code> EGLNativeFileDescriptorKHR eglGetStreamFileDescriptorKHR(EGLDisplay dpy, EGLStreamKHR stream) </code> <br>Part of <code>EGL_KHR_stream_cross_process_fd</code><br>   */
  private native int dispatch_eglGetStreamFileDescriptorKHR0(long dpy, long stream, long procAddress);
  ...
  public long eglCreateStreamFromFileDescriptorKHR(long dpy, int file_descriptor)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglCreateStreamFromFileDescriptorKHR"));
        ...
        return dispatch_eglCreateStreamFromFileDescriptorKHR0(dpy, file_descriptor, __addr_);
  }

  /** Entry point to C language function: <code> EGLStreamKHR eglCreateStreamFromFileDescriptorKHR(EGLDisplay dpy, EGLNativeFileDescriptorKHR file_descriptor) </code> <br>Part of <code>EGL_KHR_stream_cross_process_fd</code><br>   */
  private native long dispatch_eglCreateStreamFromFileDescriptorKHR0(long dpy, int file_descriptor, long procAddress);
  ...
  public boolean eglQueryStreamTimeKHR(long dpy, long stream, int attribute, LongBuffer value)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglQueryStreamTimeKHR"));
        ...
        return dispatch_eglQueryStreamTimeKHR0(dpy, stream, attribute, value, Buffers.getDirectBufferByteOffset(value), __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglQueryStreamTimeKHR(EGLDisplay dpy, EGLStreamKHR stream, EGLenum attribute, EGLTimeKHR *  value) </code> <br>Part of <code>EGL_KHR_stream_fifo</code><br>
      @param value a direct only {@link java.nio.LongBuffer}   */
  private native boolean dispatch_eglQueryStreamTimeKHR0(long dpy, long stream, int attribute, Object value, int value_byte_offset, long procAddress);
  ...
  public long eglCreateStreamProducerSurfaceKHR(long dpy, long config, long stream, IntBuffer attrib_list)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglCreateStreamProducerSurfaceKHR"));
        ...
        return dispatch_eglCreateStreamProducerSurfaceKHR0(dpy, config, stream, attrib_list, Buffers.getDirectBufferByteOffset(attrib_list), __addr_);
  }

  /** Entry point to C language function: <code> EGLSurface eglCreateStreamProducerSurfaceKHR(EGLDisplay dpy, EGLConfig config, EGLStreamKHR stream, const EGLint *  attrib_list) </code> <br>Part of <code>EGL_KHR_stream_producer_eglsurface</code><br>
      @param attrib_list a direct only {@link java.nio.IntBuffer}   */
  private native long dispatch_eglCreateStreamProducerSurfaceKHR0(long dpy, long config, long stream, Object attrib_list, int attrib_list_byte_offset, long procAddress);
  ...
  public boolean eglQueryDeviceAttribEXT(long device, int attribute, PointerBuffer value)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglQueryDeviceAttribEXT"));
        ...
        return dispatch_eglQueryDeviceAttribEXT0(device, attribute, value != null ? value.getBuffer() : null, Buffers.getDirectBufferByteOffset(value), __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglQueryDeviceAttribEXT(EGLDeviceEXT device, EGLint attribute, EGLAttrib *  value) </code> <br>Part of <code>EGL_EXT_device_base</code><br>
      @param value a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  private native boolean dispatch_eglQueryDeviceAttribEXT0(long device, int attribute, Object value, int value_byte_offset, long procAddress);
  ...
  public ByteBuffer eglQueryDeviceStringEXT(long device, int name)  {
    ...
    _res = dispatch_eglQueryDeviceStringEXT0(device, name, __addr_);
  ...
  /** Entry point to C language function: <code> const char *  eglQueryDeviceStringEXT(EGLDeviceEXT device, EGLint name) </code> <br>Part of <code>EGL_EXT_device_base</code><br>   */
  private native ByteBuffer dispatch_eglQueryDeviceStringEXT0(long device, int name, long procAddress);
  ...
  public boolean eglOutputLayerAttribEXT(long dpy, long layer, int attribute, long value)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglOutputLayerAttribEXT"));
        ...
        return dispatch_eglOutputLayerAttribEXT0(dpy, layer, attribute, value, __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglOutputLayerAttribEXT(EGLDisplay dpy, EGLOutputLayerEXT layer, EGLint attribute, EGLAttrib value) </code> <br>Part of <code>EGL_EXT_output_base</code><br>   */
  private native boolean dispatch_eglOutputLayerAttribEXT0(long dpy, long layer, int attribute, long value, long procAddress);
  ...
  public boolean eglQueryOutputLayerAttribEXT(long dpy, long layer, int attribute, PointerBuffer value)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglQueryOutputLayerAttribEXT"));
        ...
        return dispatch_eglQueryOutputLayerAttribEXT0(dpy, layer, attribute, value != null ? value.getBuffer() : null, Buffers.getDirectBufferByteOffset(value), __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglQueryOutputLayerAttribEXT(EGLDisplay dpy, EGLOutputLayerEXT layer, EGLint attribute, EGLAttrib *  value) </code> <br>Part of <code>EGL_EXT_output_base</code><br>
      @param value a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  private native boolean dispatch_eglQueryOutputLayerAttribEXT0(long dpy, long layer, int attribute, Object value, int value_byte_offset, long procAddress);
  ...
  public ByteBuffer eglQueryOutputLayerStringEXT(long dpy, long layer, int name)  {
    ...
    final ByteBuffer _res;
    _res = dispatch_eglQueryOutputLayerStringEXT0(dpy, layer, name, __addr_);
    if (_res == null) return null;
    Buffers.nativeOrder(_res);
    return _res;
  }
  ...
  /** Entry point to C language function: <code> const char *  eglQueryOutputLayerStringEXT(EGLDisplay dpy, EGLOutputLayerEXT layer, EGLint name) </code> <br>Part of <code>EGL_EXT_output_base</code><br>   */
  private native ByteBuffer dispatch_eglQueryOutputLayerStringEXT0(long dpy, long layer, int name, long procAddress);
  ...
  public boolean eglOutputPortAttribEXT(long dpy, long port, int attribute, long value)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglOutputPortAttribEXT"));
        ...
        return dispatch_eglOutputPortAttribEXT0(dpy, port, attribute, value, __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglOutputPortAttribEXT(EGLDisplay dpy, EGLOutputPortEXT port, EGLint attribute, EGLAttrib value) </code> <br>Part of <code>EGL_EXT_output_base</code><br>   */
  private native boolean dispatch_eglOutputPortAttribEXT0(long dpy, long port, int attribute, long value, long procAddress);
  ...
  public boolean eglQueryOutputPortAttribEXT(long dpy, long port, int attribute, PointerBuffer value)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglQueryOutputPortAttribEXT"));
        ...
        return dispatch_eglQueryOutputPortAttribEXT0(dpy, port, attribute, value != null ? value.getBuffer() : null, Buffers.getDirectBufferByteOffset(value), __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglQueryOutputPortAttribEXT(EGLDisplay dpy, EGLOutputPortEXT port, EGLint attribute, EGLAttrib *  value) </code> <br>Part of <code>EGL_EXT_output_base</code><br>
      @param value a direct only {@link com.jogamp.common.nio.PointerBuffer}   */
  private native boolean dispatch_eglQueryOutputPortAttribEXT0(long dpy, long port, int attribute, Object value, int value_byte_offset, long procAddress);
  ...
  public ByteBuffer eglQueryOutputPortStringEXT(long dpy, long port, int name)  {
    ...
    final ByteBuffer _res;
    _res = dispatch_eglQueryOutputPortStringEXT0(dpy, port, name, __addr_);
    if (_res == null) return null;
    Buffers.nativeOrder(_res);
    return _res;
  }
  ...
  /** Entry point to C language function: <code> const char *  eglQueryOutputPortStringEXT(EGLDisplay dpy, EGLOutputPortEXT port, EGLint name) </code> <br>Part of <code>EGL_EXT_output_base</code><br>   */
  private native ByteBuffer dispatch_eglQueryOutputPortStringEXT0(long dpy, long port, int name, long procAddress);
  ...
  public long eglGetPlatformDisplayEXT(int platform, long native_display, IntBuffer attrib_list)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglGetPlatformDisplayEXT"));
        ...
        return dispatch_eglGetPlatformDisplayEXT0(platform, native_display, attrib_list, Buffers.getDirectBufferByteOffset(attrib_list), __addr_);
  }

  /** Entry point to C language function: <code> EGLDisplay eglGetPlatformDisplayEXT(EGLenum platform, void *  native_display, const EGLint *  attrib_list) </code> <br>Part of <code>EGL_EXT_platform_base</code><br>
      @param attrib_list a direct only {@link java.nio.IntBuffer}   */
  private native long dispatch_eglGetPlatformDisplayEXT0(int platform, long native_display, Object attrib_list, int attrib_list_byte_offset, long procAddress);
  ...
  public long eglCreatePlatformWindowSurfaceEXT(long dpy, long config, long native_window, IntBuffer attrib_list)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglCreatePlatformWindowSurfaceEXT"));
        ...
        return dispatch_eglCreatePlatformWindowSurfaceEXT0(dpy, config, native_window, attrib_list, Buffers.getDirectBufferByteOffset(attrib_list), __addr_);
  }

  /** Entry point to C language function: <code> EGLSurface eglCreatePlatformWindowSurfaceEXT(EGLDisplay dpy, EGLConfig config, void *  native_window, const EGLint *  attrib_list) </code> <br>Part of <code>EGL_EXT_platform_base</code><br>
      @param attrib_list a direct only {@link java.nio.IntBuffer}   */
  private native long dispatch_eglCreatePlatformWindowSurfaceEXT0(long dpy, long config, long native_window, Object attrib_list, int attrib_list_byte_offset, long procAddress);
  ...
  public long eglCreatePlatformPixmapSurfaceEXT(long dpy, long config, long native_pixmap, IntBuffer attrib_list)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglCreatePlatformPixmapSurfaceEXT"));
        ...
        return dispatch_eglCreatePlatformPixmapSurfaceEXT0(dpy, config, native_pixmap, attrib_list, Buffers.getDirectBufferByteOffset(attrib_list), __addr_);
  }

  /** Entry point to C language function: <code> EGLSurface eglCreatePlatformPixmapSurfaceEXT(EGLDisplay dpy, EGLConfig config, void *  native_pixmap, const EGLint *  attrib_list) </code> <br>Part of <code>EGL_EXT_platform_base</code><br>
      @param attrib_list a direct only {@link java.nio.IntBuffer}   */
  private native long dispatch_eglCreatePlatformPixmapSurfaceEXT0(long dpy, long config, long native_pixmap, Object attrib_list, int attrib_list_byte_offset, long procAddress);
  ...
  public boolean eglStreamConsumerOutputEXT(long dpy, long stream, long layer)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglStreamConsumerOutputEXT"));
        ...
        return dispatch_eglStreamConsumerOutputEXT0(dpy, stream, layer, __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglStreamConsumerOutputEXT(EGLDisplay dpy, EGLStreamKHR stream, EGLOutputLayerEXT layer) </code> <br>Part of <code>EGL_EXT_stream_consumer_egloutput</code><br>   */
  private native boolean dispatch_eglStreamConsumerOutputEXT0(long dpy, long stream, long layer, long procAddress);
  ...
  public long eglCreateStreamSyncNV(long dpy, long stream, int type, IntBuffer attrib_list)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglCreateStreamSyncNV"));
        ...
        return dispatch_eglCreateStreamSyncNV0(dpy, stream, type, attrib_list, Buffers.getDirectBufferByteOffset(attrib_list), __addr_);
  }

  /** Entry point to C language function: <code> EGLSyncKHR eglCreateStreamSyncNV(EGLDisplay dpy, EGLStreamKHR stream, EGLenum type, const EGLint *  attrib_list) </code> <br>Part of <code>EGL_NV_stream_sync</code><br>
      @param attrib_list a direct only {@link java.nio.IntBuffer}   */
  private native long dispatch_eglCreateStreamSyncNV0(long dpy, long stream, int type, Object attrib_list, int attrib_list_byte_offset, long procAddress);
  ...
  public long eglCreateFenceSyncNV(long dpy, int condition, IntBuffer attrib_list)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglCreateFenceSyncNV"));
        ...
        return dispatch_eglCreateFenceSyncNV0(dpy, condition, attrib_list, Buffers.getDirectBufferByteOffset(attrib_list), __addr_);
  }

  /** Entry point to C language function: <code> EGLSyncNV eglCreateFenceSyncNV(EGLDisplay dpy, EGLenum condition, const EGLint *  attrib_list) </code> <br>Part of <code>EGL_NV_sync</code><br>
      @param attrib_list a direct only {@link java.nio.IntBuffer}   */
  private native long dispatch_eglCreateFenceSyncNV0(long dpy, int condition, Object attrib_list, int attrib_list_byte_offset, long procAddress);
  ...
  public boolean eglDestroySyncNV(long sync)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglDestroySyncNV"));
        ...
        return dispatch_eglDestroySyncNV0(sync, __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglDestroySyncNV(EGLSyncNV sync) </code> <br>Part of <code>EGL_NV_sync</code><br>   */
  private native boolean dispatch_eglDestroySyncNV0(long sync, long procAddress);
  ...
  public boolean eglFenceNV(long sync)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglFenceNV"));
        ...
        return dispatch_eglFenceNV0(sync, __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglFenceNV(EGLSyncNV sync) </code> <br>Part of <code>EGL_NV_sync</code><br>   */
  private native boolean dispatch_eglFenceNV0(long sync, long procAddress);
  ...
  public int eglClientWaitSyncNV(long sync, int flags, long timeout)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglClientWaitSyncNV"));
        ...
        return dispatch_eglClientWaitSyncNV0(sync, flags, timeout, __addr_);
  }

  /** Entry point to C language function: <code> EGLint eglClientWaitSyncNV(EGLSyncNV sync, EGLint flags, EGLTimeNV timeout) </code> <br>Part of <code>EGL_NV_sync</code><br>   */
  private native int dispatch_eglClientWaitSyncNV0(long sync, int flags, long timeout, long procAddress);
  ...
  public boolean eglSignalSyncNV(long sync, int mode)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglSignalSyncNV"));
        ...
        return dispatch_eglSignalSyncNV0(sync, mode, __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglSignalSyncNV(EGLSyncNV sync, EGLenum mode) </code> <br>Part of <code>EGL_NV_sync</code><br>   */
  private native boolean dispatch_eglSignalSyncNV0(long sync, int mode, long procAddress);
  ...
  public boolean eglGetSyncAttribNV(long sync, int attribute, IntBuffer value)  {
    ...
    if (__addr_ == 0) {
      throw new UnsupportedOperationException(String.format("Method \"%s\" not available", "eglGetSyncAttribNV"));
        ...
        return dispatch_eglGetSyncAttribNV0(sync, attribute, value, Buffers.getDirectBufferByteOffset(value), __addr_);
  }

  /** Entry point to C language function: <code> EGLBoolean eglGetSyncAttribNV(EGLSyncNV sync, EGLint attribute, EGLint *  value) </code> <br>Part of <code>EGL_NV_sync</code><br>
      @param value a direct only {@link java.nio.IntBuffer}   */
  private native boolean dispatch_eglGetSyncAttribNV0(long sync, int attribute, Object value, int value_byte_offset, long procAddress);
